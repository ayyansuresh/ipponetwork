...
class purchaseInvoiceBlock extends Controller {
    ...
    public static function saveInvoice() {
        return purchaseModel::saveInvoice();
    }
...
public static function exportPurchaseGstPdfQuote() {
        ...
        $url = URL1 . 'reports-reports/printPurchaseGstPdf?fromDate=' . $fromDate
                . '&toDate=' . $toDate
        ...
        $head = "";
        $footer = "";
        generalhelper::pdfGstPurchaseReports($html, $head, $footer, 'Quotation');
    }
     public static function removeBill() {
        return purchaseModel::removeBill();
    }
public static function exportGoldPurchaseGstPdfQuote() {
        //$billNumber = generalhelper::getGetElement('invoiceNumber');
        $company = $_SESSION['beebooklogincompanyid'];
        $accountyear = $_SESSION['beebookloginaccountyearid'];
        $toDate = generalhelper::getGetElement('toDate');
        ...
        $url = URL1 . 'reports-reports/printGoldPurchaseGstPdf?fromDate=' . $fromDate
                . '&toDate=' . $toDate
                . '&customerId=' . $customerId
