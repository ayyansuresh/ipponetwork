...
class salesInvoiceCstVatBlock extends Controller {
    ...
    public static function loadAllModel() {
        self::loadModelSales('sales/' . client_folder . '/salescstvatModel');
    }
    ...
    public static function saveInvoice() {
        return salescstvatModel::saveInvoice();
    }
    public static function updateInvoice(){
        return salescstvatModel::updateInvoice();
    }

    public static function getSalesInvoiceDetails() {
        return salescstvatModel::getSalesInvoiceDetails();
    }
