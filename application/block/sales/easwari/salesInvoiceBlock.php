...
class salesInvoiceBlock extends Controller {
    ...
    public static function loadallconstants() {
        ...
        self::loadConstants('company');
        self::loadConstants('invoicerawdatas');
        self::loadConstants('invoiceprocessingerror');
    }
...
//        print_r($billPrefixResult);
//        echo "gsttype".$gstBillType;
    ...
    public static function getPayrollDataWithFromDateAndToDate() {
        return salesModel::getPayrollDataWithFromDateAndToDate();
    }
    
    public static function getPayrollDataCurrentDate() {
        return salesModel::getPayrollDataCurrentDate();
    }
    
    public static function getpayrollDataById() {
        return salesModel::getpayrollDataById();
    }
    
    public static function getPayrollItemDataById() {
        return salesModel::getPayrollItemDataById();
    }
    
    
    
    public static function SavePayroll() {
        return salesModel::SavePayroll();
    }
    
    public static function UpdatePayroll() {
        return salesModel::UpdatePayroll();
    }
    
    public static function DeletePayroll() {
        return salesModel::DeletePayroll();
    }
    ...
    public static function saveinvoiceEntry($data) {
        return salesModel::saveinvoiceEntry($data);
    }    

    public static function runPendingInvoicesCron($limit = 50, $maxRerunCount = 5) {
        return salesModel::runPendingInvoicesCron($limit, $maxRerunCount);
    }

    public static function getInvoiceApiRequestsList($fromDate = '', $toDate = '', $status = '', $limit = 500) {
        return salesModel::getInvoiceApiRequestsList($fromDate, $toDate, $status, $limit);
    }

    public static function getInvoiceApiRequestStats() {
        return salesModel::getInvoiceApiRequestStats();
    }

    public static function processSinglePendingInvoiceById($invoiceRawDataId) {
        return salesModel::processSinglePendingInvoiceById($invoiceRawDataId);
    }

    public static function getInvoiceProcessingErrorLogs($invoiceRawDataId) {
        return salesModel::getInvoiceProcessingErrorLogs($invoiceRawDataId);
    }
    ...
    public static function getInvoiceFullDetailsForPrint($salesBillId) {
        return salesModel::getInvoiceFullDetailsForPrint($salesBillId);
    }
