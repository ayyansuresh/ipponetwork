...
INSERT INTO `account` VALUES ('2', '2', 'VIJAYABANK', '308600301000188', '1', 'VIJB003086', 'current account');
...
-- ----------------------------
INSERT INTO `accountopeningbalance` VALUES ('1', '1', '0', '1095', '1095', '1', '1');
...
-- ----------------------------
INSERT INTO `accounttransaction` VALUES ('1', '2017-11-15', '1', '1', '1095', '1', '1', '2017-11-15 11:26:36', '0', '2017-11-15 16:56:36', 'Cash Payment for Cash Bill Number - ', '1', '3', '1', '1');
...
CREATE TABLE `commodity` (
  ...
  `depreciationRefId` bigint(20) NOT NULL,
...
-- ----------------------------
INSERT INTO `commodity` VALUES ('2', 'rice', '1', '4414', '0', '1', '1', '1');
INSERT INTO `commodity` VALUES ('8', 'Pencil', '2', '4911', '1', '1', '1', '1');
INSERT INTO `commodity` VALUES ('9', 'Marker', '2', '4414', '1', '1', '1', '1');
INSERT INTO `commodity` VALUES ('11', 'Mobile Phone', '2', '4414', '1', '1', '1', '2');
INSERT INTO `commodity` VALUES ('12', 'Orid Dhall', null, '4414', '1', '1', '1', '1');
...
CREATE TABLE `commoditytype` (
  `commodityTypeId` bigint(20) NOT NULL auto_increment,
  `commodityTypeName` varchar(200) NOT NULL,
...
-- ----------------------------
INSERT INTO `commoditytype` VALUES ('1', 'Products');
INSERT INTO `commoditytype` VALUES ('2', 'Service');
INSERT INTO `commoditytype` VALUES ('3', 'Assets');
...
-- Records of company
-- ----------------------------
INSERT INTO `company` VALUES ('1', 'WELCOME PHOTO STUDIO', 'WELCOME PHOTO STUDIO');
INSERT INTO `company` VALUES ('2', 'WELCOME IMAGING', 'WELCOME IMAGING');
...
-- ----------------------------
INSERT INTO `companyaddress` VALUES ('1', '1', '6-pavali road', null, '1', '33', '28', '626001', 'office@welcomephotostudio.com', '04562-244548', '9943044548', '1', '1', null, null, null, '33AABPE1841N1ZZ');
INSERT INTO `companyaddress` VALUES ('2', '2', '6-pavali road', null, '1', '33', '28', '626001', 'office@welcomephotostudio.com', '04562-244548', '9943044548', '1', '1', null, null, null, '33AIBPJ7646J1Z6');
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', 'venkatesh', '123456789', '1', '1', '1', '1', '2017-11-11 18:02:32', '1', '2017-11-11 13:49:57', '1', '3434');
...
-- ----------------------------
INSERT INTO `customeraddress` VALUES ('1', '1', 'test', 'test', '1', '31', '28', '', '', '', '', '1', '0', '1', null, '2017-11-11 13:49:57', '2017-11-11 17:50:44');
INSERT INTO `customeraddress` VALUES ('2', '1', 'test', 'test', '1', '31', '28', '', '', '', '', '1', '0', null, '1', '2017-11-11 17:50:44', '2017-11-11 18:01:29');
INSERT INTO `customeraddress` VALUES ('3', '1', 'test', 'test', '1', '31', '28', '', '', '', '', '1', '0', null, '1', '2017-11-11 18:01:29', '2017-11-11 18:02:23');
INSERT INTO `customeraddress` VALUES ('4', '1', 'test', 'test', '1', '31', '28', '626001', 'venkatesh@teambeehive.com', '23423', '12323', '1', '0', null, '1', '2017-11-11 18:02:23', '2017-11-11 18:02:32');
INSERT INTO `customeraddress` VALUES ('5', '1', 'test', 'test', '1', '31', '28', '626001', 'venkatesh@teambeehive.com', '23423', '12323', '1', '1', null, '1', '2017-11-11 18:02:32', null);
...
-- ----------------------------
INSERT INTO `customeropeningbalance` VALUES ('1', '1', '1000', '1000', '1000', '1', '1');
INSERT INTO `customeropeningbalance` VALUES ('2', '1', '1000', '1000', '1000', '2', '1');
INSERT INTO `customeropeningbalance` VALUES ('3', '1', '1000', '1000', '1000', '3', '1');
...
-- ----------------------------
INSERT INTO `customertransaction` VALUES ('1', '0', '2017-11-15', '3', 'Debit For Cash bill - ', '1', '1095', '1', '1', '1', '1', '2017-11-15 11:26:36', null, null, '1', '3');
INSERT INTO `customertransaction` VALUES ('2', '0', '2017-11-15', '3', 'Credit For Cash bill - ', '2', '1095', '1', '1', '1', '1', '2017-11-15 11:26:36', null, null, '1', '3');
...
-- ----------------------------
INSERT INTO `daytransaction` VALUES ('1', '2017-11-15', '1', '2', '3', 'Goods Debit for Cash Bill Number - ', '1', '1095', '0', '1', '1', '1', '0', '2017-11-15 11:26:36', '0000-00-00 00:00:00');
INSERT INTO `daytransaction` VALUES ('2', '2017-11-15', '1', '1', '3', 'Sales Credit for Cash Bill Number - ', '1', '1095', '0', '1', '1', '1', '0', '2017-11-15 11:26:36', '0000-00-00 00:00:00');
INSERT INTO `daytransaction` VALUES ('3', '2017-11-15', '1', '1', '3', 'Cash Payment for Cash Bill Number - ', '1', '1095', '0', '1', '1', '1', '0', '2017-11-15 11:26:36', '0000-00-00 00:00:00');

-- ----------------------------
-- Table structure for `depreciation`
-- ----------------------------
DROP TABLE IF EXISTS `depreciation`;
CREATE TABLE `depreciation` (
  `depreciationId` bigint(20) NOT NULL auto_increment,
  `depreciationName` varchar(200) default NULL,
  `depreciationPercentage` float(20,0) default NULL,
...
-- ----------------------------
INSERT INTO `depreciation` VALUES ('1', 'No Depreciation', '0');
INSERT INTO `depreciation` VALUES ('2', 'Furniture', '18');
INSERT INTO `depreciation` VALUES ('3', 'Electronic Products', '22');
...
-- ----------------------------
-- Table structure for `gdc`
-- ----------------------------
DROP TABLE IF EXISTS `gdc`;
CREATE TABLE `gdc` (
  `gdcId` int(10) NOT NULL auto_increment,
  `gdcDate` date default NULL,
  `vanNumber` varchar(200) default NULL,
  `staffName` varchar(500) default NULL,
  `status` int(10) default NULL,
  `createdTimeStamp` timestamp NULL default NULL,
  `vanId` int(2) default NULL,
  PRIMARY KEY  (`gdcId`)
...
-- Records of gdc
-- ----------------------------
INSERT INTO `gdc` VALUES ('4', '2017-11-11', '123456', 'Beehive', '0', '2017-11-11 19:12:22', '1');
INSERT INTO `gdc` VALUES ('6', '2017-11-11', 'TN 67 AB 1234', 'New', '0', '2017-11-11 20:33:11', '2');
INSERT INTO `gdc` VALUES ('7', '2017-10-06', '59874', 'Test', '0', '2017-11-11 20:36:38', '1');
INSERT INTO `gdc` VALUES ('8', '2017-11-15', 'TN 67 AB 2546', 'Venkatesh', '0', '2017-11-15 13:11:07', '1');
INSERT INTO `gdc` VALUES ('9', '2017-11-15', null, 'venkatesh', '1', '2017-11-15 13:32:39', '1');
INSERT INTO `gdc` VALUES ('10', '2017-11-16', null, 'Beehive', '1', '2017-11-16 16:55:44', '2');

-- ----------------------------
-- Table structure for `gdcin`
-- ----------------------------
DROP TABLE IF EXISTS `gdcin`;
CREATE TABLE `gdcin` (
  `gdcInId` int(20) NOT NULL auto_increment,
  `gdcOutRefId` int(20) default NULL,
  `gdcInDate` datetime default NULL,
  `receivedPerson` varchar(500) default NULL,
  `deliveryPerson` varchar(500) default NULL,
  `createdTimeStamp` timestamp NULL default NULL,
  PRIMARY KEY  (`gdcInId`)
...
-- Records of gdcin
-- ----------------------------
INSERT INTO `gdcin` VALUES ('3', '6', '2017-11-08 00:00:00', 'New', 'NewDesc', null);
INSERT INTO `gdcin` VALUES ('4', '8', '2017-11-14 00:00:00', 'Person1', 'Person2', null);
INSERT INTO `gdcin` VALUES ('5', '29', '2017-11-07 00:00:00', 'That', 'Person', null);
INSERT INTO `gdcin` VALUES ('6', '29', '2017-11-15 00:00:00', 'Rest', 'Th', null);
INSERT INTO `gdcin` VALUES ('7', '23', '2017-11-16 00:00:00', 'Hello', 'World', '2017-11-18 13:16:36');

-- ----------------------------
-- Table structure for `gdcinitems`
-- ----------------------------
DROP TABLE IF EXISTS `gdcinitems`;
CREATE TABLE `gdcinitems` (
  `inItemId` int(20) NOT NULL auto_increment,
  `gdcInRefId` int(20) default NULL,
  `gdcOutRefId` int(20) default NULL,
  `gdcOutItemRefId` int(20) default NULL,
  `receivedQuantity` double(100,0) default NULL,
  `inItemDescription` varchar(500) default NULL,
  `createdTimeStamp` timestamp NULL default NULL,
  PRIMARY KEY  (`inItemId`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of gdcinitems
-- ----------------------------
INSERT INTO `gdcinitems` VALUES ('1', null, '7', '2', '800', 'kjhjkh', null);
INSERT INTO `gdcinitems` VALUES ('2', null, '30', '3', '100', 'First', null);
INSERT INTO `gdcinitems` VALUES ('3', null, '30', '1', '1000', 'Second', null);
INSERT INTO `gdcinitems` VALUES ('4', '0', '6', '2', '1000', 'NewOne', null);
INSERT INTO `gdcinitems` VALUES ('5', '4', '8', '2', '780', 'TestDesc', null);
INSERT INTO `gdcinitems` VALUES ('6', '5', '29', '1', '100', 'New', '2017-11-18 13:07:03');
INSERT INTO `gdcinitems` VALUES ('7', '5', '29', '3', '500', 'Sw', '2017-11-18 13:07:03');
INSERT INTO `gdcinitems` VALUES ('8', '7', '23', '2', '80', 'Testing', '2017-11-18 13:16:36');

-- ----------------------------
-- Table structure for `gdcitems`
-- ----------------------------
DROP TABLE IF EXISTS `gdcitems`;
CREATE TABLE `gdcitems` (
  `gdcItemid` int(10) NOT NULL auto_increment,
  `gdcRefId` int(10) default NULL,
  `itemId` int(10) default NULL,
  `uomId` int(10) default NULL,
  `takenQuantity` double(100,0) default NULL,
  `returnQuantity` double(100,0) default NULL,
  `salesQuantity` double(100,0) default NULL,
  `updatedTimeStamp` timestamp NULL default NULL on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`gdcItemid`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of gdcitems
-- ----------------------------
INSERT INTO `gdcitems` VALUES ('2', null, null, null, '4500', '3500', null, null);
INSERT INTO `gdcitems` VALUES ('4', '4', '1', '2', '150', '0', '150', null);
INSERT INTO `gdcitems` VALUES ('6', '6', '1', '2', '500', '0', '500', null);
INSERT INTO `gdcitems` VALUES ('7', '6', '1', '3', '15', '0', '15', null);
INSERT INTO `gdcitems` VALUES ('8', '6', '1', '2', '5000', '0', '5000', null);
INSERT INTO `gdcitems` VALUES ('9', '7', '1', '9', '700', '0', '700', null);
INSERT INTO `gdcitems` VALUES ('10', '8', '2', '2', '5000', '5000', '5000', '2017-11-15 13:29:07');
INSERT INTO `gdcitems` VALUES ('11', '9', '2', '2', '4500', '4500', '0', '2017-11-15 13:40:58');
INSERT INTO `gdcitems` VALUES ('12', '10', '1', '5', '500', '300', '200', '2017-11-16 16:56:20');
INSERT INTO `gdcitems` VALUES ('13', '10', '2', '2', '400', '200', '200', '2017-11-16 16:56:20');

-- ----------------------------
-- Table structure for `gdcout`
-- ----------------------------
DROP TABLE IF EXISTS `gdcout`;
CREATE TABLE `gdcout` (
  `gdcOutId` int(20) NOT NULL auto_increment,
  `gdcOutDate` date default NULL,
  `companyName` varchar(500) default NULL,
  `issuedPerson` varchar(500) default NULL,
  `deliveryPerson` varchar(500) default NULL,
  `contactNumber` varchar(500) default NULL,
  `status` int(2) default NULL,
  `createdTimeStamp` timestamp NULL default NULL on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`gdcOutId`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of gdcout
-- ----------------------------
INSERT INTO `gdcout` VALUES ('5', '2017-11-16', 'New', 'One', 'Two', '985787878', '1', '2017-11-18 17:01:20');
INSERT INTO `gdcout` VALUES ('6', '2017-11-01', 'Test', 'PersonOne', 'PersonTwo', '54787587', '1', '2017-11-18 18:16:09');
INSERT INTO `gdcout` VALUES ('7', '2017-11-02', 'New', 'Bee', 'Hive', '785878', '1', '2017-11-18 17:03:42');
INSERT INTO `gdcout` VALUES ('8', '2017-11-07', 'First', 'New', 'NewNew', '9854758748', '1', '2017-11-18 18:19:03');
INSERT INTO `gdcout` VALUES ('15', '2017-11-04', 'gnfgbnd', 'fgngfd', 'fgnhgfd', '94984544', '0', '2017-11-16 20:00:19');
INSERT INTO `gdcout` VALUES ('16', '2017-11-07', 'fdsaff', 'dfgvds', 'vbnvfgdb', '98979', '0', '2017-11-16 20:06:59');
INSERT INTO `gdcout` VALUES ('18', '2017-11-08', 'Infosys', 'Torry', 'Michel', '784587485', '0', '2017-11-18 11:52:59');
INSERT INTO `gdcout` VALUES ('19', '2017-11-16', 'Bee', 'Saravana', 'Raj', '9629116451', '0', '2017-11-18 11:55:44');
INSERT INTO `gdcout` VALUES ('23', '2017-11-18', 'SRS', 'jdbvdj', 'dvfbdxj', '41423', '1', '2017-11-18 18:46:36');
INSERT INTO `gdcout` VALUES ('28', '2017-11-10', 'TCS', 'Peter', 'John', '9003143123', '0', '2017-11-18 13:09:21');
INSERT INTO `gdcout` VALUES ('29', '2017-11-11', 'Beehive', 'Veera', 'Manoj', '988787878', '1', '2017-11-18 18:37:03');
INSERT INTO `gdcout` VALUES ('30', '2017-11-18', 'CTS', 'John', 'Ibrahim', '9584878475', '1', '2017-11-18 17:26:28');

-- ----------------------------
-- Table structure for `gdcoutitems`
-- ----------------------------
DROP TABLE IF EXISTS `gdcoutitems`;
CREATE TABLE `gdcoutitems` (
  `outItemId` int(20) NOT NULL auto_increment,
  `gdcOutRefId` int(20) default NULL,
  `itemId` int(20) default NULL,
  `uomId` int(20) default NULL,
  `takenQuantity` double(100,0) default NULL,
  `outItemDescription` varchar(500) default NULL,
  `createdTimeStamp` timestamp NULL default NULL,
  PRIMARY KEY  (`outItemId`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of gdcoutitems
-- ----------------------------
INSERT INTO `gdcoutitems` VALUES ('6', '5', '2', '1', '500', 'Ponni', '0000-00-00 00:00:00');
INSERT INTO `gdcoutitems` VALUES ('7', '6', '2', '1', '5000', 'High', '0000-00-00 00:00:00');
INSERT INTO `gdcoutitems` VALUES ('8', '7', '2', '1', '800', 'New', '0000-00-00 00:00:00');
INSERT INTO `gdcoutitems` VALUES ('9', '8', '2', '1', '800', 'Self', '2017-11-16 14:10:21');
INSERT INTO `gdcoutitems` VALUES ('17', '15', '2', '1', '2312', 'vdbdvb', '2017-11-16 14:30:19');
INSERT INTO `gdcoutitems` VALUES ('18', '15', '3', '1', '1321', 'bddbd', '2017-11-16 14:30:19');
INSERT INTO `gdcoutitems` VALUES ('19', '16', '2', '1', '200', 'jnjbn', '2017-11-16 14:36:59');
INSERT INTO `gdcoutitems` VALUES ('22', '18', '2', '1', '5000', 'LowCost', '2017-11-18 06:22:59');
INSERT INTO `gdcoutitems` VALUES ('23', '18', '3', '1', '514', 'High', '2017-11-18 06:22:59');
INSERT INTO `gdcoutitems` VALUES ('24', '18', '1', '1', '4000', 'Medium', '2017-11-18 06:22:59');
INSERT INTO `gdcoutitems` VALUES ('25', '19', '2', '1', '8000', 'NewUpdate', '2017-11-18 06:25:44');
INSERT INTO `gdcoutitems` VALUES ('29', '23', '2', '1', '87', 'fdhfd', '2017-11-18 07:20:34');
INSERT INTO `gdcoutitems` VALUES ('35', '28', '3', '1', '500', '', '2017-11-18 07:39:21');
INSERT INTO `gdcoutitems` VALUES ('36', '28', '1', '1', '1000', '', '2017-11-18 07:39:21');
INSERT INTO `gdcoutitems` VALUES ('37', '29', '1', '1', '500', 'HighQuality', '2017-11-18 07:47:48');
INSERT INTO `gdcoutitems` VALUES ('38', '29', '3', '1', '1000', 'LowQuality', '2017-11-18 07:47:48');
INSERT INTO `gdcoutitems` VALUES ('39', '30', '3', '1', '500', 'Heelo', '2017-11-18 11:55:33');
INSERT INTO `gdcoutitems` VALUES ('40', '30', '1', '1', '1548', 'New', '2017-11-18 11:55:33');
...
-- ----------------------------
INSERT INTO `gsthsncode` VALUES ('4414', '1', 'Frames', '14', '14', '28', '0', '0', '1');
INSERT INTO `gsthsncode` VALUES ('4911', '1', 'Photos', '6', '6', '12', '0', '0', '1');
...
CREATE TABLE `income` (
  ...
  `incomeCateogryRefId` bigint(20) default NULL,
  `incomeSubCateogoryRefId` bigint(20) default NULL,
  `amount` double default NULL,
  `incomeMode` int(4) default NULL,
  `incomeDescription` varchar(500) default NULL,
  `accountRefId` bigint(20) default NULL,
  `companyRefId` bigint(20) default NULL,
  `accountYearRefId` bigint(20) default NULL,
  `createdBy` bigint(20) default NULL,
...
CREATE TABLE `items` (
  ...
  PRIMARY KEY  (`ItemId`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Items Details';

-- ----------------------------
-- Records of items
-- ----------------------------
INSERT INTO `items` VALUES ('1', 'peacock', '1', '1', '100', '100', '2', null, '0', '1', '0', '2017-11-16 17:43:38', '0', '0000-00-00 00:00:00', '1', '1223');
INSERT INTO `items` VALUES ('2', '25 Kg Rice', '25', '1', '100', '95', '2', null, '0', '1', '0', '2017-11-16 17:43:39', '0', '0000-00-00 00:00:00', '1', '12345');
INSERT INTO `items` VALUES ('3', 'venkatesh', '100', '1', '100', '100', '8', null, '0', '1', '0', '2017-11-16 17:44:32', '0', '2017-11-16 17:44:32', '1', '123456');
INSERT INTO `items` VALUES ('5', 'Mobile Phone', '1', '1', '250', '300', '11', '2', '0', '1', '0', '2017-11-16 17:52:42', '0', '0000-00-00 00:00:00', '1', '12323');
INSERT INTO `items` VALUES ('6', '50Kg Orid Dhall', '1', '1', '1500', '1200', '12', null, '0', '1', '0', '2017-11-19 11:53:37', '0', '2017-11-19 11:53:37', '1', '12345678');
...
CREATE TABLE `journal` (
  `journal_Id` bigint(25) NOT NULL auto_increment,
  `journal_Description` varchar(250) default NULL,
  `journal_Entry_By_Name` varchar(150) NOT NULL,
  `journal_Date` timestamp NOT NULL default '0000-00-00 00:00:00',
  `company_Ref_Id` int(10) NOT NULL,
  `account_Year_Ref_Id` int(10) NOT NULL,
  `created_Time_Stamp` timestamp NOT NULL default '0000-00-00 00:00:00' on update CURRENT_TIMESTAMP,
...
-- Records of journal
-- ----------------------------
INSERT INTO `journal` VALUES ('1', 'testing', 'venkatesh', '2017-11-20 00:00:00', '1', '1', '2017-11-20 12:02:14');

-- ----------------------------
-- Table structure for `journalitems`
-- ----------------------------
DROP TABLE IF EXISTS `journalitems`;
CREATE TABLE `journalitems` (
  `journal_Items_Id` bigint(25) NOT NULL auto_increment,
  `journal_Ref_Id` bigint(25) NOT NULL,
  `commodity_Ref_Id` bigint(20) NOT NULL,
  `item_Ref_Id` bigint(20) NOT NULL,
  `uom_Ref_Id` int(10) NOT NULL,
  `quantity` double NOT NULL,
  `packing_Factor` double NOT NULL,
  `total_UOM_Quantity` double NOT NULL,
  `transaction_Type` varchar(50) NOT NULL,
  `company_Ref_Id` int(10) NOT NULL,
  `account_Year_Ref_Id` int(10) NOT NULL,
  `created_Time_Stamp` timestamp NOT NULL default '0000-00-00 00:00:00' on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`journal_Items_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of journalitems
-- ----------------------------
INSERT INTO `journalitems` VALUES ('1', '1', '2', '2', '1', '150', '25', '3750', '1', '1', '1', '2017-11-20 06:32:14');
INSERT INTO `journalitems` VALUES ('2', '1', '2', '1', '1', '100', '1', '100', '1', '1', '1', '2017-11-20 06:32:14');
...
INSERT INTO `login` VALUES ('2', 'bill', 'bill', '1', '2', null, null, '1', '1');
...
CREATE TABLE `openingstock` (
  ...
  `updatedBy` bigint(20) NOT NULL,
  `openingStockValue` double default NULL,
...
-- ----------------------------
INSERT INTO `openingstock` VALUES ('1', '2', '1', '1', '1', '1', '2017-11-10 15:58:49', '50', '-3635', '-3635', '0', '5000', '2017-11-20 12:02:14', null);
INSERT INTO `openingstock` VALUES ('2', '8', '1', '1', '2', '1', '2017-11-11 18:53:07', '20', '20', '20', '0', '2000', '0000-00-00 00:00:00', null);
INSERT INTO `openingstock` VALUES ('3', '9', '1', '1', '2', '1', '2017-11-13 15:00:55', '200', '200', '200', '0', '20000', '0000-00-00 00:00:00', null);
INSERT INTO `openingstock` VALUES ('5', '11', '1', '1', '2', '1', '2017-11-16 17:51:40', '150', '150', '150', '1', '1500', '2017-11-16 17:52:42', null);
INSERT INTO `openingstock` VALUES ('6', '12', '1', '1', null, '1', '2017-11-19 11:49:48', '2500', '2500', '2500', '0', '250000', '0000-00-00 00:00:00', null);

-- ----------------------------
-- Table structure for `openingstockitem`
-- ----------------------------
DROP TABLE IF EXISTS `openingstockitem`;
CREATE TABLE `openingstockitem` (
  `openingStockItemId` bigint(20) NOT NULL auto_increment,
  `itemRefId` bigint(20) NOT NULL,
  `commodityRefId` bigint(20) NOT NULL,
  `companyRefId` bigint(20) NOT NULL,
  `accountYearRefId` bigint(20) NOT NULL,
  `UOMRefId` bigint(20) default NULL,
  ...
  `updatedTimeStamp` timestamp NOT NULL default '0000-00-00 00:00:00' on update CURRENT_TIMESTAMP,
  `closingStockValue` double default NULL,
  PRIMARY KEY  (`openingStockItemId`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of openingstockitem
-- ----------------------------
INSERT INTO `openingstockitem` VALUES ('1', '3', '8', '1', '1', '2', '1', '2017-11-16 17:44:32', '200', '200', '200', '0', '150', '0000-00-00 00:00:00', null);
INSERT INTO `openingstockitem` VALUES ('2', '5', '11', '1', '1', '2', '1', '2017-11-16 17:51:40', '150', '150', '150', '0', '1500', '2017-11-16 17:52:42', null);
INSERT INTO `openingstockitem` VALUES ('3', '6', '12', '1', '1', '1', '1', '2017-11-19 11:53:37', '100', '100', '100', '0', '1000', '0000-00-00 00:00:00', null);
...
CREATE TABLE `purchasepayment` (
  ...
  `billDescription` varchar(250) default NULL,
...
-- ----------------------------
INSERT INTO `salesbill` VALUES ('3', '1', '1', '2017-11-15', '1', '0.00', '0.00', '119.77', '119.77', '0', '0.00', '0', '855.47', '0', '-0.01', '1095', '1', '1', '1', '2017-11-15 16:56:36', '0', '0000-00-00 00:00:00', '3', '0', '1', '0', '1', 'vernk', '121', '0', null, null, '2', '0');
...
CREATE TABLE `salesbillitem` (
  ...
  `vatRate` double default NULL,
  `vatTotal` double default NULL,
  `unitRateWithTax` double default NULL,
  `totalWithTax` double default NULL,
  PRIMARY KEY  (`ID`)
...
-- ----------------------------
INSERT INTO `salesbillitem` VALUES ('1', '3', '1', '2', '78.13', null, '10', '781.25', '0', '0', '14', '109.38', '14', '109.38', '0', '0', '1', '1', '10', '2017-11-15', '4414', '0', '1', '1', '3', '1', '120', null, null, null, null, '100', '1000');
INSERT INTO `salesbillitem` VALUES ('2', '3', '2', '2', '74.22', null, '1', '74.22', '0', '0', '14', '10.39', '14', '10.39', '0', '0', '1', '25', '25', '2017-11-15', '4414', '0', '1', '1', '3', '1', '1', null, null, null, null, '95', '95');
...
INSERT INTO `salesbillprefix` VALUES ('3', '1', '1', 'BEE/17-18/', '4', '3');
...
-- Records of stock
-- ----------------------------
INSERT INTO `stock` VALUES ('1', '2', '1', '10', '2017-11-15', '1', '1', '2', '2', '1', '1', '2017-11-15 16:56:36', '0', '2017-11-15 11:26:36');
INSERT INTO `stock` VALUES ('2', '2', '1', '25', '2017-11-15', '1', '1', '2', '2', '2', '1', '2017-11-15 16:56:36', '0', '2017-11-15 11:26:36');
INSERT INTO `stock` VALUES ('3', '2', '3750', '3750', '2017-11-20', '1', '1', '2', '11', '1', '1', '2017-11-20 12:02:14', '0', '2017-11-20 06:32:14');
INSERT INTO `stock` VALUES ('4', '2', '100', '100', '2017-11-20', '1', '1', '1', '11', '2', '1', '2017-11-20 12:02:14', '0', '2017-11-20 06:32:14');
...
-- ----------------------------
-- Table structure for `vannumber`
-- ----------------------------
DROP TABLE IF EXISTS `vannumber`;
CREATE TABLE `vannumber` (
...
-- ----------------------------
-- Records of vannumber
-- ----------------------------
INSERT INTO `vannumber` VALUES ('1', 'TN 67 AB 2546');
INSERT INTO `vannumber` VALUES ('2', 'TN 67 AF 1202');
INSERT INTO `vannumber` VALUES ('3', 'TN 67 BC 6587');
...
-- ----------------------------
INSERT INTO `villagecustomer` VALUES ('3', '3', '1', 'venkatesh', 'virudhuangar');
