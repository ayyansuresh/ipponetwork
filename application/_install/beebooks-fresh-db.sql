...
INSERT INTO `account` VALUES ('2', '2', 'Indian Bank', '', '1', null, 'current account');
INSERT INTO `account` VALUES ('3', '3', 'Dhanasekaran', 'KVB', '1', 'cash', 'cash');
...
INSERT INTO `accountopeningbalance` VALUES ('2', '1', '0', '0', '0', '1', '1');
INSERT INTO `accountopeningbalance` VALUES ('3', '1', '0', '0', '0', '1', '1');
...
-- Records of company
-- ----------------------------
INSERT INTO `company` VALUES ('1', 'BEEHIVE', 'BEEHIVE');
...
-- ----------------------------
INSERT INTO `companyaddress` VALUES ('1', '1', '57, SAMIYAR KINATRU STREET', null, '1', '33', '28', '626001', 'office@welcomephotostudio.com', '04562-420833', '99445 98150,77087 91', '1', '1', null, null, null, null);
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', 'Retail', '123456789', '1', '1', '1', '1', '2017-12-06 19:22:36', '1', '2017-11-11 13:49:57', '1', '3434');
...
-- ----------------------------
INSERT INTO `customeropeningbalance` VALUES ('1', '1', '0', '0', '0', '1', '1');
...
-- ----------------------------
INSERT INTO `expensecategory` VALUES ('1', 'Rent', '1');
INSERT INTO `expensecategory` VALUES ('2', 'Salary', '1');
...
-- ----------------------------
INSERT INTO `expensesubcategory` VALUES ('1', '1', 'Office', '1');
...
CREATE TABLE `journal` (
  ...
  `journal_Date` timestamp  NULL default NULL,
  `company_Ref_Id` int(10) NOT NULL,
  `account_Year_Ref_Id` int(10) NOT NULL,
  `created_Time_Stamp` timestamp  NULL default NULL on update CURRENT_TIMESTAMP,
...
-- Records of login
-- ----------------------------
INSERT INTO `login` VALUES ('1', 'beehive', 'P@ssword', '1', '1', null, '2017-12-06 19:24:25', '1', '1');
INSERT INTO `login` VALUES ('2', 'bill', 'P@ssword', '1', '2', null, '2017-12-06 19:24:29', '1', '1');
...
-- ----------------------------
INSERT INTO `salesbillprefix` VALUES ('1', '1', '1', 'BEE/17-18/', '4', '1');
INSERT INTO `salesbillprefix` VALUES ('2', '1', '1', 'BEE/17-18/', '4', '2');
...
-- ----------------------------
-- Procedure structure for `bank_Account_Transaction`
-- ----------------------------
DROP PROCEDURE IF EXISTS `bank_Account_Transaction`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `bank_Account_Transaction`(IN `FromDate` date,IN `ToDate` date,IN `CompanyId` bigint,IN `accountYearId` bigint,IN `accountId` bigint)
BEGIN
SELECT a.accountDate as 'accountdate',
CASE b.salesBillType
  WHEN '2' THEN CONCAT(' Cash Sales  as  Per (Bill Number : ',b.salesBillDisplayNumber,')')
  ELSE CONCAT(' Advance for Sales as  Per (Bill Number : ',b.salesBillDisplayNumber,')')
  END  as 'Description',
...
inner join salesbill as b on b.salesBillID=a.tableDetailId
where a.tableReference=1  and a.transactionType=1
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId
union
SELECT a.accountDate as 'accountdate',
CASE b.salesBillRefId  WHEN '0' THEN
        CASE b.paymentMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') By Cash as per (Receipt Number : (',b.receiptNumber,')' )
                        WHEN '2' THEN
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') Through Online (', b.modeDescription ,')' )
                                WHEN '3' THEN
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') Through Online (', b.modeDescription ,')' )

                        WHEN '4' THEN
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') By Demand Draft (', b.modeDescription ,')' )
        END
ELSE
CASE b.paymentMode
                        WHEN '1' THEN
                                                                CASE c.salesBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Sales Payment for the (Bill Number : ',c.salesBillDisplayNumber ,') By Cash as per (Receipt Number : (',b.receiptNumber,')' )
                                                                                        ELSE
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',c.salesBillDisplayNumber ,') By Cash as per (Receipt Number : (',b.receiptNumber,')' )
                                                                END

                        WHEN '2' THEN
                                                                CASE c.salesBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Sales Payment for the (Bill Number : ',c.salesBillDisplayNumber ,') Through Online (', b.modeDescription ,')')
                                                                                        ELSE
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',c.salesBillDisplayNumber ,') Through Online (', b.modeDescription ,')' )
                                                                END

                                WHEN '3' THEN
                                                                CASE c.salesBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Sales Payment for the (Bill Number : ',c.salesBillDisplayNumber ,') By Cheque (', b.modeDescription ,')')
                                                                                        ELSE
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',c.salesBillDisplayNumber ,') Through Online (', b.modeDescription ,')' )
                                                                END
                        ...
                        WHEN '4' THEN
                                                                CASE c.salesBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Sales Payment for the (Bill Number : ',c.salesBillDisplayNumber ,') By Demand Draft (', b.modeDescription,')' )
                                                                                        ELSE
                                                                                        CONCAT(' Sales Payment By ',d.`name`,' for the (Bill Number : ',c.salesBillDisplayNumber ,') By Demand Draft (', b.modeDescription ,')' )
                                                                END
        END
END  as 'Description',
CASE a.transactionType
...
CASE a.transactionType
 ...
 FROM
accounttransaction as a
inner join salespayment as b on b.salesPaymentId=a.tableDetailId
left join salesbill as c on c.salesBillID=b.salesBillRefId
left join customer as d on d.customerID=b.customerRefId
where a.tableReference=5  and a.transactionType=1
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId
...
SELECT a.accountDate as 'accountdate',
CASE b.purchaseBillType
  WHEN '2' THEN CONCAT(' Cash Purchase  as  Per (Bill Number : ',b.purchaseBillDisplayNumber,')')
  ELSE CONCAT(' Advance for Purchase as  Per (Bill Number : ',b.purchaseBillDisplayNumber,')')
  END  as 'Description',
CASE a.transactionType
  WHEN '1' THEN a.amount
  ELSE NULL
...
CASE a.transactionType
 ...
 FROM
accounttransaction as a
inner join purchasebill as b on b.purchaseBillID=a.tableDetailId
where a.tableReference=3  and a.transactionType=2
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId
union
SELECT a.accountDate as 'accountdate',
CASE b.purchaseBillRefId  WHEN '0' THEN
        CASE b.paymentMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') By Cash as per (Receipt Number : (',b.receiptNumber,')' )
                        WHEN '2' THEN
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') Through Online (', b.modeDescription ,')' )
                                WHEN '3' THEN
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') Through Online (', b.modeDescription ,')' )

                        WHEN '4' THEN
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',b.billDescription ,') By Demand Draft (', b.modeDescription ,')' )
        END
ELSE
CASE b.paymentMode
                        WHEN '1' THEN
                                                                CASE c.purchaseBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Purchase Payment for the (Bill Number : ',c.purchaseBillDisplayNumber ,') By Cash as per Receipt Number : (',b.receiptNumber,')' )
                                                                                        ELSE
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',c.purchaseBillDisplayNumber ,') By Cash as per (Receipt Number : (',b.receiptNumber,')' )
                                                                END

                        WHEN '2' THEN
                                                                CASE c.purchaseBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Purchase Payment for the (Bill Number : ',c.purchaseBillDisplayNumber ,') Through Online (', b.modeDescription ,')')
                                                                                        ELSE
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',c.purchaseBillDisplayNumber ,') Through Online (', b.modeDescription ,')' )
                                                                END

                                WHEN '3' THEN
                                                                CASE c.purchaseBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Purchase Payment for the (Bill Number : ',c.purchaseBillDisplayNumber ,') By Cheque (', b.modeDescription ,')')
                                                                                        ELSE
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',c.purchaseBillDisplayNumber ,') Through Online (', b.modeDescription ,')' )
                                                                END
                        ...
                        WHEN '4' THEN
                                                                CASE c.purchaseBillType
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Purchase Payment for the (Bill Number : ',c.purchaseBillDisplayNumber ,') By Demand Draft (', b.modeDescription,')' )
                                                                                        ELSE
                                                                                        CONCAT(' Purchase Payment By ',d.`name`,' for the (Bill Number : ',c.purchaseBillDisplayNumber ,') By Demand Draft (', b.modeDescription ,')' )
                                                                END
        END
END  as 'Description',
CASE a.transactionType
...
CASE a.transactionType
 ...
 FROM
accounttransaction as a
inner join purchasepayment as b on b.purchasePaymentId=a.tableDetailId
left join purchasebill as c on c.purchaseBillID=b.purchaseBillRefId
left join customer as d on d.customerID=b.customerRefId
where a.tableReference=6  and a.transactionType=2
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId

union
SELECT a.accountDate as 'accountdate',
CASE b.expenseId  WHEN '0' THEN
        CASE b.paymentMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Expense Payment (',b.paymentDescription ,') By Cash as per (Receipt Number : (',b.voucherNumber,')' )
                        WHEN '2' THEN
                                                                                        CONCAT(' Expense Payment (',b.paymentDescription ,') By Cash as per (Receipt Number : (',b.voucherNumber,')' )
                                WHEN '3' THEN
                                                                                        CONCAT(' Expense Payment (',b.paymentDescription ,') By Cash as per (Receipt Number : (',b.voucherNumber,')' )
...
CASE b.paymentMode
                        ...
                        WHEN '2' THEN
                                                                CASE b.paymentMode
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Expense Payment : (',b.paymentDescription ,') Through Online (', b.voucherNumber ,')')
                                                                                        ELSE
                                                                                        CONCAT(' Expense Payment : (',b.paymentDescription ,') Through Online (', b.voucherNumber ,')' )
                                                                END
                                ...
                                WHEN '3' THEN
                                                                CASE b.paymentMode
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Expense Payment : (',b.paymentDescription ,') By Cheque (', b.voucherNumber ,')')
                                                                                        ELSE
                                                                                        CONCAT(' Expense Payment : (',b.paymentDescription ,') Through Online (', b.voucherNumber ,')')
                        ...
                        WHEN '4' THEN
                                                                CASE b.paymentMode
                                                                                        WHEN 3 THEN
                                                                                        CONCAT(' Expense Payment : (',b.paymentDescription ,') By Demand Draft (', b.voucherNumber,')' )
                                                                                        ELSE
                                                                                        CONCAT(' Expense Payment : (',b.paymentDescription ,') By Demand Draft (', b.voucherNumber ,')' )
                                                                END
        END
...
CASE a.transactionType
 ...
 FROM
accounttransaction as a
inner join expenses as b on b.expenseId=a.tableDetailId
left join expensecategory as c on c.expenseCategoryId=b.expenseCateogryRefId
left join expensesubcategory as d on d.expenseCategoryRefId=c.expenseCategoryId
where a.tableReference=7  and a.transactionType=2
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId

union
SELECT a.accountDate as 'accountdate',
CASE a.tableReference  WHEN '8' THEN
        CASE b.depositMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Bank Deposited (',b.modeDescription ,') By Cash ' )
                        WHEN '2' THEN
                                                                                        CONCAT(' Bank Deposited (',b.modeDescription ,') By Online ' )
                        WHEN '3' THEN
                                                                                        CONCAT(' Bank Deposited (',b.modeDescription ,') By Cheque ' )
  END 
  ELSE NULL
...
CASE a.transactionType
 ...
 FROM
accounttransaction as a
inner join bankdeposit as b on b.depositId=a.tableDetailId
inner join account as c on b.accountRefId=c.accountId
where a.tableReference=8   
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId
...
SELECT a.accountDate as 'accountdate', 
CASE a.tableReference  WHEN '9' THEN
        CASE b.withdrawalMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Bank Withdrawal (',b.modeDescription ,') By Cash ' )
                        WHEN '2' THEN
                                                                                        CONCAT(' Bank Withdrawal (',b.modeDescription ,') By Online ' )
                        WHEN '3' THEN
                                                                                        CONCAT(' Bank Withdrawal (',b.modeDescription ,') By Cheque ' )
  END 
  ELSE NULL
...
CASE a.transactionType
 ...
 FROM
accounttransaction as a
inner join bankwithdrawal as b on b.withdrawalId=a.tableDetailId
inner join account as c on b.accountRefId=c.accountId
where a.tableReference=9  
and a.accountDate between FromDate AND ToDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId
...
-- ----------------------------
-- Procedure structure for `bank_Account_Transaction_Opening`
-- ----------------------------
DROP PROCEDURE IF EXISTS `bank_Account_Transaction_Opening`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `bank_Account_Transaction_Opening`(IN `FromDate` date,IN `ToDate` date,IN `CompanyId` bigint,IN `accountYearId` bigint,IN `accountId` bigint)
BEGIN
SELECT a.accountDate as 'accountdate',
CASE b.salesBillType
  WHEN '2' THEN CONCAT(' Cash Sales  as  Per (Bill Number : ',b.salesBillDisplayNumber,')')
...
inner join salesbill as b on b.salesBillID=a.tableDetailId
where a.tableReference=1  and a.transactionType=1
and a.accountDate < FromDate  AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId and a.accountRefId=accountId
union
SELECT a.accountDate as 'accountdate',
CASE b.salesBillRefId  WHEN '0' THEN
...
CASE b.depositMode
                        WHEN '1' THEN
																	CONCAT('Cash deposited in ',c.accountName)
  ELSE NULL
...
CASE b.withdrawalMode
                        WHEN '1' THEN
																	CONCAT('Cash Withdraw From ',c.accountName)
  ELSE NULL
...
-- ----------------------------
-- Procedure structure for `day_Transaction_Opening`
-- ----------------------------
DROP PROCEDURE IF EXISTS `day_Transaction_Opening`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `day_Transaction_Opening`(IN `FromDate` date,IN `ToDate` date,IN `CompanyId` bigint,IN `accountYearId` bigint)
BEGIN

SELECT a.date as 'transactionDate',a.created_Timestamp as 'createdTime',
CASE b.salesBillType
WHEN '1' THEN CONCAT(' Sales Credit  as  Per (Credit Bill Number : ',b.salesBillDisplayNumber,')')

  WHEN '2' THEN CONCAT(' Sales Credit  as  Per (Cash Bill Number : ',b.salesBillDisplayNumber,')')
  ELSE CONCAT(' Sales Credit  as  Per (Retail Bill Number : ',b.salesBillDisplayNumber,')')
  END  as 'Description'
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join salesbill as b on b.salesBillID=a.transactionDetailId
LEFT JOIN customer AS c on c.customerID =b.CustomerID
where a.transactionTable=1  and a.transactionType=1   AND `transactionDescription` NOT LIKE '%Cash Payment%' 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId 

UNION

SELECT a.date as 'transactionDate',a.created_Timestamp as 'createdTime',
CASE a.transactionType
WHEN '2' THEN CONCAT(' Goods sold  as  Per (Bill Number : ',b.salesBillDisplayNumber,')')
  ELSE NULL
  END  as 'Description',
CASE a.transactionType
  WHEN '1' THEN a.amount
...
inner join salesbill as b on b.salesBillID=a.transactionDetailId
LEFT JOIN customer AS c on c.customerID =b.CustomerID
where a.transactionTable=1  and a.transactionType=2 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE b.salesBillType
  ...
  WHEN '2' THEN CONCAT(' Cash Payment for Sales(Cash Bill Number : ',b.salesBillDisplayNumber,')')
  ELSE CONCAT(' Cash Payment for Sales(Retail Bill Number : ',b.salesBillDisplayNumber,')')
  END  as 'Description',
CASE a.transactionType
  WHEN '1' THEN a.amount
  ELSE NULL
...
inner join salesbill as b on b.salesBillID=a.transactionDetailId
LEFT JOIN customer AS c on c.customerID =b.CustomerID
where a.transactionTable=1  and a.transactionType=1  AND `transactionDescription` LIKE '%Cash Payment%' 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join salespayment as b on b.salesPaymentId=a.transactionDetailId
left join salesbill as c on c.salesBillID=b.salesBillRefId
left join customer as d on d.customerID=b.customerRefId
where a.transactionTable=5  and a.transactionType=1  
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId 
...
SELECT a.date as 'transactionDate',a.created_Timestamp as 'createdTime',
CASE b.purchaseBillType
WHEN '1' THEN CONCAT(' Purchase Debit  as  Per (Credit Bill Number : ',b.purchaseBillDisplayNumber,')')

  WHEN '2' THEN CONCAT(' Purchase Debit  as  Per (Cash Bill Number : ',b.purchaseBillDisplayNumber,')')
  ELSE CONCAT(' Purchase Debit  as  Per (Retail Bill Number : ',b.purchaseBillDisplayNumber,')')
  END  as 'Description'
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join purchasebill as b on b.purchaseBillID=a.transactionDetailId
LEFT JOIN customer AS c on c.customerID =b.CustomerID
where a.transactionTable=3  and a.transactionType=2   AND `transactionDescription` NOT LIKE '%Purchase Cash%' 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId 
...
SELECT a.date as 'transactionDate',a.created_Timestamp as 'createdTime',
CASE a.transactionType
WHEN '1' THEN CONCAT(' Goods sold  as  Per (Bill Number : ',b.purchaseBillDisplayNumber,')')
  ELSE NULL
  END  as 'Description',
CASE a.transactionType
  WHEN '1' THEN a.amount
...
inner join purchasebill as b on b.purchaseBillID=a.transactionDetailId
LEFT JOIN customer AS c on c.customerID =b.CustomerID
where a.transactionTable=3  and a.transactionType=1 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE b.purchaseBillType
  ...
  WHEN '2' THEN CONCAT(' Cash Payment for Purchase(Cash Bill Number : ',b.purchaseBillDisplayNumber,')')
  ELSE CONCAT(' Cash Payment for Purchase(Retail Bill Number : ',b.purchaseBillDisplayNumber,')')
  END  as 'Description',
CASE a.transactionType
  WHEN '1' THEN a.amount
  ELSE NULL
...
inner join purchasebill as b on b.purchaseBillID=a.transactionDetailId
LEFT JOIN customer AS c on c.customerID =b.CustomerID
where a.transactionTable=3  and a.transactionType=2  AND `transactionDescription` LIKE '%Purchase Cash%' 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join purchasepayment as b on b.purchasePaymentId=a.transactionDetailId
left join purchasebill as c on c.purchaseBillID=b.purchaseBillRefId
left join customer as d on d.customerID=b.customerRefId
where a.transactionTable=6  and a.transactionType=2  
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join expenses as b on b.expenseId=a.transactionDetailId
left join expensecategory as c on c.expenseCategoryId=b.expenseCateogryRefId
left join expensesubcategory as d on d.expenseCategoryRefId=c.expenseCategoryId
where a.transactionTable=7  and a.transactionType=2  
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join bankdeposit as b on b.depositId=a.transactionDetailId
inner join account as c on b.accountRefId=c.accountId
where a.transactionTable=8 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId
...
CASE a.transactionType
 ...
 FROM
daytransaction as a
inner join bankwithdrawal as b on b.withdrawalId=a.transactionDetailId
inner join account as c on b.accountRefId=c.accountId
where a.transactionTable=9 
and a.date < FromDate AND a.companyRefId=CompanyId
and a.accountYearRefId=accountYearId

ORDER BY transactionDate,createdTime ;
...
-- ----------------------------
-- Procedure structure for `day_Transaction_Report`
-- ----------------------------
DROP PROCEDURE IF EXISTS `day_Transaction_Report`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `day_Transaction_Report`(IN `FromDate` date,IN `ToDate` date,IN `CompanyId` bigint,IN `accountYearId` bigint)
BEGIN
...
union
SELECT a.date as 'transactionDate',a.created_Timestamp as 'createdTime',
CASE a.transactionTable  WHEN '8' THEN
        CASE b.depositMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Bank Deposited (',b.modeDescription ,') By Cash ' )
                        WHEN '2' THEN
...
SELECT a.date as 'transactionDate',a.created_Timestamp as 'createdTime',
CASE a.transactionTable  WHEN '9' THEN
        CASE b.withdrawalMode
                        WHEN '1' THEN
                                                                                        CONCAT(' Bank Withdrawal (',b.modeDescription ,') By Cash ' )
                        WHEN '2' THEN
...
SELECT a.date as stockdate,c.journal_Id as billnumber,
'journal' as billtype,
...
inner join journal as c on c.journal_Id=b.journal_Ref_Id
where a.tableReferenceId=11  and a.type=2 and a.commodityRefId=Commodity 
and a.date between FromDate AND ToDate AND a.companyRefId=FirmID and a.accountYearRefId=AccountYear GROUP BY c.journal_Id
...
inner join journalitems as b on a.tableReferenceDetailId=b.journal_Items_Id
inner join journal as c on c.journal_Id=b.journal_Ref_Id
where a.tableReferenceId=11  and a.type=1 and a.commodityRefId=Commodity 
and a.date between FromDate AND ToDate AND a.companyRefId=FirmID and a.accountYearRefId=AccountYear GROUP BY c.journal_Id
...
inner join journal as c on c.journal_Id=b.journal_Ref_Id
where a.tableReferenceId=11  and a.type=2 and a.commodityRefId=Commodity 
and a.date < FromDate AND a.companyRefId=FirmID and a.accountYearRefId=AccountYear GROUP BY c.journal_Id
