...
where c." . salesbill_sales_bill_id . "=" . $salesBillId;
    ...
    public static function addSalesBill() {
        ...
        try {
            ...
            $sql = "insert into " . table_sales_bill . "(" . salesbill_sales_bill_number . ","
                    ...
                    . "," . salesbill_address_id . "," . salesbill_total_square_feet . "," . salesbill_total_weight
                    . ")"
            ...
            $parameter = array(':' . salesbill_sales_bill_number => generalhelper::getGetElement('billNumber'),
                ...
                ':' . salesbill_total_square_feet => generalhelper::getGetElement('totalSquareFeet'),
                ':' . salesbill_total_weight => generalhelper::getGetElement('totalLineWeight')
            );
    ...
    public static function saveInvoiceItems() {
        ...
        try {
            ...
            $lineUOMQuanity = generalhelper::getGetElementArray('lineWeight');
            ...
            for ($increment = 0; $increment < count($linetotal); $increment++) {
                ...
                $datafieldsValue = array(salesbillitem_sales_bill_ref_id => self::$salesBillId,
                    ...
                    salesbillitem_total_UOM_quantity => $lineUOMQuanity[$increment],
        ...
        try {
            ...
            for ($increment = $start; $increment < $end; $increment++) {
                ...
                $updatStockSql = "update " . table_opening_stock . " set " . openingstock_trial_UOM_quantity
                        . " = " . openingstock_trial_UOM_quantity . " - " . $lineUOMQuanity[$arraycount]
                        . " , " . openingstock_closing_UOMQuantity
                        . " = " . openingstock_closing_UOMQuantity . " - " . $lineUOMQuanity[$arraycount] .
                ...
                $datafieldsValue = array(stock_UOM_id => $lineUOM[$arraycount]
                    , stock_UOM_quantity => $lineUOMQuanity[$arraycount],
    ...
    public static function getSalesInvoiceDetails() {
        ...
        $sql = "SELECT a." . salesbill_total_square_feet . ",a." . salesbill_total_weight . ",a." . salesbill_sales_bill_id . ",a." . salesbill_sales_bill_display_number
                ...
                . " inner join customeraddress as g on g.customerRefId=a.CustomerID
                inner JOIN " . table_city . " as d ON d." . city_id . " = g." . customeraddress_city_ref_id . " and g." . customer_active_flag . " = 1
                inner JOIN " . table_state . " as e ON e." . state_id . " = g." . customeraddress_state_ref_id . " and d." . state_active_flag . " = 1
