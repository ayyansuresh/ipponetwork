    ...
    public static function addSalesBill() {
        ...
        try {
            ...
            $sql = "insert into " . table_sales_bill . "(" . salesbill_sales_bill_number . ","
                    ...
                    . "," . salesbill_address_id . "," . salesbill_account_ref_id . "," . salesbill_vat_cst_flag . "," . salesbill_customerType . "," . salesbill_fright
                    . ")"
            ...
            $parameter = array(
                ...
                ':' . salesbill_total_discount => generalhelper::getGetElement('discount'),
                ...
                ':' . salesbill_customerType => generalhelper::getGetElement('partyType'),
                ':' . salesbill_fright => generalhelper::getGetElement('totalFreight')
            );
