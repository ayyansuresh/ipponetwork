...
class salescstvatModel extends Controller {
    ...
    public static function saveInvoiceItems() {
        ...
        try {
            ...
            $datafields = array(salesbillitem_sales_bill_ref_id, salesbillitem_sales_bill_date,
                ...
                salesbillitem_vat_rate, salesbillitem_vat_total,
                salesbillitem_cst_rate, salesbillitem_cst_total,
            ...
            for ($increment = 0; $increment < count($linetotal); $increment++) {
                ...
                $datafieldsValue = array(salesbillitem_sales_bill_ref_id => self::$salesBillId,
                    ...
                    salesbillitem_vat_rate => $linecgstrate[$increment],
                    salesbillitem_vat_total => $linecgsttotal,
                    salesbillitem_cst_rate => $lineigstrate[$increment],
                    salesbillitem_cst_total => $lineigsttotal,
