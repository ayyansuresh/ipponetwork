...
where c." . salesbill_sales_bill_id . "=" . $salesBillId;
    ...
    public static function addSalesBill() {
        ...
        try {
            ...
            $sql = "insert into " . table_sales_bill . "(" . salesbill_sales_bill_number . ","
                    ...
                    . "," . salesbill_address_id . "," . salesbill_account_ref_id . "," . salesbill_incentiveAmount ."," . salesbill_vat_cst_flag 
                    . ")"
                    ...
                    . ",:" . salesbill_transport . ",:" . salesbill_bundle
                    . ",:" . salesbill_total_discount . ",:" . salesbill_product_discount
                    . ",:" . salesbill_address_id . ",:" . salesbill_account_ref_id . ",:" . salesbill_incentiveAmount .
            ...
            $parameter = array(
                ...
                ':' . salesbill_incentiveAmount => generalhelper::getGetElement('incentiveAmount'),
    ...
    public static function saveInvoiceItems() {
        ...
        try {
            ...
            $incentivePercentage = generalhelper::getGetElementArray('incentivePercentage');
            $incentiveTaxAmount = generalhelper::getGetElementArray('incentiveTaxAmount');
            ...
            $datafields = array(salesbillitem_sales_bill_ref_id, salesbillitem_sales_bill_date,
                ...
                salesbillitem_bags,salesbillitem_incentivePercentage,salesbillitem_incentiveTaxamount
            );
            for ($increment = 0; $increment < count($linetotal); $increment++) {
                ...
                $datafieldsValue = array(salesbillitem_sales_bill_ref_id => self::$salesBillId,
                    ...
                    salesbillitem_incentivePercentage => $incentivePercentage[$increment],
                    salesbillitem_incentiveTaxamount => $incentiveTaxAmount[$increment]
                );
    ...
    public static function getSalesInvoiceDetails() {
        ...
        $sql = "SELECT a." . salesbill_sales_bill_id . ",a." . salesbill_sales_bill_display_number
                ...
                ",a." . salesbill_sales_bill_status . ",a." . salesbill_sales_bill_stage . ",a." . salesbill_gst_type . ",a." . salesbill_incentiveAmount .
                ",b." . customer_aadharNumber . ",b." . customer_id .",b." . customer_name . ",b." . customer_gst_number . ",b." . customer_party_gst_type . ",b." . customer_type .
                ...
                . " inner join customeraddress as c on c.addressId=a.addressRefId
    ...
    public static function companyDetails() {
        $sql = "SELECT a.*,b.*,c.*,d.* from " . table_company . " as a"
                . " inner join " . table_company_address . " as b on a." . company_id .
                " = b ." . companyaddress_company_ref_id .
                " inner join " . table_state . " as c on b." .companyaddress_state_ref_id. " = c.".state_id.
                " inner join " . table_city . " as d on b." .companyaddress_city_ref_id. " = d.".city_id.
    ...
    public static function getBillItem($billId) {
       echo $sql = "select a.*,b.*,c.*,d.* from " . table_sales_bill_item . " as a " .
                ...
                " inner join " . table_uom . " as d on a. " . salesbillitem_UOM_ref_id . " = d. " . uom_id . 
                " where a." . salesbillitem_sales_bill_ref_id . " = " . $billId;
        $query = self::$db->prepare($sql);
        $query->execute();
        return $query->fetchAll();
 ...
 public static function  getBillValue() {
        $sql = "select * from " . table_journal . " where "
    ...
    public static function  getLastDeliveryBillDetail() {
       $sql = "select max(" . journal_deliverynumber . ") as lastBillNumber from " . table_journal . " where "
                . journal_companyRefId . " = :" . journal_companyRefId .
                " and " . journal_accountYearRefId . " = :" . journal_accountYearRefId;
        $query = self::$db->prepare($sql);
        $query->execute(array(':' . journal_companyRefId => generalhelper::getSessionElement('beebooklogincompanyid'),
