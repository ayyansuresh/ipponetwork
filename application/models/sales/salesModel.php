...
where c." . salesbill_sales_bill_id . "=" . $salesBillId;
    ...
    public static function addSalesBill() {
        ...
        try {
            ...
            $sql = "insert into " . table_sales_bill . "(" . salesbill_sales_bill_number . ","
                    ...
                    . "," . salesbill_packing_charge . "," . salesbill_postage_charge
                    . ")"
    ...
    public static function getSalesInvoiceDetails() {
        ...
        $sql = "SELECT a." . salesbill_despatched_to . ",a." . salesbill_lorry_number . ","
                . "a." . salesbill_document_through . ","
                . "a." . salesbill_packing_charge . ",a." . salesbill_postage_charge . ","
                . "a." . salesbill_sales_bill_id . ",a." . salesbill_sales_bill_display_number
                ...
                left join " . table_company . " as f ON f." . company_id . " = a." . salesbill_company_ref_id . " 
    ...
    public static function getCustomerNameByID($customerID) {
        $sql = "Select " . customer_name . " as Name from " . table_customer . "
    ...
    public static function getStaffNameByID($staffID) {
        $sql = "Select " . staff_name . " as Name from " . table_staff . "
    ...
    public static function getReceiptDetailsById() {
        ...
        LEFT JOIN " . table_customer . " as b on a." . salespayment_customer_ref_id . " = b." . customer_id . "
    ...
    public static function getBillDetailsByIdGold() {
        $billId = generalhelper::getGetElement('salesBillId');
        $sql = "select a.*,b.*,c.*,"
    ...
    public static function getGoldReceiptDetailsById() {
        ...
        $sql = "select a." . salespayment_receipt_number . ",a." . salespayment_id . ", a." .
                ...
                . ", a." . salespayment_mode_description . " from " . table_sales_payment . " as a
        LEFT JOIN " . table_customer . " as b on a." . salespayment_customer_ref_id . " = b." . customer_id . "
        INNER JOIN " . table_salesbill_gold . " as c on c." . salesbill_sales_bill_id . " = a." . salespayment_salesbill_ref_id . "
            INNER JOIN " . table_account . " as d on a." . salespayment_account_ref_id . "= d." . account_id . "
              INNER JOIN " . table_payment_mode . " as e on a." . salespayment_mode . "= e." . paymentmode_id . "
        where a." . salesbill_company_ref_id . " =:" . salesbill_company_ref_id .
                " and a." . salesbill_account_year_ref_id . "=:" . salesbill_account_year_ref_id
    ...
    public static function getSalesInvoiceCofeeGstDetails() {
        ...
        $sql = "SELECT a." . salesbill_sales_bill_id . ",a." . salesbill_sales_bill_display_number
                ...
                ",b." . customer_aadharNumber . ",b." . customer_name . ",b." . customer_gst_number . ",b." . customer_party_gst_type . ",b." . customer_type .
                ",g.*,c." . customeraddress_address1 . " as customeraddress1, c." . customeraddress_address2 . " as customeraddress2 , d." . city_name . " as city ,e." . state_Code . ",e." . state_name . " as state ,f." . company_name_english . ",f." . company_name_tamil .
                ",h.*,i." . purchaseorder_id . ",i." . purchaseorder_purchaseorderNumber . ",i." . purchaseorder_purchaseorderDate . ",k." . salescustomeraddress_address1 . " as shippmentaddress1,k." . salescustomeraddress_address2 . " as shippmentaddress2 ,k." . salescustomeraddress_countryName . ",k." . salescustomeraddress_cityName . " as shipcity ,k." . salescustomeraddress_stateName . " as shipstate,k." . salescustomeraddress_pinCode . ",k." . salescustomeraddress_mobile .
                " FROM " . table_sales_bill . " as a left JOIN " . table_purchaseorder . " as i ON a." . salesbill_purchaseOrderRefId . " = i." . purchaseorder_id .
                ...
                " left JOIN " . table_salescustomeraddress . " as k ON k." . salescustomeraddress_salesbillRefId . " = a." . salesbill_sales_bill_id .
    ...
    public static function getCustomerShipmentAddress() {
        ...
        $sql = "SELECT a.*, b." . city_name . " as cityName ,c." . state_name
                . " as stateName ,d." . country_name . " as country from " . table_customershipmentaddress .
                " as a inner JOIN " . table_city . " as b ON b." . city_id . " = a." . customershippmentaddress_city_ref_id .
                " inner JOIN " . table_state . " as c ON c." . state_id . " = a." . customershippmentaddress_state_ref_id .
                " inner JOIN " . table_country . " as d ON d." . country_id . " = a." . customershippmentaddress_country_ref_id
                . " where a." . customershippmentaddress_customer_ref_id . " = " . $customerId;
        $query = self::$db->prepare($sql);
        $query->execute();
        return $query->fetchAll();
    }

    public static function saveInvoiceShipment() {
        self::$db->beginTransaction();
        $commit = self::addSalesBillShipment();
    ...
    public static function addSalesBillShipment() {
        $commit = 1;
        try {
            $billNumber = self::getLastBillNumber(generalhelper::getGetElement('billGSTType')) + 1;
            ?>
            ...
            $sql = "insert into " . table_sales_bill . "(" . salesbill_sales_bill_number . ","
                    ...
                    . "," . salesbill_address_id . "," . salesbill_account_ref_id . "," . salesbill_vat_cst_flag
                    . "," . salesbill_despatched_to . "," . salesbill_lorry_number . "," . salesbill_document_through
                    . "," . salesbill_packing_charge . "," . salesbill_postage_charge . "," . salesbill_ewayBillNumber . "," . salesbill_totalNumberOfBags
                    . ")"
                    . " values (:" . salesbill_sales_bill_number
                    . ",:" . salesbill_sales_bill_display_number . ",:" . salesbill_sales_bill_date
                    . ",:" . salesbill_customer_id . ",:" . salesbill_cgst_total . ",:" . salesbill_sgst_total
    ...
    public static function getBillDetailsByShipment() {
        $gstBillType = generalhelper::getGetElement('gstType'); //Within State
        $billNumber = generalhelper::getGetElement('billNumber');
        $vatCstFlag = generalhelper::getGetElement('vatCstFlag');
        ...
        $sql = "select a.*,b.*,c.* from " . table_sales_bill . " as a " .
                " left join " . table_village_customer . " as b on a." . salesbill_sales_bill_id . " = b." .
                village_billRefId . " inner join " . table_salescustomeraddress . " as c on a." . salesbill_customer_id . " = c." .
                salescustomeraddress_customer_ref_id . " and a." . salesbill_sales_bill_id . " = c." . salescustomeraddress_salesbillRefId .
                " where a." . salesbill_company_ref_id . " = " . generalhelper::getSessionElement('beebooklogincompanyid') .
                " and a." . salesbill_account_year_ref_id . " = " . generalhelper::getSessionElement('beebookloginaccountyearid') .
                " and a." . salesbill_gst_type . " = " . $gstBillType .
                " and a." . salesbill_sales_bill_number . " = " . $billNumber
    ...
    public static function updateInvoiceShipment() {
        $billType = generalhelper::getGetElement('billType');
        self::$db->beginTransaction();
        $commit = 1;
        $commit = self::removeBill();
        ...
        if ($commit == 1) {
            $commit = self::addSalesShipmentAddressUpdate($salesBillLastId);
        }
        if ($commit == 1) {
            self::$db->commit();
        } else {
    ...
    public static function addSalesShipmentAddressUpdate($salesBillLastId) {
        $commit = 1;
        try {
            $salesBillId = generalhelper::getGetElement('shipmentSalesbillRefId');
            $salesaddressdeleteSql = "delete  from " . table_salescustomeraddress . " where " . salescustomeraddress_salesbillRefId . "=" . $salesBillId;

            $addressdeleteSql = self::$db->prepare($salesaddressdeleteSql);
            $addressdeleteSql->execute();
            $sql = "insert into " . table_salescustomeraddress . "(" . salescustomeraddress_customer_ref_id .
                    "," . salescustomeraddress_address1 .
                    "," . salescustomeraddress_address2 . "," . salescustomeraddress_countryName
                    . "," . salescustomeraddress_stateName .
    ...
    public static function updateSalesBil() {

        $commit = 1;
        try {
            $updateSalesbillSql = "update " . table_sales_bill . " set " . salesbill_creditPointFlag
                    . " = 0 where " . salesbill_salesbill_id . " = " . $salesbillid;
            $updateSalesbill = self::$db->prepare($updateSalesbillSql);
            $updateSalesbill->execute();
        } catch (PDOException $ex) {
            $commit = 0;
            echo $ex;
        } catch (Exception $ex) {
