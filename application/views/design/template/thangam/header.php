                ...
                <div class="nav-wrapper">
                    ...
                    <div class="col s12">
                        ...
                        <ul id='master' class='dropdown-content'>
                            ...
                            <li class="divider"></li>
                            <li onclick="loadNewVendor();"><a href="#!">New Customer</a></li>
                            <li class="divider"></li>
                            <li onclick="loadVendorUpdate();"><a href="#!">Customer Update</a></li>
                            <li class="divider"></li>
                        ...
                        <ul id='salesEntry' class='dropdown-content'>
                           <!-- <li onclick="loadSalesBillForm(1, 0,<?php echo client_Live ?>);"><a href="#!">GST(WITHIN STATE)</a></li>
                            <li class="divider"></li> -->
                            <li onclick="loadRetailForm(3, 0)"><a href="#!">Sales Entry Form</a></li>
                            <li class="divider"></li>
                        ...
                        <ul id='salesUpdate' class='dropdown-content'>
                            <!--  <li onclick="updateSales(1, 0);"><a href="#!">GST(WITHIN STATE)</a></li>
                              <li class="divider"></li> -->
                            <li onclick="loadRetailUpdateForm(3, 0)"><a href="#!">Update Sales Entry</a></li>
                            <li class="divider"></li>
                        ...
                        <ul id='reportsMenu' class='dropdown-content'>
                            ...
                            <li class="divider"></li>
                            <li onclick="loadDayWiseStockReports();"><a href="#!">Daywise Stock Reports</a></li>
                            <li class="divider"></li>
                            <li onclick="loadDayWiseReports();"><a href="#!">Daywise Reports</a></li>
                            <li class="divider"></li>
                            <li onclick="loadCustomerCreditPointReports();"><a href="#!">Customer Credit Point Reports</a></li>
                            <li class="divider"></li>
