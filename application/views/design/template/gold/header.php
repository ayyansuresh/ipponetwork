            ...
            <div class="nav-wrapper">
                ...
                <div class="col s12">
                    <ul class="left hide-on-med-and-down">
                        ...
                        <li><a class="dropdown-button"  data-activates="estimateEntry" href="#!">Order Entry<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                    ...
                    <ul id='master' class='dropdown-content'>
                        ...
                        <ul id='estimateEntry' class='dropdown-content'>
                            <li onclick="loadEstimateBillForm(1, 0);"><a href="#!">Order Entry</a></li>
                            <li class="divider"></li>
                        ...
                        <ul id='salesPrint' class='dropdown-content'>
                            ...
                            <li class="divider"></li>
                            <li onclick="billPrintOrder(1, 0);"><a href="#!">ORDER ENTRY PRINT</a></li>
                            <li class="divider"></li>
                            <li onclick="billPrintOrderInvoice(1, 0);"><a href="#!">ORDER INVOICE PRINT</a></li>
                            <li class="divider"></li>
                ...
                <ul id='purchaseEntry' class='dropdown-content'>
                    ...
                    <li class="divider"></li>-->
                    <li onclick="loadPurchaseGoldBillForm(1, 0);"><a href="#!">Purchase Entry</a></li>
                    <li class="divider"></li>
                    <li onclick="updatePurchaseGold(1);"><a href="#!">Purchase Update</a></li>
                    <li class="divider"></li>
               ...
               <!-- <ul id='purchaseUpdate' class='dropdown-content'>
                ...
                <ul id='salesEntry' class='dropdown-content'>
                    <li onclick="loadSalesBillForm(1, 0);"><a href="#!">Sales Entry</a></li>
                    <li class="divider"></li>
                    <li onclick="updateSales(1, 0);"><a href="#!">Sales Update</a></li>
                    <li class="divider"></li>
                </ul>
                <ul id='salesUpdate' class='dropdown-content'>
                    <li onclick="updateSales(1, 0);"><a href="#!">GST(WITHIN STATE)</a></li>
            ...
            <div class="nav-wrapper">
                ...
                <div class="col s12">
                    ...
                    <li class="divider"></li>
                        ...
                        <ul id='estimateEntry' class='dropdown-content'>
                            <li onclick="loadEstimateBillForm(1, 0);"><a href="#!">GST(WITHIN STATE)</a></li>
                            <li class="divider"></li>
                        </ul>
                        <ul id='salesPrint' class='dropdown-content'>
                            <li onclick="billPrint(1, 0);"><a href="#!">GST(WITHIN STATE)</a></li>
