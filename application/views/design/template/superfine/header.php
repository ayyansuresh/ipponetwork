                ...
                <div class="col s12">
                    ...
                    <!--    <li><a class="dropdown-button" data-activates="print" href="#!">Reports<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                     !-->   <li><a class="dropdown-button" data-activates="salesPrint" href="#!">Bill print<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        ...
                        <li><a class="dropdown-button" data-activates="journalMenu" href="#!">Delivery<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                    ...
                    <ul id='master' class='dropdown-content'>
                        ...
                        <li onclick="loadroomrent();"><a href="#!" >Room Rent</a></li>
                        <li class="divider"></li>
                        <li onclick="loadupdateroomrent();"><a href="#!" >Update Room Rent</a></li>
                        <li class="divider"></li>
                        ...
                        <ul class="collapsible collapsible-accordion">
                            ...
                            <li class="bold teal lighten-2"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-autorenew"></i> TRANSACTIONS</a>
                                <div class="collapsible-body">
                                    ...
                                    <ul id='journalMenu' class='dropdown-content'>
                                    <li onclick="loadDeliveryOutEntry();"><a href="#!">Delivery</a></li>
                                    <li class="divider"></li>
                                    <li onclick="loadDeliveryReturnSearch();"><a href="#!">Delivery Return</a></li>
                                    <li class="divider"></li>
                                       <li onclick="loadDeliveryPrint(1, 0);"><a href="#!">Delivery Print</a></li>
                                    <li class="divider"></li>   
                                    <!--<li onclick="loadDeleteJournal();"><a href="#!">Journal Delete</a></li>
                                    <li class="divider">loadDeliveryReturnEntry</li>-->
                                    </ul>
                                </div>
                            </li>
                        </ul>
