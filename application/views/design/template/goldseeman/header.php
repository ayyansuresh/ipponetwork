                ...
                <div class="nav-wrapper">
                    ...
                    <div class="col s12">
                        <ul class="left hide-on-med-and-down">
                           ...
                           <li><a class="dropdown-button"  data-activates="orderEntry" href="#!">Order Entry<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                       ...
                       <!--    <li><a class="dropdown-button" data-activates="print" href="#!">Reports<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        ...
                        <ul id='master' class='dropdown-content'>
                            ...
                            <ul id='orderEntry' class='dropdown-content'>
                            <li onclick="loadOrderEntryForm(1, 0);"><a href="#!">Order Entry</a></li>
                            <li class="divider"></li>
                            <li onclick="loadOrderUpdate(1, 0);"><a href="#!">Order Entry Update</a></li>
                            <li class="divider"></li>
                            <li onclick="loadEstimateInvoice(1, 0);"><a href="#!">Order Invoice</a></li>
                            <li class="divider"></li>
                            <li onclick="loadOrderInvoiceUpdate(1, 0);"><a href="#!">Order Invoice Update</a></li>
                            <li class="divider"></li>
                        </ul>
