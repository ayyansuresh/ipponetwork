            ...
            <div class="nav-wrapper">
                ...
                <div class="col s12">
                    ...
                    <ul id='salesPrint' class='dropdown-content'>
                        ...
                        <li class="divider"></li>
                        <li onclick="billPrintThermal(3, 0)"><a href="#!">Retail Bill Thermal</a></li>
                        <li class="divider"></li>
                    ...
                    <ul id='reportsMenu' class='dropdown-content'>
                        ...
                        <li class="divider"></li>
                        <li onclick="loadDeletePaidTax();"><a href="#!">Delete Paid GST Entry</a></li>
                    ...
                    <ul id='txnMenu' class='dropdown-content'>
                        ...
                        <li class="divider"></li>      
                        <li onclick="loadTaxEntry();"><a href="#!">Paid GST Entry</a></li>
