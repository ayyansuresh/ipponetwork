            ...
            <div class="nav-wrapper">
                ...
                <div class="col s12">
                    <ul class="left hide-on-med-and-down">
                        ...
                        <li><a class="dropdown-button" data-activates="purchaseEntry" href="#!">Purchase<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                       <!-- <li><a class="dropdown-button" data-activates="purchaseUpdate" href="#!">Purchase Update<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        <!--<li><a class="dropdown-button" data-activates="purchaseOrder" href="#!">PO Entry<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        <li><a class="dropdown-button" data-activates="purchaseOrderUpdate" href="#!">PO Update<i class="mdi-navigation-arrow-drop-down right"></i></a></li>-->
                     <!--   <li><a class="dropdown-button" data-activates="purchaseOrderSales" href="#!">PO Sales<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        <li><a class="dropdown-button" data-activates="purchaseOrderSalesUpdate" href="#!">PO Sales Update<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                       !--> <li><a class="dropdown-button"  data-activates="salesEntry" href="#!">Sales<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                    ...
                    <!--    <li><a class="dropdown-button" data-activates="print" href="#!">Reports<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                     !-->   <li><a class="dropdown-button" data-activates="salesPrint" href="#!">Bill print<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        ...
                        <li><a class="dropdown-button" data-activates="outpassMenu" href="#!">Outpass<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        <li><a class="dropdown-button" data-activates="invoiceMenu" href="#!">Vendor Invoice<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        <li><a class="dropdown-button" data-activates="journalMenu" href="#!">Journal Entry<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                    ...
                    <ul id='master' class='dropdown-content'>
                        ...
                        <li class="divider"></li>
                        <li onclick="loadCommodityForm();"><a href="#!">Add Material Type</a></li>
                        <li class="divider"></li>
                        <li onclick="loadUpdateCommodity();"><a href="#!">Material Type Update</a></li>
                        <li class="divider"></li>
                        <!-- <li onclick="newItemForm_New();"><a href="#!" >Add Product</a></li>
                         <li class="divider"></li>
                         <li onclick="newItemForm_Update();"><a href="#!" > Product Update</a></li>
                         <li class="divider"></li>
                         ...
                         <li class="divider"></li>
                        -->
                        <li><a href="#!" onclick="loadNewMaterial();">New Material </a></li>
                        <li class="divider"></li>
                        <li onclick="loadNewMaterialUpdate();"><a href="#!">Material Update </a></li>
                        <li class="divider"></li>
                        <li onclick="loadItemDescriptionForm();"><a href="#!">Item Description</a></li>
                        <li class="divider"></li>
                        <li onclick="loadUpdateDescriptionForm();"><a href="#!">Item Description Update</a></li>
                        <li class="divider"></li>
                        <!-- <li onclick="loadNewVendor();"><a href="#!">New Vendor</a></li>
                         <li class="divider"></li>
                         <li onclick="loadVendorUpdate();"><a href="#!">Vendor Update</a></li>
                         <li class="divider"></li>
                        -->
                        <!-- <li onclick="loadAddShippmentCustomer();"><a href="#!" >New Shippment Customer</a></li>
                         <li class="divider"></li>
                         <li onclick="loadEditShippmentCustomer();"><a href="#!" >Shippment Customer update</a></li>
                         <li class="divider"></li>
                        -->
                   ...
                   <ul id='purchaseEntry' class='dropdown-content'>
                       <li onclick="loadPurchaseBillFormTextile(1, 0);"><a href="#!">GST(WITHIN STATE)</a></li>
                       <li class="divider"></li>
                       <li onclick="loadPurchaseBillFormTextile(2, 0);"><a href="#!">GST(OTHER STATE)</a></li>
                       <li class="divider"></li>
...
!-->
                        <ul id='salesEntry' class='dropdown-content'>
                            <!-- <li onclick="poSales(1, 0);"><a href="#!">PO Sales(WITHIN STATE)</a></li>
                             <li class="divider"></li>
                             <li onclick="poSales(2, 0);"><a href="#!">PO Sales(OTHER STATE)</a></li>
                             <li class="divider"></li>
                            -->
                            <li onclick="loadSalesBillForm(1, 0,<?php echo client_Live ?>);"><a href="#!">SALES ENTRY(WS)</a></li>
                            <li class="divider"></li>
                            <li onclick="loadSalesBillForm(2, 0,<?php echo client_Live ?>);"><a href="#!">SALES ENTRY(OS)</a></li>
                            <li class="divider"></li>
                            <li onclick="updateSales(1, 0);"><a href="#!">UPDATE SALES(WS)</a></li>
                            <li class="divider"></li>
                            <li onclick="updateSales(2, 0);"><a href="#!">UPDATE SALES(OS)</a></li>
                            <li class="divider"></li>

                            <!--  <li class="divider"></li>
                                                    <li onclick="loadSalesBillForm(2, 0,<?php // echo client_Live     ?>);"><a href="#!">GST(OTHER STATE)</a></li> 
                              <li class="divider"></li>
                        ...
                        <ul id='salesUpdate' class='dropdown-content'>
                            <!-- <li onclick="poSalesUpdate(1, 0);"><a href="#!">PO Sales Update(WITHIN STATE)</a></li>
                             <li class="divider"></li>
                             <li onclick="poSalesUpdate(2, 0);"><a href="#!">PO Sales Update(OTHER STATE)</a></li>
                             <li class="divider"></li>  
                            -->
                            <li onclick="updateSales(1, 0);"><a href="#!">GST Update(WITHIN STATE)</a></li>
                            <li class="divider"></li>
                            <li onclick="updateSales(2, 0);"><a href="#!">GST Update(OTHER STATE)</a></li>
                            <li class="divider"></li>
                        ...
                        <ul id='reportsMenu' class='dropdown-content'>
                            ...
                            <li class="divider"></li>
                            -->
                            <li onclick="loadVendorStockReports();"><a href="#!">Stock Reports</a></li>
                            <li class="divider"></li>
                            <li onclick="loadStockDetailedReports();"><a href="#!">Stock Detailed Reports</a></li>
                            <li class="divider"></li>
                            <li onclick="loadItemStockReports();"><a href="#!">Item Stock Reports</a></li>
                            <li class="divider"></li>
                            <li onclick="loadItemStockDetailedReports();"><a href="#!">Item Stock Detailed Reports</a></li>
                            <li class="divider"></li>
                            ...
                            <li class="divider"></li>
                            <!--  <li onclick="loadCustomerPoReports();"><a href="#!">Customer Wise Po Reports</a></li>
                              <li class="divider"></li>
                              <li onclick="loadPoSalesReports();"><a href="#!">Po Sales Reports</a></li>
                              <li class="divider"></li>
                            -->
                        </ul>
                        <ul id='txnMenu' class='dropdown-content'>
                            ...
                            <li class="divider"></li>
                            <li onclick="purchasePaymentOldBills();"><a href="#!">Purchase Payment (Old Bills)</a></li>
                            <li class="divider"></li>
                        ...
                        <ul id='outpassMenu' class='dropdown-content'>
                            <li onclick="outpassEntry();"><a href="#!">Issue Entry</a></li>
                            <li class="divider"></li>
                            <li onclick="outpassUpdate();"><a href="#!">Issue Update</a></li>
                            <li class="divider"></li>
                            <li onclick="receiveEntry();"><a href="#!">Receive Entry</a></li>
                            <li class="divider"></li>
                            <li onclick="receiveUpdate();"><a href="#!">Receive Update</a></li>
                            <li class="divider"></li>
                            <!-- <li onclick="vendorOutpassEntry();"><a href="#!">Vendor Outpass Entry</a></li>
                             <li class="divider"></li>
                             <li onclick="vendorOutpassUpdate();"><a href="#!">Vendor Outpass Update</a></li>
                             <li class="divider"></li>
                            -->
                        </ul>
                        <ul id='invoiceMenu' class='dropdown-content'>
                            <li onclick="invoiceEntry();"><a href="#!">Vendor Invoice Entry</a></li>
                            <li class="divider"></li>
                            <li onclick="invoiceUpdate();"><a href="#!">Vendor Invoice Update</a></li>
                            <li class="divider"></li>
                        </ul>
                ...
                <ul id='purchaseEntry' class='dropdown-content'>
                    <li onclick="loadPurchaseBillForm(1);"><a href="#!">PURCHASE ENTRY(WS)</a></li>
                    <li class="divider"></li>
                    <li onclick="loadPurchaseBillForm(2);"><a href="#!">PURCHASE ENTRY(OS)</a></li>
                    <li class="divider"></li>
                    <li onclick="updatePurchase(1);"><a href="#!">UPDATE PURCHASE(WS)</a></li>
                    <li class="divider"></li>
                    <li onclick="updatePurchase(2);"><a href="#!">UPDATE PURCHASE(OS)</a></li>
                    <li class="divider"></li>
                ...
                <ul id='purchaseOrder' class='dropdown-content'>
                    <li onclick="loadPurchaseOrderForm(1, 0);"><a href="#!">PO ENTRY(WITHIN STATE)</a></li>
                    <li class="divider"></li>
                    <li onclick="loadPurchaseOrderForm(2, 0);"><a href="#!">PO ENTRY(OTHER STATE)</a></li>
                    <li class="divider"></li>
                </ul>

                <ul id='purchaseOrderUpdate' class='dropdown-content'>
                    <li onclick="poUpdate(1, 0);"><a href="#!">PO UPDATE(WITHIN STATE)</a></li>
                    <li class="divider"></li>
                    <li onclick="poUpdate(2, 0);"><a href="#!">PO UPDATE(OTHER STATE)</a></li>
                    <li class="divider"></li>
                </ul>

                <!-- <ul id='purchaseOrderSales' class='dropdown-content'>
                       <li onclick="poSales(1, 0);"><a href="#!">PO Sales(WITHIN STATE)</a></li>
                       <li class="divider"></li>
                       <li onclick="poSales(2, 0);"><a href="#!">PO Sales(OTHER STATE)</a></li>
                   </ul>
                
                <ul id='purchaseOrderSalesUpdate' class='dropdown-content'>
                    <li onclick="poSalesUpdate(1, 0);"><a href="#!">PO Sales Update(WITHIN STATE)</a></li>
                    <li class="divider"></li>
                    <li onclick="poSalesUpdate(2, 0);"><a href="#!">PO Sales Update(OTHER STATE)</a></li>
                </ul>
