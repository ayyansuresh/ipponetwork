...
<header id="header" class="page-topbar">
            ...
            <div class="nav-wrapper">
                ...
                <div class="col s12">
                    ...
                    <ul id='master' class='dropdown-content'>
                        ...
                        <li class="divider"></li>
                        <li onclick="loadCommodityForm();"><a href="#!">Add Commodity</a></li>
                        <li class="divider"></li>
                        ...
                        <li class="divider"></li>
                       <li><a href="#!" onclick="loadCommodityFormWithItem();">New Commodity WithItem</a></li>
                        <li class="divider"></li>
                        <li onclick="loadUpdateCommodityWithItem();"><a href="#!">Commodity WithItem Update </a></li>
                        <li class="divider"></li>
                        ...
                        <li class="divider"></li>
                        <!--<li onclick="loadUpdateNewMaterial();"><a href="#!">Material Update </a></li>-->
                        <li class="divider"></li>
 ...
 !-->
                        <ul id='salesEntry' class='dropdown-content'>
                            ...
                            <li class="divider"></li>
                            <li onclick="loadSalesBillForm(1, 0,<?php echo client_Live ?>);"><a href="#!">GST(WITHIN STATE)</a></li>
                        ...
                        <ul id='outpassMenu' class='dropdown-content'>
                            <li onclick="outpassEntry();"><a href="#!">Outpass Entry</a></li>
                            <li class="divider"></li>
                            <li onclick="outpassUpdate();"><a href="#!">Outpass Update</a></li>
                            <li class="divider"></li>
