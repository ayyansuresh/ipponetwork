...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Sub Product Update</h4>
    </div>
    <div class="card-panel">
        <h4 class="header2">Search Sub Product</h4>
        <div class="row">
            <div class="row">
