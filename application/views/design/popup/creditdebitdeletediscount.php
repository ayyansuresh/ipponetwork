...
<div id="creditDebitDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            ...
                            <input type="hidden" id="creditDebitId" />
                            <input type="hidden" id="txntype" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteCreditDebitDiscount();">Delete</button>
