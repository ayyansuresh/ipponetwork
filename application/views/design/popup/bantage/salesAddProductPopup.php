...
<div id="newProductForSales" class="modal modal-fixed-footer teal" >
                    ...
                    <div class="row">
                        <form class="col s12" id="newsalesproductform">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m4" id="normalCustomer" >
                                    <div class="input-group">
                                        ...
                                        <div class="sel-wrap">
                                            <select id="description" class="floating-label active" >
                                                <option value="" selected >Select Customer</option>
                                                <?php echo itemBlock::getItemDescription(""); ?>
                                            </select>
                                            <div class='bar'></div>
                                        </div>  
                                    </div>
                                    <script>
                                        floatingSelect2('description');
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m3" style="display: none">
                                    <i class="mdi-action-event prefix"></i>
                                    <select id="unitRateType" class="floating-label active">
                                        <option value="1"  >Per Kg</option>
                                        <option value="0" selected >Per Bag</option>
                                    </select>
                                    <div class='bar'></div>
                                    <label for="unitRateType" class="active">unit Rate Type</label>
                                    <script>
                                        floatingSelect2('unitRateType');
                                        $("#unitRateType").val("0").trigger("change");
                                    </script>
                                ...
                                <div class="input-field col s12 m3">
                                    <input id="itemdiscount" type="text" >
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="billItemDiscountSave();">Save</button>
