...
?>
<div id="newPopup" class="modal modal-fixed-footer teal" >
    <div class="modal-content" >
        <div id="newIssuePopup">
            
        </div>                 
        <div class="modal-footer green lighten-4">
            <button  class="waves-effect waves-green btn-flat" onclick="makeIssueEntry();">Save</button>
