...
<div id="expenseEntryPopupWS" class="modal modal-fixed-footer teal" >
    <div class="modal-content" id="expenseEntrySave">
    </div>
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeExpensePaymentModal();">Close</button>
    </div>
</div>