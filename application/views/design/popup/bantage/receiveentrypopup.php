...
?>
<div id="newPopupR" class="modal modal-fixed-footer teal" >
    <div class="modal-content" >
        <div id="newReceivePopup">
            
        </div>                 
        <div class="modal-footer green lighten-4">
            <button  class="waves-effect waves-green btn-flat" onclick="makeReceiveInvoicePrint();">Save</button>
