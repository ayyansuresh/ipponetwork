                        ...
                        <form class="col s12" id="newsalesproductform">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m4"  >
                                    ...
                                    <label for="productDescription" class="active">product Description</label>
                                </div>
                            ...
                            <div class="row" style="display:none">
                                ...
                                <div class="input-field col s12 m8" <?php echo $igstdisplay; ?>>
                                    ...
                                    <label for="vatRate" class="active">VAT(%)</label>
                                </div>
                                <div class="input-field col s12 m8" <?php echo $igstdisplay; ?>>
                                    <input id="cstRate" type="text" value="0.00" readonly="">
                                    <label for="csttRate" class="active">CST(%)</label>
                                </div>
                                <div class="input-field col s12 m4" >
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m2">
                                    ...
                                    <label for="numberOfBags" >Total Weight</label>
                                </div>
                                 <div class="input-field col s12 m2">
                                    <input id="invoiceValue" type="text" >
                                    <label for="invoiceValue" >Invoice Value</label>
                                </div>
                                <div class="input-field col s12 m2">
                                    <input id="rateOfCommission" type="text" >
                                    <label for="rateOfCommission" >Rate Of Commission</label>
                                </div>

                                <div class="input-field col s12 m2">
                                    <input id="salesBillItemCurrencyTotal" type="text" onchange="changeUnitRate();">
                                    <label for="salesBillItemCurrencyTotal" >Amount In Convert Currency</label>
                                </div>
                                
                                <div class="input-field col s12 m2">
                                    <input id="currencyValue" type="text" value="1" onchange="changeUnitRate();" <?php echo $readonly;?>  <?php echo $active;?>>
                                    <label for="currencyValue" class="active" >currency Value</label>
                                </div>
