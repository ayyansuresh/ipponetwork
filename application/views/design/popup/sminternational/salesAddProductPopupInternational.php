                        ...
                        <form class="col s12" id="newsalesproductform">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m2" style="display:none">
                                    ...
                                    <label class="active" for="productquantity" class="active">Quantity</label>
                                ...
                                <div class="input-field col s12 m2">
                                    <div class="input-group">
                                        ...
                                        <div class="sel-wrap">
                                            <select id="rateOfCommission" class="floating-label active">
                                                <option value=""  disabled >Rate of Comission</option>
                                                <option value="11" >0%</option>
                                                <option value="1" selected>1%</option>
                                                <option value="2"  >0.5%</option>
                                                <option value="7" >0.10%</option>
                                                <option value="8" >0.15%</option>
                                                <option value="9" >0.20%</option>
                                                <option value="10" >0.25%</option>
                                                <option value="3" >(1%-1$/MT)/2</option>
                                                <option value="4" >(1%/3)</option>
                                                <option value="5" >(0.5%-1$/MT)/2</option>
                                                <option value="6" >(0.5%/3)</option>
                                                <option value="12" >0.75%</option>
                                ...
                                <div class="input-field col s12 m2" id="nillAmountInCurrency" >
                                    <input id="salesBillItemCurrencyTotal" type="text"  onchange="changeUnitRate();">
                                    <label class="active" for="salesBillItemCurrencyTotal" >Amount In Convert Currency</label>
                                </div>
                                
                      
                                <div class="input-field col s12 m1">
                                    <input id="currencyValue" type="text" value="1" onchange="changeUnitRate();" <?php echo $readonly; ?>  <?php echo $active; ?>>
                                    <label class="active" for="currencyValue" class="active" >currency Value</label>
                                </div>
