...
<div id="salesOldPaymentDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            ...
                            <input type="hidden" id="salesPaymentId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteOldSalesPayment();">Delete</button>
