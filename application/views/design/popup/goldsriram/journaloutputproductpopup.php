<div id="newOutputProductForJournal" class="modal modal-fixed-footer teal" >
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6">
                                ...
                                <script>
                                    floatingSelect2OutJournal('journalOutputProducts', 'loadOutputUnitRate', 'outputQuantity');
                                </script>
                            </div>
                            <div class="input-field col s12 m3">
                                <input id="outputQuantity" type="text" >
                                <label for="outputQuantity" >Taken Quantity</label>
                            </div>
                        </div>
                    </div>
                    <br/>
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="journalOutputSave();">Save</button>
