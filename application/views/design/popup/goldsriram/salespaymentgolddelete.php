...
<div id="salesPaymentGoldDeletePopupWS" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            ...
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteSalesPayment();">Delete</button>
