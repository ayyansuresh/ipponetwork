...
<div id="bankWithdrawalDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Bank Withdrawal</h4>
                            <input type="hidden" id="withdrawId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteWithdrawal();">Delete</button>
