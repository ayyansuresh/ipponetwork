...
<div id="oldProductForPurchase" class="modal modal-fixed-footer teal" >
    <div class="modal-content">
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <h4 class="header2">Purchase Old Product</h4>
                    <div class="row">
                        <form class="col s12" id="newsalesproductform">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m2" tabindex="1">
                                    <div class="input-group">
                                ...
                                <div class="input-field col s12 m1" tabindex="4">
                                    <input id="vadPurchase" type="text" value="0" onchange="calculateAmountForPurchase();" >
                                    <label class="active" for="vadPurchase" >Less Weight</label>
                                </div>
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="oldItemSave();">Save</button>
