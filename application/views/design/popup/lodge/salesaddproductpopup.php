                            ...
                            <div class="row">
                                <div class="input-field col s12 m3">
                                    <div class="input-group">
                                        <label for="commodityRefId" class="active">Room Type</label>
                                        <div class="sel-wrap">
                                ...
                                <div class="input-field col s12 m2">
                                    ...
                                    <label for="unitRate" class="active" >Per Day</label>
                                </div>
                                <div class="input-field col s12 m2">
                                ...
                                <div id="loadRoomList">
                                    <div class="input-field col s12 m3">
                                        <label for="salesproductName" class="active">Available Room</label>  
                                    </div>
                                </div>
