...
<div id="StockTransferEntryDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Stock Transfer Entry</h4>
                            <input type="hidden" id="stockTransferId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteStockTransferEntries();">Delete</button>
