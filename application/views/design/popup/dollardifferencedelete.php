...
<div id="dollarDifferenceDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Dollar Difference</h4>
                            <input type="hidden" id="dollarDifferenceId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteDollarDifferenceDetails();">Delete</button>
