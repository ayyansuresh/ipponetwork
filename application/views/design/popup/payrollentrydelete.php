...
<div id="PayrollEntryDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Payroll Entry</h4>
                            <input type="hidden" id="payrollId" />
                            <input type="hidden" id="expenseId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deletePayrollEntries();">Delete</button>
