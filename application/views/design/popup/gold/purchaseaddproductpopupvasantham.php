...
<div id="newProductForSales" class="modal modal-fixed-footer teal" >
                        ...
                        <form class="col s12" id="newsalesproductform">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m4">
                                    ...
                                    <label for="productquantity" >CRT/PIECE</label>
                                    <input id="commodityRefId" type="hidden" >
                                </div>

                                <div class="input-field col s12 m4">
                                    <input id="perCRT" type="text" value="1" >
                                    <label for="perCRT" class="active">PER CRT</label>
                                </div>
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="purchasebillItemSave();">Save</button>
