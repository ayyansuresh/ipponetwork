...
<div id="paidTaxDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Paid Tax</h4>
                            <input type="hidden" id="taxId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteTaxEntry();">Delete</button>
