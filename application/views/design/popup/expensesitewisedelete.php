...
<div id="expenseDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete sitwise expenses Expense</h4>
                            <input type="hidden" id="expenseId" />
                            <input type="hidden" id="sitewiseexpensesId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteSitewiseExpense();">Delete</button>
