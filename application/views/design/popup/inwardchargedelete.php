...
<div id="inwardChargeDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Credit/Debit Discount</h4>
                            <input type="hidden" id="inwardChargeId" />
                            <input type="hidden" id="txntype" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteInwardTransferDetails();">Delete</button>
