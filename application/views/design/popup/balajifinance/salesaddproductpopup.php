...
<div id="newProductForSales" class="modal modal-fixed-footer teal" >
                        ...
                        <form class="col s12" id="newsalesproductform">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m3">
                                    <input id="salesproductName" type="text" >
                                    <label for="salesproductName" >Item Name</label>
                                </div>
                            ...
                            <div class="row" style="display:none">
                                ...
                                <div class="input-field col s12 m4" >
                                    <input id="hsnCode" type="text" value="0" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m3">
                                    ...
                                    <label for="numberOfBags" >Number of Bundles</label>
                                </div>
                                
                                <!--<div class="input-field col s12 m3">
                                    <input id="packingFactor" type="text" readonly="">
                                    <label for="packingFactor" class="active"> Rate Per</label>
                                </div>-->
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="QuotationItemSave();">Save</button>
