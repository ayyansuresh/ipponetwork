...
<div id="salesPaymentReceiptPopup" class="modal modal-fixed-footer teal" >
    <div class="modal-content" id="receiptPopup">
        
    </div>
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="printReceiptGoldDetails();">Save</button>
