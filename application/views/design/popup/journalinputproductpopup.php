...
<div id="newInputProductForJournal" class="modal modal-fixed-footer teal" >
                                ...
                                <div class="input-field col s12 m4">
                                    <div class="input-group">
                                        ...
                                        <div class="sel-wrap">
                                            ...
                                            <script>
                                                appendInputProductList();
                                            </script>
                                            <div class='bar'></div>
                                        </div>  
                                    </div>
                                    <script>
                                        floatingSelect2Journal('gdcProductName', 'loadUnitRate', 'takenQuantity');
                                    </script>
                                </div>
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="journalInputSave();">Save</button>
