...
<div id="bankDepositPopup" class="modal modal-fixed-footer teal" >
    <div class="modal-content" id="bankDepositSave">
    </div>
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeBankDepositModal();">Close</button>
    </div>
</div>