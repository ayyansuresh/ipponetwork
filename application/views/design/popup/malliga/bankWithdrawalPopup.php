...
<div id="bankWithdrawalPopup" class="modal modal-fixed-footer teal" >
    <div class="modal-content" id="bankWithdrawalSave">
    </div>
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeBankWithdrawalModal();">Close</button>
    </div>
</div>