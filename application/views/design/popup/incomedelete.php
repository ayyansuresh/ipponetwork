...
<div id="incomeDeletePopup" class="modal modal-fixed-footer teal" >
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">Delete Income</h4>
                            <input type="hidden" id="incomeId" />
                            <button  class="waves-effect waves-green btn-flat" onclick="deleteIncome();">Delete</button>
