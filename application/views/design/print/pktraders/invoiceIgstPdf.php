    ...
    <div class="container" style="font-family:arial;">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <div style="width:49.5%;height:68px;float:left;border:1px solid #000;border-top:none;border-right:none;font-size:12px !important;">
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:12px !important;">
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle($sales[salesbill_igst_total]) ?></strong></div>
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle($sales[salesbill_round_off]) ?></strong></div>
                    </div>
                    <div style="width:100%;">
