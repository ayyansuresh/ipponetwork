                        ...
                        <div style="padding:1.4%;">
                            <table style="width:100%;font-family:sans-serif !important;font-size:12px !important;">
                                ...
                                <tr>
                                    ...
                                    <td>Time:</td>
                                    <td><strong><?php echo date("h:i:sa") ?></strong></td>
                                </tr>
        ...
        <div >
            ...
            <table  style="width:100%;height:128px;font-size:12px !important;border-top:1px dashed #000;border-bottom:1px dashed #000;border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="4" style="text-align:left;"><strong>CGST (Rs):<?php echo $saleItem[salesbillitem_cgst_total]; ?></strong></td>
                        
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align:left;"><strong>SGST (Rs):<?php echo $saleItem[salesbillitem_sgst_total]; ?></strong></td>
                        
                    </tr>
                    
                    <tr>
                        <td colspan="4" style="border-top:1px dashed #000;text-align:right;"><strong>Total Bill Amount:</strong></td>
                        <td style="border-top:1px dashed #000;text-align:center;padding-right: 1%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sales_bill_total] +$saleItem[salesbillitem_cgst_total]+$saleItem[salesbillitem_sgst_total] )); ?></strong></td>
                    </tr>
