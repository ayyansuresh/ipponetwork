            ...
            <div class="row" style="font-size: 11px !important;">
                <div class="col-xs-12">
                    <div class="row" style="width:100%;">
                             ...
                             <div style="font-size:12px !important;width:100%;text-align:left;padding-top:0.5%;">
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="font-size: 13px;width:10%;border-right:1px solid #000;float:left;text-align: center;"><strong>IGST</strong></div>
                        <div style="font-size: 13px;width:20%;border-right:1px solid #000;float:left;text-align: center;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_igst_total])) ?></strong></div>
