    ...
    <?php echo $companyDetails[companyaddress_bank] ?> A/C NO :<?php echo $companyDetails[companyaddress_accno] ?>
                    ...
                    <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:15px !important;">
                        ...
                        <div style="width:100%;">
                            ...
                            <div style="width:26.5%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_igst_total])) ?></strong></div>
