    ...
    <div class="container" style="font-family:arial;">
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:65%;float:left; padding-left: 2%">
                    <div style="text-align: left;" class="panel-body">
                        <div style="font-size:28px !important;"><strong><?php echo $companyDetails[company_name_english] ?></strong></div>
                        <div style="font-size:12px !important;">
                            <?php echo $companyDetails[companyaddress_address1] ?>,
                            <?php echo $companyDetails[companyaddress_address2] ?>,
                            Sivakasi - <?php echo $companyDetails[companyaddress_pinCode] ?><br>
        ...
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:14px !important;width:35%;float:left;border:1px solid #000;height:125px;">
                        <div class="panel panel-default">
                            <div class="panel-body" style="padding:1.4%;"> 
                             ...
                             <div style="font-size:14px !important;width:30%;float:left;border:1px solid #000;border-left:none;height:125px;" >
                        <div class="panel panel-default" style="padding-left: 3%;">
                            <br/>COMPANY BANK DETAILS 
                    ...
                    <div style="font-size:14px !important;width:34.40%;float:left;border:1px solid #000;border-left:none;height:125px;">
                        <div class="panel panel-default">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:14px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            if ($saleItem[salesbillitem_igst_total] != 0) {
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%;border-right:1px solid #000;padding-left:1%;padding-top:1%;"><strong><?php echo $saleItem[items_name]; ?></strong></td>
                        ...
                        if ($sales[salesbill_igst_total] != 0) {
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="border-right:1px solid #fff;border-top:1px solid #000;text-align:right;border-top:1px solid #000;"></strong></td>
                            <td style="border-right:1px solid #fff;text-align: right;border-top:1px solid #000;padding-right:1%;border-top:1px solid #000;"></strong></td>
                ...
                <div style="font-family:arial;font-size:13px !important;width:64.50%;height:110px;float:left;border:1px solid #000;border-top:none;border-right:none;">
                    <div style="padding-left:1%;">
                     ...
                     <div style="padding-left:0%;">
                        ...
                        <br>
                        Document Through :<STRONG><?php echo $sales[salesbill_document_through] ?></STRONG><br>
                    </div>
                    </div>
                </div>
                ...
                <div style="width:35%;height:110px;float:left;border:1px solid #000;border-top:none;font-size:12px !important;">
                    <div style="width:100%;">
                        <div style="width:64.25%;border-right:1px solid #000;border-bottom:1px solid #fff;float:left;text-align: right;padding-right: 4%;"><strong>IGST (<?php echo $saleItem[salesbillitem_igst_rate] ?> %)</strong></div>
