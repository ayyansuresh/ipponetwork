                    ...
                    <div style="font-size:12px !important;width:55%;float:left;border-top:1px dashed #000;">
                        <div class="panel panel-default">
                            <div class="panel-body" style="padding:1.4%;"> 
                                ...
                                STATE CODE : <?php echo $sales[state_Code]; ?>
                                ...
                                if ($sales[customer_gst_number] != "") {
                                    ?>
                                    GSTIN:&nbsp;&nbsp;
                                    <?php echo $sales[customer_gst_number] ?>
                                    <?php
                                } else {
                                    ?>
                                    AADHAR Number:&nbsp;&nbsp;
                                    <?php echo $sales[customer_aadharNumber] ?>
                                    <?php
                                }
                                ?>
                                <br/>
                ...
                <table class="table table-condensed" style="width:100%;height:128px;font-size:12px !important;border-top:1px dashed #000;border-bottom:1px dashed #000;border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            <td colspan="2" style="border-bottom:1px dashed #000;text-align: center;">IGST</td>
                        </tr>
                        <tr>
                           <td style="border-bottom:1px dashed #000;border-right:1px dashed #000;text-align: center;">Rate<br/>(%)</td>
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            ?>
                            <tr>
                                             <td style="width:2%;text-align: right;padding-right:1%;border-right:1px dashed #000;"><?php echo $count ?></td>
                                ...
                                <td style="width:5%;text-align: center;padding-right:1%;border-right:1px dashed #000;"><?php echo $saleItem[salesbillitem_quantity] ?></td>

                                <td style="width:10%;text-align: center;padding-right:1%;border-right:1px dashed #000;"><?php echo generalhelper::formatInIndianStyle($saleItem[salesbillitem_unit_rate]) ?></td>
                                <td style="width:10.5%;text-align: right;border-right:1px dashed #000;padding-right:1%;font-size:13px !important;">
                                        <?php
                                        echo generalhelper::formatInIndianStyle($saleItem[salesbillitem_total]);
                                        ?></td>
                                <td style="text-align: center;border-right:1px dashed #000;"><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_igst_rate])) ?></td>
                                <td style="text-align: center;"><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_igst_total])) ?></td>
                            </tr>
                            <?php
                            $count++;
                        ...
                        ?>
                            ...
                            <td style="text-align: right;border-right:1px dashed #000;border-top:1px dashed #000;padding-right:1%;"><?php echo $finalquantity ?></td>
                            <td colspan="2" style="padding-right:1%;border-right:1px dashed #000;border-top:1px dashed #000;text-align:right;"><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_running_total])) ?></td>
                            <td  style="border-top:1px dashed #000;border-right:1px dashed #000;text-align:center;">&nbsp;</td>
                            <td style="border-top:1px dashed #000;text-align:center;"><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_igst_total])) ?></td>
                        </tr>
