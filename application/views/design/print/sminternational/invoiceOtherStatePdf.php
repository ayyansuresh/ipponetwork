            ...
            <div class="table-responsive">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:15px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    <thead>
                        <tr>
                            ...
                            <td rowspan="2" style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Commission In INR</strong></td>
                        </tr>
                        <tr>
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Contract No<br/>Dated</strong></td>
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Product / Shipment / Seller</strong></td>
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            if ($saleItem[salesbillitem_unit_rate] > 0) {
                                ?>
                                <tr>
                                    <td style="width:2%;border-right:1px solid #000;text-align: center;padding-right:1%;padding-top:0%;"><?php echo $count ?></td>

                                    <td style="width:25%;border-right:1px solid #000;text-align: center;padding-left:1%;padding-top:1.5%;"><?php echo $saleItem[salesbillitem_contractnumber]; ?></td>
                                    <td style="width:50%;border-right:1px solid #000;text-align: left;padding-right:1%;padding-top:1.5%;"><?php echo $saleItem[items_name] . " " . $saleItem[salesbillitem_description]; ?></td>
                                    <td style="border-right:1px solid #000;text-align: center;padding-right:0%;"><?php //echo $saleItem[salesbillitem_hsn_code_ref_id] ?></td>
                                    <td style="width:15%;border-right:1px solid #000;text-align: center;padding-right:0%;padding-top:2%;"><?php echo $saleItem[salesbillitem_bags] ?> MT</td>
                                    <td style="width:25%;border-right:1px solid #000;text-align: center;padding-right:0%;padding-top:1.5%;"><?php echo number_format($saleItem[salesbillitem_total_invoice], 2); ?> * <?php echo number_format($saleItem[salesbillitem_currency_value], 2); ?><br/>= <?php echo number_format($saleItem[salesbillitem_currency_total], 2); ?></td>

                            <td style="width:10%;border-right:1px solid #000;text-align: center;padding-right:1%;padding-top:0.5%;"><?php echo $saleItem[rate_commssion_formula] ?></td>
                            <td style="width:10%;text-align: right;padding-right:1%;border-right:1px solid #000;padding-top:0%;">
                                <?php
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    <div style="width:100%;height:17px;">
                        <div style="width:64.25%;border-right:1px solid #000;float:left;text-align: right;padding-right: 4%;font-size:12px !important;"><strong>IGST(18%)</strong></div>
                        <div style="width:30.25%;float:left;text-align: right;font-size:12px !important;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_igst_total])) ?></strong>
                        </div>
                    </div>
                    ...
                    <div style="width:100%;height:101px;">
                        <div style="width:64.25%;float:left;border-right:1px solid #000;border-top:1px solid #000;text-align: right;padding-right: 4%;padding-top:60px;height:40px;">
                            <strong>GRAND TOTAL (Rs.)</strong>
                        </div>
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;padding-top:60px;height:40px;">
                ...
                <div style="width:100%;">
                    <div style="width:100%;font-size:12px !important;float:left;border:1px solid #000;text-align: left;padding-left: 3%;border-top:none;">
                        Amount in Words: <strong><?php echo ucfirst(generalhelper::convertNumberToWordsForIndia($sales[salesbill_sales_bill_total])); ?> </strong>
                    </div>
                </div>
                <!--<div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    <div style="width:100%;">
