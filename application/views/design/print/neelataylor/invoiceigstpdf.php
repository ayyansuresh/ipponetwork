...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                <div style="width:15%;float:left;padding:0% 2%;">
                    ...
                    ?>
                    <img src="<?php echo URL; ?>assets/img/logo/lakshmi.jpg" style="height:135px;width:100px" />
                    <?php
                    }else{
                    ?>
        ...
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:13px !important;width:49.8%;float:left;border:1px solid #000;height:125px;">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:20px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    <thead>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Value<br/>(Rs.)</strong></td>                      </tr>
                    </thead>
                    <tbody>
                        <?php
                        $finalquantity = 0;
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="border-right:1px solid #000;padding-left:1%;padding-top:3%;"><strong><?php echo $saleItem[items_name]; ?></strong><br/><?php echo $saleItem[salesbillitem_description]; ?></td>
                                ...
                                <td style="width:10%;text-align: right;padding-right:1%;border-right:1px solid #000;padding-top:2%;"><strong>
                                        ...
                                        ?></strong></td>
                                <td style="width:3%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:2%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_igst_rate])) ?></strong></td>
                                <td style="width:10%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:2%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_igst_total])) ?></strong></td>
                            </tr>
                            <?php
                            $count++;
                        }
                        for ($increment = $count; $increment <= 17; $increment++) {
                            ?>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="border-right:1px solid #000;border-top:1px solid #000;text-align:right;border-top:1px solid #000;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_igst_total])) ?></strong></td>
                        </tr>
