        ...
        <div class="col-md-12">
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="border-right:1px solid #000;padding-left:1%;text-align:left;padding-top:2%;"><strong><?php echo $saleItem[items_name]; ?></strong><br/>(<?php echo $saleItem[salesbillitem_description]; ?>)</td>
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    ...
                    <div style="width:100%;">
                        <div style="width:64.25%;border-top:1px solid #000;border-right:1px solid #000;float:left;text-align: right;padding-right: 4%;"><strong>IGST</strong></div>
                    ...
                    <!--<div style="width:100%;">
                        <div style="width:64.25%;float:left;text-align: right;padding-right: 4%;"><strong></strong></div>
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong>&nbsp;</strong>
                        </div>
                    </div>-->
