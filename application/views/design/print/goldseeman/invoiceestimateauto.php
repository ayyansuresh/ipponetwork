...
$invoice = salesInvoiceBlock::getEstimateInvoiceDetails();
 ...
 */
$printer->text("\n");
$invoiceItemDetails = salesInvoiceBlock::getSalesInvoiceItemDetails($salesbillid);
$printer->text("  ----------------------------------------\n");
...
$invoicePurchaseItemDetails = salesInvoiceBlock::getPurchaseInvoiceItemDetails($salesbillid);
