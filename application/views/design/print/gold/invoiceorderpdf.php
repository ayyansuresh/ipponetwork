...
$status = 1;
$invoice = salesInvoiceBlock::getSalesEstimateDetails();
...
foreach ($invoice as $sales) {
    ...
    $invoicePurchaseItemDetails = salesInvoiceBlock::getPurchaseInvoiceItemDetails($sales[salesbillgoldestimate_sales_bill_id]);
    //$purchaseBillCount = salesInvoiceBlock::getPurchaseInvoiceItemCount($sales[salesbill_sales_bill_id]);
    //echo $purchaseBillCount;
    if (($sales[salesbillgoldestimate_taxflag] == 0) && ($sales['advance'] == $sales[salesbillgold_sales_bill_total])) {
        $printcount = 1;
...
<div class="container" style="font-family:arial;">
            ...
            <div style="width:100%;border:1px solid #000;height:25px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:55%;float:left;">
                    <div style="text-align: center;" class="panel-body"><br/>
                        ...
                        <label></label></div>
                        <br/><div style="font-size:12px !important;"><strong>ORDER BILL</strong></div><br>    
                    </div>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div style="padding:1.4%;">
                                <table style="font-family:arial;font-size:14px !important;">
                                    ...
                                    <tr>
                                        <td>Date:</td>
                                        <td><strong><?php echo date("d-m-Y", strtotime($sales[salesbillgoldestimate_sales_bill_date])) ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td>Gold Rate :</td>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <?php
                $sales[salesbillgoldestimate_sales_bill_id];
                $invoiceItemDetails = salesInvoiceBlock::getSalesEstimateItemDetails($sales[salesbillgoldestimate_sales_bill_id]);
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="width:13%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:0.5%;"><strong><?php echo number_format($saleItem[salesbillitemgoldestimate_quantity],3); ?> <?php echo $saleItem[uom_name] ?></strong></td>
                                <td style="width:5%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:0.5%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitemgoldestimate_unit_rate])); ?></strong></td>
                                <td style="width:5%;border-right:1px solid #000;text-align: center;padding-right:1%;padding-top:0.5%;"><strong><?php echo number_format($saleItem[salesbillitemgoldestimate_vad],3); ?></strong></td>
                                <td style="width:8%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:0.5%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitemgoldestimate_makingCharge])); ?></strong></td>
                                <td style="width:15%;text-align: right;padding-right:1%;font-size:13px !important;padding-top:0.5%;"><strong>
                                        <?php
                                        echo generalhelper::formatInIndianStyle(sprintf('%.2f',$saleItem[salesbillitemgoldestimate_total]));
                                        ?></strong>
                            </tr>
                            <?php
                            $count++;
                        ...
                        for ($increment = $count; $increment <= 10; $increment++) {
                            ...
                            <tr>
                                ...
                                <td style="width:5%;border-right:1px solid #000;text-align: right;padding-right:1%;">&nbsp;</td>
                                <td style="width:5%;border-right:1px solid #000;text-align: right;padding-right:1%;">&nbsp;</td>
                                <td style="width:15%;border-right:1px solid #000;text-align: right;padding-right:1%;">&nbsp;</td>
                            </tr>
                            <?php
                        }
                ...
                if($billcount > 0){
                    ?>
                        <tr>
                                ...
                                <td style="width:15%;text-align: right;padding-right:1%;font-size:13px !important;padding-top:0.5%;"><strong></strong>
                            </tr>            
                <?php
                        $finalquantity = 0;
                        $count = 1;
...
?>            
                ...
                <div style="width:49.5%;height:120px;float:left;border:1px solid #000;border-top:none;border-right:none;font-size:12px !important;">
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    <div style="width:100%;">
                        <div style="width:64.25%;border-right:1px solid #000;float:left;text-align: right;padding-right: 4%;"><strong>Order Amount</strong></div>
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbillgoldestimate_running_total])); ?></strong>
                        </div>
                    </div>
                    <div style="width:100%;">
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbillgoldestimate_round_off])); ?></strong></div>
                    </div>
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;font-size:15px !important;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbillgoldestimate_sales_bill_total])); ?></strong>
                        </div>
                    </div>
                </div>
                    <?php
                ...
                <div style="width:49.5%;height:100px;float:left;border:1px solid #000;border-top:none;border-right:none;font-size:12px !important;">
                    <div style="padding-left:1%;">
                        <!--<label>E. & O.E</label>
                        <br/>OUR BANK DETAILS : <STRONG><?php //echo $sales[account_name] ?></STRONG><BR/>
                        <STRONG>A/C NO :</STRONG> <?php //echo $sales[account_number] ?>
                ...
                <div style="width:100%;">
                    <div style="width:100%;font-size:14px !important;float:left;border:1px solid #000;text-align: left;padding-left: 3%;border-top:none;">
                        <strong><?php echo ucfirst(generalhelper::convertNumberToWordsForIndia($sales[salesbillgoldestimate_sales_bill_total])); ?> </strong>
                    </div>
                </div>
                <div style="width:100%;text-align:right;padding-top:0.5%;font-size:14px !important;">
                    ...
                    <div style="width:50%;float:left;text-align: left;">
                     <?php 
                        if($sales['advance'] == $sales[salesbillgoldestimate_sales_bill_total]){
                        ?>
                        <label><strong>Order Amount Paid Successfully</strong> <?php //echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales['advance'])); ?></label>
                        <?php
                        }else{
                        ?>
