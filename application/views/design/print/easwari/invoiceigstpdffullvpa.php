...
//                              
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            if (($count >= $pageNo * 15 - 14) && ($count <= $pageNo * 15)) {
                                ...
                                if ($saleItem[salesbillitem_igst_rate] == '0') {
                                    $zerotaxvalue = $zerotaxvalue + $saleItem[salesbillitem_total];
                                } else if ($saleItem[salesbillitem_igst_rate] == '5') {
                                    $fivetaxvalue = $fivetaxvalue + $saleItem[salesbillitem_total];
                                    $fivetaxamount_currentrow = $saleItem[salesbillitem_igst_total];
                                    $fivetaxamount = $fivetaxamount + $fivetaxamount_currentrow;
                                } else if ($saleItem[salesbillitem_igst_rate] == '12') {
                                    $twelvetaxamount_currentrow = $saleItem[salesbillitem_igst_total];
                                    $twelvetaxvalue = $twelvetaxvalue + $twelvetaxamount_currentrow;
                                    $twelvetaxamount = $twelvetaxamount + $twelvetaxamount_currentrow;
                                } else if ($saleItem[salesbillitem_igst_rate] == '18') {
                                    $eighteentaxamount_currentrow = $saleItem[salesbillitem_igst_total] ;
                                ...
                                } else if ($saleItem[salesbillitem_igst_rate] == '28') {
                                    $twentyeightamount_currentrow = $saleItem[salesbillitem_igst_total] ;
                                ...
                                $igsttotal = $igsttotal + $saleItem[salesbillitem_igst_total];
                                $sgsttotal = $sgsttotal + $saleItem[salesbillitem_sgst_total];
                                $grandtotal = $runningtotal + $sgsttotal + $sgsttotal+$igsttotal;
                                ...
                                $totalTaxableValue = $totalTaxableValue + $saleItem[salesbillitem_igst_total]+ $saleItem[salesbillitem_cgst_total]+ $saleItem[salesbillitem_sgst_total];
//                                  
                                ...
                                <tr>
                                    ...
                                    <td style="width:5%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:1%;"><strong><?php echo $saleItem[salesbillitem_igst_rate]  ?></strong></td>
    ...
    if ($pageNo == $totalPages) {
        ?>
                            ...
                            <tr>
                                <td colspan="6" style="margin-right: 20px !important;text-align: right; border-right:1px solid #000; border-top:1px solid #000; padding: 0.5%;"><strong>IGST (Rs.)</strong></td>
                                <!--<td colspan="2" style="text-align: center; border-top:1px solid #000; border-right:1px solid #000;"></td>-->
                                <td colspan="2" style="text-align: right; border-top:1px solid #000;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$igsttotal)); ?></strong></td>
                            </tr>
<!--                            <tr>
                        ...
                        <table style="height:155px;width:100%;font-size:12px !important;font-family:arial;border-collapse: collapse;" border="1">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="text-align: center;background-color: #ccc;width:30%;">IGST</td>
        ...
        if ($fivetaxvalue != 0) {
            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-bottom:none;border-top:none;text-align:center;">5%</td>
                                        <td style="border-bottom:none;border-top:none;text-align:right;"><?php echo $fivetaxvalue; ?></td>
<!--                                        <td style="border-bottom:none;border-top:none;text-align:center;">2.5%</td>
        ...
        ?>
                                <tr>
                                    ...
                                    <td style="border-bottom:none;border-top:none;text-align:right;"><?php echo $twelvetaxvalue; ?></td>
<!--                                    <td style="border-bottom:none;border-top:none;text-align:center;">6%</td>
        ...
        <?php }  if ($eighteentaxvalue != 0) { ?>
                                <tr>
                                    ...
                                    <td style="border-bottom:none;border-top:none;text-align:center;">18%</td>
                                    <td style="border-bottom:none;border-top:none;text-align:right;"><?php echo $eighteentaxvalue; ?></td>
        ...
        if ($twentyeightvalue != 0) {
            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-bottom:none;border-top:none;text-align:right;"><?php echo $twentyeightvalue; ?></td>
<!--                                        <td style="border-bottom:none;border-top:none;text-align:center;">14%</td>
        ...
        ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="padding:1%;text-align: right;background-color: #ccc;"><?php echo $totalvalue; ?></td>
...
<!--                                    <td style="text-align: center;background-color: #ccc;">Tax %</td>
        ...
        <!--                                    <td style="text-align: center;background-color: #ccc;">Tax %</td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td  colspan="4" style="border-bottom:none;border-top:none;padding:0.7%;text-align:center;"></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="padding:1%;text-align: right;background-color: #ccc;"><?php echo "Carried Down ----->" ?></td>
