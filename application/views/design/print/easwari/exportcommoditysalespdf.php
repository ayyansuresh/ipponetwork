...
$commodityDetails = itemBlock::getCommodityDetailsById($commodityId,$companyId,$accountYearId);
$commodityDetailsFinal = (array) $commodityDetails[0];
?>
<link rel="stylesheet" href="<?php echo URL; ?>assets/css/materalize/plugins/data-tables/css/jquery.dataTables.min.css">
<?php
$salesReport = commoditySalesBlock::commoditySalesReport($companyId, $accountYearId);
?>
        ...
        <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
            ...
            <div style="width:100%;float:left;">
                <div style="text-align: center;" class="panel-body">
                    <div style="font-size:15px !important;"><strong>COMMODITY WISE SALES REPORT
                ...
                <tbody>
                    ...
                    foreach ($salesReport as $sales) {
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;">  <?php echo date("d-m-Y", strtotime($sales[salesbill_sales_bill_date])); ?>    </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales[salesbill_sales_bill_display_number]; ?>   </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales[customer_name]; ?>   </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales[customer_gst_number]; ?>   </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales['Quantity']; ?>  </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales['total']; ?>  </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales['cgstTotal']; ?>  </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;"> <?php echo $sales['sgstTotal']; ?> </td>
                            <td style="border:1px solid #000;text-align: center;padding:1%;width:2%;">  <?php echo $sales['igstTotal']; ?>  </td>
                        </tr>
                        <?php
                        $totalQuantity = $totalQuantity + $sales['Quantity'];
                        $totalValue = $totalValue + $sales['total'];
                        $totalCgst = $totalCgst + $sales['cgstTotal'];
                        $totalSgst = $totalSgst + $sales['sgstTotal'];
                        $totalIgst = $totalIgst + $sales['igstTotal'];
                        $count++;
                    }
                    ?>
                    <tr>
