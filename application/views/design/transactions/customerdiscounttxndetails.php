    ...
    $(document).ready(function () {
        ...
        $("#customerTransaction").submit(function (evt) {
            ...
            if ($("#customerTransaction").data().materialvalidation.methods.validate()) {
                makeCustomerTransactionDiscount();
            }
            return false;
        });
    });
...
<form id="customerTransaction">
    <div class="container teal lighten-2">
        ...
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Customer <?php echo $display ?> Discount</h4>
        </div>
        <div class="card-panel">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        <h4 class="header2"><?php echo $display ?> Discount Details</h4>
                        <div class="row">
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="sel-wrap">
                                            <select id="customerName" class="floating-label active" data-validation="select" data-content="Please Select a Customer">
                                                ...
                                                <?php echo transactionsBlock::getCustomerNameWithCity(); ?>
                                            </select>
                                            <div class='bar'></div>
                                        </div>
                                    </div>
...
<?php
$creditNoteResult = transactionsBlock::getCreditNoteDetailsDiscount($txnType);
if ($txnType == 1) {
    $display = "Credit";
} else {
    $display = "Debit";
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;"><?php echo $display ?> Discount Reports</h4>
    </div>
    <div class="card-panel">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            foreach ($creditNoteResult as $creditNote) {
                                ...
                                <tr>
                                    ...
                                    <td><i onclick="deleteCrdeitDebitNoteDiscount(
...
<?php self::loadDesign('popup/creditdebitdeletediscount'); ?>
