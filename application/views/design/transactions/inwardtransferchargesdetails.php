...
<form id="customerTransaction">
    <div class="container teal lighten-2">
        ...
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Inward Transfer Charges</h4>
        </div>
        <div class="card-panel">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        <h4 class="header2">Inward Transfer Charges Details</h4>
                        <div class="row">
                            <div class="row">
...
<?php
$creditNoteResult = transactionsBlock::getInwardTransferChargeDetails($txnType);
if ($txnType == 1) {
    $display = "Credit";
} else {
    $display = "Debit";
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Inward Transfer Charges Reports</h4>
    </div>
    <div class="card-panel">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            foreach ($creditNoteResult as $creditNote) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('d-m-Y', (strtotime($creditNote[customer_inward_charges_date]))); ?></td>
                                    <td><?php echo $creditNote[customer_name]; ?></td>
                                    <td><?php echo $creditNote[customer_inward_charges_description]; ?></td>
                                    <td><?php echo $creditNote[customer_inward_charges_amount]; ?></td>
                                    <td><i onclick="deleteInwardTransferCharges(
                                    <?php echo $creditNote[customer_inward_charges_customerInwardChargeId] ?>
                                    ,<?php echo $txnType ?>    
...
<?php self::loadDesign('popup/inwardchargedelete'); ?>
