...
<form id="customerTransaction">
    <div class="container teal lighten-2">
        ...
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Customer <?php echo $display ?> Note</h4>
        </div>
        <div class="card-panel">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        <h4 class="header2"><?php echo $display ?> Note Details</h4>
                        <div class="row">
                            <div class="row">
...
<?php
$creditNoteResult = transactionsBlock::getCreditNoteDetails($txnType);
if ($txnType == 1) {
    $display = "Credit";
} else {
    $display = "Debit";
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;"><?php echo $display ?> Note Reports</h4>
    </div>
    <div class="card-panel">
        <div class="row">
                            ...
                            foreach ($creditNoteResult as $creditNote) {
                                ...
                                <tr>
                                    ...
                                    <?php echo $creditNote[customer_credit_debit_transaction_Id] ?>
                                      ,<?php echo $txnType ?>   );" class="mdi-action-delete" style="color:red;cursor:pointer;"></i></td>
                                </tr>
                                <?php
                                $count++;
                            }
