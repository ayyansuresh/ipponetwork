    ...
    $(document).ready(function () {
        ...
        $("#customerTransaction").submit(function (evt) {
            ...
            if ($("#customerTransaction").data().materialvalidation.methods.validate()) {
                makeCustomerDebitNoteTransaction();
            }
            return false;
        });
    });
...
<form id="customerTransaction">
    <div class="container teal lighten-2">
        <input id="transactionType" type="hidden" value="2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Customer Debit Note</h4>
        </div>
        <div class="card-panel">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        <h4 class="header2">Debit Note Details</h4>
                        <div class="row">
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="sel-wrap">
                                            <select id="customerName" class="floating-label active" data-validation="select" data-content="Please Select a Customer">
                                                ...
                                                <?php echo transactionsBlock::getCustomerNameWithCityOnlyPurchaseorPurchaseSalesByCompanyId(); ?>
                                            </select>
                                            <div class='bar'></div>
                                        </div>
                                    </div>
                                    <script>
                                        floatingSelect2Change('customerName', 'loadPurchaseBillByCustomer');
                                        // $("#customerName").val("1").trigger("change");
                                    </script>
                                </div>
                                
                                <div class="input-field col s12 m4" id="loadPurchaseBill">
                                </div>
...
<?php
$creditNoteResult = transactionsBlock::getDebitNoteDetails();
?>
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Debit Note Reports</h4>
    </div>
    <div class="card-panel">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            foreach ($creditNoteResult as $creditNote) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $creditNote[purchasebill_purchase_bill_display_number]; ?></td>
                                    ...
                                    <?php echo $creditNote[customer_credit_debit_transaction_Id] ?>
                                      ,2   );" class="mdi-action-delete" style="color:red;cursor:pointer;"></i></td>
                                </tr>
                                <?php
                                $count++;
                            }
