...
<form id="customerTransaction">
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Dollar Difference</h4>
        </div>
        <div class="card-panel">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        <h4 class="header2">Dollar Difference Details</h4>
                        <div class="row">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6" id="normalCustomer" >
                                    <div class="input-group">
                                        ...
                                        <div class="sel-wrap">
                                            <select id="transactionType" class="floating-label active" data-validation="select" data-content="Please Select a Customer">
...
<?php
$creditNoteResult = transactionsBlock::getDollarDifferenceDetails();

?>
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Dollar difference Reports</h4>
    </div>
    <div class="card-panel">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            foreach ($creditNoteResult as $creditNote) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('d-m-Y', (strtotime($creditNote[customer_dollar_difference_date]))); ?></td>
                                    <td><?php echo $creditNote[customer_name]; ?></td>
                                    <td><?php echo $creditNote[customer_dollar_difference_description]; ?></td>
                                    <td><?php echo $creditNote[customer_dollar_difference_amount]; ?></td>
                                    <td><i onclick="deleteDollarDifference('<?php echo $creditNote[customer_dollar_difference_customerDollarDifferenceId] ?>');" class="mdi-action-delete" style="color:red;cursor:pointer;"></i></td>
                                </tr>
                                <?php
                                $count++;
                            }
...
<?php self::loadDesign('popup/dollardifferencedelete'); ?>
