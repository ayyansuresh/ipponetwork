<script type="text/javascript" src="<?php echo URL; ?>assets/js/invoice/newSales.js"></script>
...
<form id="salesInvoice" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Vendor Invoice <?php echo $salesDisplay; ?></h4>
        </div>
            ...
            <div class="card-panel">
                <div class="row">
                    ...
                    <div class="input-field col s12 m4">
                        <input id="partyType" type="hidden" class="validate" value="<?php echo $partyType ?>" readonly>
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="customerName" class="floating-label active" >
                                    ...
                                    <?php echo customerBlock::getVendorNameByType($partyType, $gstBillType, ""); ?>
                                </select>
                                <div class='bar'></div>
                            </div>  
                        </div>
...
<?php self::loadDesign('popup/invoice/salesAddProductPopup'); ?>
