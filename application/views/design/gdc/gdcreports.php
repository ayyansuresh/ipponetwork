...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">GDC Reports</h4>
    </div>

    <form class="formValidate" id="gdcReportsform" novalidate>
        <div class="card-panel">
            <h4 class="header2">GDC Reports</h4>
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                        <div class="input-group">
                            <label for="vanNumber1" class="active">Van Number</label>
                            <div class="sel-wrap">
                                <select id="vanNumber1" class="floating-label">
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                ...
                                <select id="productName" class="floating-label">
                                    ...
                                    <?php echo gdcBlock::getGdcItemDetails(1); ?>
