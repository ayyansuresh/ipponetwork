        ...
        <div class="row">
            ...
            <div class="card material-table">
                <div class="input-field col s12 m4 right" style="text-align: right;">
                    <button class="waves-effect waves-light btn teal darken-2" onclick="printGdcReports('<?php echo generalhelper::getGetElement('fromDate') ?>','<?php echo generalhelper::getGetElement('toDate') ?>',
                    <?php echo generalhelper::getGetElement('itemId') ?>,
                                    '<?php echo $itemName ?>','<?php echo generalhelper::getGetElement('vanId') ?>','<?php echo generalhelper::getGetElement('vanNumber') ?>');"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
                </div> 
                    ...
                    <tbody>
                        ...
                        foreach ($gdcResult as $gdcReportsResult) {
                            ...
                            <tr>
                                ...
                                <td><?php echo date('d-m-Y', (strtotime($gdcReportsResult[gdc_date]))); ?></td>
                                <td><?php echo $gdcReportsResult[gdc_staffName]; ?></td>
                                <td><?php echo $gdcReportsResult[gdcItems_takenQuantity]; ?></td>
                                <td><?php echo $gdcReportsResult[gdcItems_returnQuantity]; ?></td>
                                <td><?php echo $gdcReportsResult[gdcItems_salesQuantity]; ?></td>
