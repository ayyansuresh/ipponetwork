...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">GDC Form </h4>
    </div>
        ...
        <div class="card-panel">
            <div class="row">
                ...
                <div class="input-field col s12 m3">
                    ...
                    <input id="staffName" type="text" value="" data-validation="text" data-content="Staff Name cannot be empty">
                </div>
                <div class="input-field col s12 m3">
                    <p>
