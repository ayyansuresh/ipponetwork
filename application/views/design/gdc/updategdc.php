...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">GDC Update</h4>
    </div>
                        ...
                        <tbody>
                            ...
                            foreach ($gdcDetails as $gdcDetailsResult) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $gdcDetailsResult[gdc_van_number] ?></td>
                                    <td><?php echo $gdcDetailsResult[gdc_staffName] ?></td>
                                    <td><i class="material-icons" onclick="loadGDCUpdateDetails(<?php echo $gdcDetailsResult[gdc_id] ?>);">mode_edit</i></td>
                                </tr>
                                <?php
                                $count++;
                            }
