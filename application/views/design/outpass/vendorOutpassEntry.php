...
<form id="vendorOutpass" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Vendor Outpass Entry</h4>
        </div>
        <div class="col s12 m12 l12">
            <div class="card-panel">
                <div class="row">
                    <div class="input-field col s12 m3">
                        <input id="vendorOutpassReceiptNo" type="text" >
                    ...
                    <div class="input-field col s12 m3">
                        ...
                        <input id="mobile1" readonly="" type="text" value="Weiving">
                        <label class="active" for="mobile1">Process Type</label>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m3" >
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="uomName" class="floating-label active" >
                    ...
                    <div class="input-field col s12 m12">
                        <center><button class="waves-effect waves-light btn teal darken-2" form="vendorOutpass" type="submit" name="action">Create Vendor Outpass <i class="material-icons right">receipt</i></button></center>
                    </div>
                </div>
            </div>
        </div>
