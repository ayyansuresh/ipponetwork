...
<div class="container" style="font-family:arial;">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <?php
                $sales[jobOrder_Id];
                $invoiceItemDetails = outpassBlock :: getReceiveItemDetails($sales[jobOrder_Id]);
                ?>
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:15px !important;border:1px solid #000;border-collapse: collapse;font-family:arial;">
                    <thead>
                        <tr>
                            ...
                            <td style="border:1px solid #000;border-top:none;text-align: center;background-color: #ccc;color:#000;"><strong>Quantity</strong></td>
                            <td style="border:1px solid #000;border-top:none;text-align: center;background-color: #ccc;color:#000;"><strong>Weight<br/></strong></td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                           ...
                           // $finalquantity = $finalquantity + $saleItem[salesbillitem_quantity];
                            ...
                            <tr>
                                ...
                                <td style="width:15%;text-align: right;padding-right:1%;padding-top:0.5%;"><strong>
                                        <?php
                                        echo generalhelper::formatInIndianStyle(sprintf('%.2f',$saleItem[joborderitem_grossWeight]));
                                        ?></strong></td>
                            </tr>
                            <?php
                            $count++;
