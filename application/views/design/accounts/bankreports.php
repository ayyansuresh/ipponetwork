...
<script type="text/javascript">
    $(document).ready(function () {
        $("#bankReportsForm").materialvalidation({
            theme: "materialize"
        });
        $("#bankReportsForm").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#bankReportsForm").data().materialvalidation.methods.validate()) {
                loadBankGridDetails();
            }
            return false;
        });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Bank Reports</h4>
    </div>
    <form class="formValidate" id="bankReportsForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Bank Reports</h4>
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="accountName" class="floating-label">
                                    <option value="-3" selected disabled>Please Select</option>
                                    <?php echo accountBlock::getAccountName(); ?> 
                        ...
                        <script>
                           floatingSelect2('accountName');
                        </script>
                    </div>
                   
                    <div class="input-field col s12 m2">
                        <button class="waves-effect waves-light btn teal darken-2" form="bankReportsForm" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
