...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Search Deposits</h4>
    </div>
    <form class="formValidate" id="deleteExpenseForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Deposit Search</h4>
            <div class="row">
                <div class="row">
