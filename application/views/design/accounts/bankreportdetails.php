<?php $accountName = generalhelper::getGetElement('accountName'); ?>
...
$dayWiseOpeningBalance = accountBlock::getBankTransactionOpeningBalance($companyID, $accountYear);
$credit = 0;
$debit = 0;
...
$trialBalance = accountBlock::getAccountTrialBalance($companyID, $accountYear);
$trialBalanceFinal = (array) $trialBalance[0];

$openingStart = $trialBalanceFinal[account_opening_balance] + $credit - $debit;
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Account Ledger</h4>
    </div>
    <div class="card-panel">
      ...
      <button class="waves-effect waves-light btn teal darken-2"
                        onclick="printAccountReports('<?php echo generalhelper::getGetElement('fromDate') ?>',
                                        '<?php echo generalhelper::getGetElement('toDate') ?>',
                        <?php echo generalhelper::getGetElement('accountId') ?>,
                                        '<?php echo $accountName ?>');"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
            </div>
