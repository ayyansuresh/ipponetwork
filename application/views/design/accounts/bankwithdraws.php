...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">New Withdrawal</h4>
    </div>
        ...
        <div class="row">
            <div>
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">WITHDRAWAL DETAILS</h4>
                            <div class="row">
                                <div class="row">
                                    <div class="input-field col s12 m6">
                                        <label for="paymentDate">Withdrawal Date</label>
                                        <input id="paymentDate" type="date" class="datepicker">
                                    </div>
                                    <div class="col s12 m6">
                                        <div class="input-group">
                                            <label for="paymentMode">Select Withdrawal Mode</label>
                                            <div class="sel-wrap">
                                                <select id="paymentMode" class="floating-label active" onchange="loadWithdrawalModeDetails(this.value)">
                        ...
                        <div class="modal-footer green lighten-4">
                            <button  class="waves-effect waves-green btn-flat" onclick="saveBankWithdrawal();">Save</button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php self::loadDesign('popup/bankWithdrawalPopup'); ?>
