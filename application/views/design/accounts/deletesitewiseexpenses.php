...
$categoryResult = accountBlock::getSitewiseExpensesDetails($companyID, $accountYear);
?>
                        ...
                        <tbody>
                            ...
                            foreach ($categoryResult as $category) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $category[customer_site_name]; ?></td>
                                    ...
                                    <td><i onclick="deleteSitewiseExpenses('<?php echo $category[expenses_account]; ?>','<?php echo $category[sitewiseexpenses_id]; ?>');" class="mdi-action-delete" style="color:red;cursor:pointer;"></i></td>
                                </tr>
                                <?php
...
<?php self::loadDesign('popup/expensesitewisedelete'); ?>
