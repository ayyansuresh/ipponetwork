...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">New Expense</h4>
    </div>
    <div class="card-panel" style="margin-bottom:200px;">
                ...
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        ...
                        <div class="modal-footer green lighten-4">
                            <button  class="waves-effect waves-green btn-flat" onclick="saveExpensePayment();">Save</button>
