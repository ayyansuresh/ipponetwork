...
<script type="text/javascript">
    $(document).ready(function () {
        $("#expenseReportsForm").materialvalidation({
            theme: "materialize"
        });
        $("#expenseReportsForm").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#expenseReportsForm").data().materialvalidation.methods.validate()) {
                loadExpenseGridDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Expense Reports</h4>
    </div>
    <form class="formValidate" id="expenseReportsForm" novalidate>
        <div class="card-panel">
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                ...
                                <select id="categoryName" class="floating-label">
                                    <option value="-3" selected disabled>Please Select</option>
                        ...
                        <script>
                            floatingSelect2Change('categoryName', 'getSubcategoryByCategoryId');
                        </script>
                    </div>
                    ...
                    <div class="input-field col s12 m2">
                        <button class="waves-effect waves-light btn teal darken-2" form="expenseReportsForm" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
