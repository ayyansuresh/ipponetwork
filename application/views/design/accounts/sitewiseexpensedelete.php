...
<script type="text/javascript">
    $(document).ready(function () {
        $("#deleteExpenseForm").materialvalidation({
            theme: "materialize"
        });
        $("#deleteExpenseForm").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#deleteExpenseForm").data().materialvalidation.methods.validate()) {
                loadDeleteSitewiseExpenseDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Search Sitewise Expense</h4>
    </div>
    <form class="formValidate" id="deleteExpenseForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Expense Search</h4>
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m2">
                        <button class="waves-effect waves-light btn teal darken-2" form="deleteExpenseForm" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
...
<div id="loadDeleteExpenseDetails"></div>
