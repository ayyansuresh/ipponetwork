...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">New Income</h4>
    </div>
        ...
        <div class="row">
            <div>
                <div class="col s12 m12 l12">
                    <div class="col s12 m12 l12">
                        <div class="card-panel">
                            <h4 class="header2">INCOME DETAILS</h4>
                            <div class="row">
                                <div class="row">
                        ...
                        <div class="modal-footer green lighten-4">
                            <button  class="waves-effect waves-green btn-flat" onclick="saveIncome();">Save</button>
...
<?php self::loadDesign('popup/incomeentrypopup'); ?>
