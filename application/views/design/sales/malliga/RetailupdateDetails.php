                        ...
                        <div class="card-panel divHeight">
                            <table id="myTable" style="margin-top:15px;">  
                                ...
                                foreach ($billItemDetails as $billItems) {
                                    ...
                                    ?>
                                    <tr>
                                        <td class="input-field"><input id="productId<?php echo $count; ?>" type="text" value="<?php echo $billItems[items_item_id]; ?>" name="lineproductId[]" onchange="loadUnitRateNew(<?php echo $count; ?>)"><label for="productId">Item Code</label></td>
                                        ...
                                        <td class="input-field"><input id="productName<?php echo $count; ?>" type="text" value="<?php echo $billItems[items_name]; ?>" name="lineproductName[]" readonly=""><label for="productName">Item Name</label></td>
                                        <td class="input-field"><input id="unitRate<?php echo $count; ?>" type="text" value="<?php echo $billItems[salesbillitem_unit_rate]; ?>" name="lineunitrate[]" readonly="" onchange="finalTotal(<?php echo $count; ?>)"> <label for="unitRate">Retail Unit Rate </label> </td>
                                        <td class="input-field"><input id="Qty<?php echo $count; ?>" onchange="finalTotal(<?php echo $count; ?>)" type="text" value="<?php echo $billItems[salesbillitem_quantity]; ?>" name="linequantity[]"><label  for="Qty">Quantity</label></td>
                               <!--         <td class="input-field"><input id="discount<?php echo $count; ?>" onchange="finalTotal(<?php echo $count; ?>)" type="hidden" value="<?php echo $billItems[salesbillitem_Discount]; ?>" name="linediscount[]"><label for="discount" class="active">Discount</label></td>  -->
                                        <td class="input-field">
                                            ...
                                            <input id="linetotal<?php echo $count; ?>" type="hidden" name="linetotal[]" readonly="" value="<?php echo $billItems[salesbillitem_total] ?>"> <!--<label  for="lineTotal">line Total</label>  -->
