...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
       ...
       ?>
           <img src="<?php echo URL;?>/assets/img/mallikastores.jpg" style="height:100px;width:100%"/>
      <?php }
      else
      {
       ?>
           <img src="<?php echo URL;?>/assets/img/kannamani.jpg" style="height:100px;width:100%"/>
    <?php      
      }
?>
            </div> </div>  <!--
    ...
    </div><br/><br/><hr style="border-top: 1px dashed #000 !important;"><br/>
    <div class="container" style="font-family:arial;">
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:25px;font-size: 11px !important;border-bottom:none;">
              <!--  <div style="width:15%;float:left;padding:0% 2%;">  -->
