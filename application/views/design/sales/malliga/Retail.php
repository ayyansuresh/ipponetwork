        ...
        <table id="myTable" style="margin-top:15px;">
                            <tr>
                               ...
                               <input id="itemId0" type="hidden" name="lineitemId[]" readonly=""> <!--<label for="itemId" class="active">Item Id</label>  -->
                                ...
                                <td class="input-field"><input id="unitRate0" type="text" name="lineunitrate[]" onchange="finalTotal(0);" readonly=""> <label for="unitRate" class="active">Retail Unit Rate </label> </td>
                    ...
                    <div class="card-panel">
                        ...
                        <div class="row">  
                            ...
                            <div class="input-field col s12 m12" value="0.00">
                               <center>  <button id="makeInvoice" class="btn teal darken-2" type="submit" onclick="makeRetailSalesInvoice();">MAKE INVOICE</button> </center>  
