            ...
            <div class="table-responsive">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:13px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    ...
                    <tbody>
                        ...
                        for ($increment = $count; $increment <= 18; $increment++) {
                            ?>
                            <tr>
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:15px !important;">
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:26.5%;float:left;border-top:1px solid #000;text-align: right; "><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_cgst_total])) ?></strong></div>
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:26.5%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_sgst_total])) ?></strong></div>
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:26.5%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_round_off])) ?></strong></div>
                    </div>
                    <div style="width:100%;">
                        ...
                        <div style="width:26.5%;float:left;border-top:1px solid #000;text-align: right;">
