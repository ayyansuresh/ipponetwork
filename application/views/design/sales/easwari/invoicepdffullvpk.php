    ...
    <div class="container" style="font-family:arial;">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:18px !important;border:1px solid #3E3A77;border-collapse: collapse;border-top:none;font-family:arial;">
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td style="border-right:1px solid #3E3A77;padding-left:1%;padding-top:2%;font-size:14px !important;font-size:14px !important;"><strong><?php echo $saleItem[items_name]; ?></strong><!--<br/>--><?php //echo $saleItem[salesbillitem_description]; ?></td>
                ...
                <div style="width:50%;float:left;border:1px solid #3E3A77;border-top:none;font-size:14px !important;">
                    <div style="width:100%;">
                    ...
                    <?php }?>
                    <div style="width:100%;">
                        <div style="width:64.25%;border-top:1px solid #3E3A77;border-right:1px solid #3E3A77;border-bottom:1px solid #3E3A77;float:left;text-align: right;padding-right: 4%;color:#3E3A77;"><strong>CGST(9%)</strong></div>
                        <div style="width:30.25%;float:left;text-align: right;border-top:1px solid #3E3A77;border-bottom:1px solid #3E3A77;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_cgst_total] )) ?></strong>
                        </div>
                    </div>
                    <div style="width:100%;">
                        <div style="width:64.25%;border-right:1px solid #3E3A77;float:left;text-align: right;padding-right: 4%;color:#3E3A77;"><strong>SGST(9%)</strong></div>
                        <div style="width:30.25%;float:left;text-align: right;">
                    ...
                    <div style="width:100%;height:27px">
                        <div style="width:64.25%;height:28px;float:left;border-right:1px solid #3E3A77;text-align: right;padding-right: 4%;color:#3E3A77;">
                    ...
                    <div style="width:100%;height:48px">
                        <div style="width:64.25%;height:48px;float:left;border-right:1px solid #3E3A77;text-align: right;padding-right: 4%;color:#3E3A77;">
                            <strong>GRAND TOTAL (Rs.)</strong>
                        </div>
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sales_bill_total])); ?></strong>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    ...
                    <?php }?>
                    <div style="width:100%;">
                        <div style="width:64.25%;border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;float:left;text-align: right;padding-right: 4%;"><strong>CGST(9%)</strong></div>
                        <div style="width:30.25%;float:left;text-align: right;border-top:1px solid #000;border-bottom:1px solid #000;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_cgst_total] )) ?></strong>
                        </div>
                    </div>
                    <div style="width:100%;">
                        <div style="width:64.25%;border-right:1px solid #000;float:left;text-align: right;padding-right: 4%;"><strong>SGST(9%)</strong></div>
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sgst_total] )) ?></strong>
                        </div>
                    </div>
                    ...
                    <div style="width:100%;height:27px">
                        <div style="width:64.25%;height:28px;float:left;border-right:1px solid #000;text-align: right;padding-right: 4%;">
                            <strong>GRAND TOTAL (Rs.)</strong>
                        </div>
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sales_bill_total])); ?></strong>
                    ...
                    <div style="width:100%;height:48px">
                        <div style="width:64.25%;height:48px;float:left;border-right:1px solid #000;text-align: right;padding-right: 4%;">
                            <strong>GRAND TOTAL (Rs.)</strong>
                        </div>
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sales_bill_total])); ?></strong>
