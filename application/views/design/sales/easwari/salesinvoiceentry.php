            ...
            <div class="card-panel">
                <div class="row">
                 ...
                 <div class="input-field col s12 m4">
                    ...
                    <div class="input-field col s12 m4">
                        ...
                        <label for="transportName">Address</label>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m2"   style="display:none;">
                        <i class="mdi-action-event prefix"></i>
                        <input id="ewaybillno" type="text" class="validate focus">
                    ...
                    <div class="input-field col s12 m2" style="display:none;">
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="lrno" type="text" class="validate">
                    ...
                    <div class="input-field col s12 m3" style="display:none;">
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="marksonpackage" type="text" class="validate">
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="input-field col s12" style="display:none">
                                    <input id="less" type="text" value="0" onchange="calculateTotalValue()">
                                    <label for="less" class="active">Less</label>
                                </div>
                                <div class="input-field col s12" style="display:none">
                                    <input id="packingexpense" type="text" value="0" readonly="" onchange="calculateTotalValue()">
...
<?php // self::loadDesign('popup/easwari/salesAddProductPopupWithoutProduct'); ?>
