...
<?php 
    $billtypeName = "";
    if($gstType == "1") {
       $billtypeName = "GST (within state) Bill - ";
    } else  if($gstType == "2") {
       $billtypeName = "GST (other state) Bill - ";
    } else {
       $billtypeName = "Retail Bill - ";
    }

?>


<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/easwari/updateSales.js"></script>
<script>
 $(document).ready(function () {
        $("#billprint").focus();}</script>
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;"> <?php echo $billtypeName; ?> Print Invoice</h4>
    </div>
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4">
                    ...
                    <p><a class="waves-effect waves-light btn teal darken-2" href="#!" id="billprint" onclick="printAction('<?php echo $gstType; ?>','<?php echo $companyId; ?>','<?php echo $accountyear; ?>')"><i class="mdi-action-print left"></i> Print</a></p>
                </div>
            </div>
        </div>
    </div>
