...
<form id="salesInvoice" novalidate>
    <div class="container teal lighten-2">
        ...
        <table id="myTable" style="margin-top:15px;">
                            <tr>
                                <td class="input-field"><input id="productId0" type="text" tabindex="1" name="lineproductId[]" onchange="loadUnitRateNew(0)"><label for="productId">Item Code</label></td>
                                ...
                                <td class="input-field"><input id="unitRate0" type="text" name="lineunitrate[]" onchange="finalTotal(0);"> <label for="unitRate" class="active">Retail Unit Rate </label> </td>
                                <td class="input-field"><input id="Qty0" tabindex="2" onchange="finalTotal(0);addField();" type="text" name="linequantity[]"><label  for="Qty">Quantity</label></td>
                               <td class="input-field">  <input id="discount0" onchange="finalTotal(0)" type="text" value="0" name="linediscount[]"><label for="discount" class="active">Discount</label></td>
                ...
                <div class="col s12 m12 l3">
                    <div class="card-panel">
                        ...
                        <div class="row">  
                            ...
                            <h4>&nbsp;</h4>
                            <div class="input-field col s12 m12" >
                                <input id="grandTotal" type="number" style="font-size:2.75rem;" value="0"readonly="">
