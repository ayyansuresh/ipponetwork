...
$billDetailsRecord = salesInvoiceBlock::getBillDetailsByNumber($billNumber);
if (count($billDetailsRecord) > 0) {
    ...
    <form id="updateSalesInvoice" novalidate>
        ...
        <div class="container teal lighten-2">
            <?php if($billDetails[salesbill_credit_note]==="1") { ?>
            ...
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        <div class="col s12">
                            <span class="flow-text red-text text-darken-2" style="font-weight: bold;">
                                You cannot delete because this bill is against a credit note entry.
                            </span>
                        </div>
                    </div>
                </div>
 ...
 <div class="input-field col s12 m4">
                            ...
                            <label for="transportName" class="active">Address</label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="input-field col s12 m3"  style="display: none;">
                            <i class="mdi-action-event prefix"></i>
                            <input id="ewaybillno" type="text" class="validate" value="<?php echo $billDetails[salesbill_ewayBillNo] ?>">
                            <label for="ewaybillno" class="active">Eway Bill No</label>
                        </div>
                        ...
                        <div class="input-field col s12 m2" style="display:none">
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="lrno" type="text" class="validate" value="<?php echo $billDetails[salesbill_lrNumber] ?>">
                        <label for="lrno" class="active">L.R no</label>
                    </div>
                    </div>
                    <div class="row">
                    <div class="input-field col s12 m3" style="display:none">
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="lrdate" type="date" class="datepicker" 
                               data-validation="date" data-content="Date cannot be empty"
                               value="<?php echo $billDetails[salesbill_lrDate] ?>">
                        <label for="lrdate" class="active">L.R date</label>
                    </div>
                    <div class="input-field col s12 m3" style="display:none">
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="marksonpackage" type="text" class="validate" value="<?php echo $billDetails[salesbill_marksonpackage] ?>">
                        <label for="marksonpackage" class="active">Marks on package</label>
                    </div>    
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            <div class="input-field col s1">
                                                ...
                                                <input readonly name="lineproductdescription[]" type="hidden" value="<?php echo $billItems[salesbillitem_description]; ?>">
                                            </div>
                                            
                                            <div class="input-field col s2">
                                                <input readonly name="lineproductdescription[]" type="text" value="<?php echo $billItems[salesbillitem_description]; ?>">
                                            </div>
                                            ...
                                            <div class="input-field col s1" style="padding-top:15px; text-align: center;">
                        ...
                        <div class="card-panel">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <input id="less" type="text" value="<?php echo $billDetails[salesbill_less] ?>" onchange="calculateTotalValue()">
                                    <label for="less" class="active">Less</label>
                                    </div>
                                     <div class="input-field col s12" style="display: none;">
                                    <input id="packingexpense" type="text" value="<?php echo $billDetails[salesbill_packing_charge]?>" onchange="calculateTotalValue()">
                                    <label for="packingexpense" class="active">Total Amount Before Tax</label>
                                    </div>
...
?>
<?php self::loadDesign('popup/easwari/salesAddProductPopup'); ?>
