...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
        ...
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:13px !important;width:49.8%;float:left;border:1px solid #000;height:140px;">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="border-right:1px solid #000;padding-left:1%;text-align:left;"><strong><?php echo $saleItem[items_name]; ?></strong><br/>(<?php echo $saleItem[salesbillitem_description]; ?>)</td>
                ...
                <div style="font-family:arial;font-size:10.8px !important;width:49.5%;height:99px;float:left;border:1px solid #000;border-top:none;border-right:none;">
                    <div style="padding-left:1%;">
                        ...
                        <!--<div style="border-top:1px solid #000;"><span style="text-decoration: underline;"><strong>Terms & Conditions</strong></span> :<br/><label>1.Extra GST 18%.</label><br/><label>2.Valid 30 days.</label><br/><label>3.Transport Extra</label>  </div>-->
                    </div>
                </div>
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    ...
                    <!--<div style="width:100%;">
                        <div style="width:64.25%;float:left;border-top:1px solid #000;text-align: right;padding-right: 4%;">
                            <strong>&nbsp;</strong>
                        </div>
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;">
                            <strong>&nbsp;</strong>
