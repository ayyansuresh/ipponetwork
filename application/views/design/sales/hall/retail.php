...
<form id="salesInvoice">
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">ROOM BOOKING ENTRY</h4>
        </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="billType" class="floating-label active" data-validation="select" data-content="Please Select Bill Type">
                                        ...
                                        <option value="3" selected >NEW CUSTOMER</option>
                                    </select>
                                    <div class='bar'></div>
                                </div>  
                            </div>
                        ...
                        <div id="villageCustomer" style="display:none">
                            ...
                            <div class="row" >
                                ...
                                <div class="input-field col s12 m2">
                                    ...
                                    <label for="transportName">License</label>
                                </div>
                                <div class="input-field col s12 m2">
                                    <label for="villagecustomerCity">Other Proof</label>
                            ...
                            <div  id="billForm">
                                ...
                                <div class="col s12">
                                    <div class="input-field col s12 m122">
                                        <label>ROOM BOOKING DETAILS</label>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div id="loadGoldAccount">
                                    <div class="input-field col s12"  >
                                        <strong><input id="advancePayment" type="text" value="0.00"  style="font-size: 20px" class="active" required ></strong>
