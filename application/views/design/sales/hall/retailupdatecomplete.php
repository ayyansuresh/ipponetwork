<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/hall/updateRetailSalesHall.js"></script>
<?php
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Booking Complete Entry</h4>
    </div>
