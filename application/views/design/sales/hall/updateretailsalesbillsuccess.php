...
<div class="modal-footer green lighten-4">
    ...
    <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeSalesUpdateRetailModal(<?php echo generalhelper::getGetElement('billGSTType') ?>);">Close</button>
</div>
<script>
