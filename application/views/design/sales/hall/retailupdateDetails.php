<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/hall/newSales.js"></script>
    ...
    <form id="salesInvoice">
        ...
        <div class="container teal lighten-2">
            <div class="collection">
                <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Retail Update </h4>
            </div>
...
?> 
<?php self::loadDesign('popup/hall/salesAddProductPopup'); ?>
