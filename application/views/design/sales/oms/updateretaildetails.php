<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/oms/newSalesTaxInclude.js"></script>
...
if ($gstBillType == 1 || $gstBillType == 3) {
                    ...
                    <div class="col s12 m12 l2">
                        <div class="card-panel">
                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="subtotal" readonly value="<?php echo $billDetails[salesbill_running_total] ?>" >
                                        <label for="subtotal" class="active">Total</label>
                                    </div>
                                    <div class="input-field col s12" <?php echo $cgstdisplay; ?>>
                                        <input id="cgstvalue" readonly value="<?php echo $billDetails[salesbill_cgst_total] ?>" >
                                        <label for="cgstvalue" class="active">CGST</label>
                                    </div>

                                    <div class="input-field col s12" <?php echo $sgstdisplay; ?>>
                                        <input id="sgstvalue" readonly value="<?php echo $billDetails[salesbill_sgst_total] ?>" >
                                        <label for="sgstvalue" class="active">SGST</label>
                                    </div>
                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="igstvalue" readonly value="<?php echo $billDetails[salesbill_igst_total] ?>" >
                                        <label for="igstvalue" class="active">IGST</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="roundOff" readonly value="<?php echo $billDetails[salesbill_round_off] ?>">
                                        <label for="roundOff" class="active">Round Off</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="grandTotal" readonly  value="<?php echo $billDetails[salesbill_sales_bill_total] ?>">
