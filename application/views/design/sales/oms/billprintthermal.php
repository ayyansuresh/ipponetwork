...
?>
<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/oms/updateSales.js"></script>
    ...
    <div class="card-panel">
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4">
                    <p><a class="waves-effect waves-light btn teal darken-2" href="#!" onclick="printActionThermal('<?php echo $gstType; ?>','<?php echo $companyId; ?>','<?php echo $accountyear; ?>')"><i class="mdi-action-print left"></i> Print</a></p>
                </div>
            </div>
        </div>
    </div>
