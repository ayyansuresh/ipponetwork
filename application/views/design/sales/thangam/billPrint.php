        ...
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4">
                    <p><a class="waves-effect waves-light btn teal darken-2" href="#!" onclick="printNewReport('printpage','<?php echo $companyId; ?>','<?php echo $accountyear; ?>')"><i class="mdi-action-print left"></i> Print</a></p>
                </div>
            </div>
        </div>
    </div>
