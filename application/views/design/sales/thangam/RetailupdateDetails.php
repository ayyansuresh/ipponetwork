...
<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/vasantham/newSalesTaxInclude.js"></script> 
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="billType" class="floating-label active" data-validation="select" data-content="Please Select Bill Type">
                                    ...
                                    <option value="2" <?php if ($billDetails[salesbill_sales_bill_type] == 2) echo 'selected'; ?>>Membership Customer</option>
                 ...
                 <!--       <input id="billNumber" type="hidden" class="validate" value="<?php echo $billNumber ?>" readonly>
                  ...
                  <!--      <i class="mdi-av-my-library-books prefix"></i>  -->
                    ...
                    <div class="input-field col s12 m6" id="normalCustomer" >
                        <div class="input-group">
                            <label for="customerName" class="active">Customer Names</label>
                            <div class="sel-wrap">
                    ...
                    <div class="card-panel divHeight">
                        <table id="myTable" style="margin-top:15px;">  
                            ...
                            foreach ($billItemDetails as $billItems) {
                                ...
                                ?>
                                <tr>
                                    <td class="input-field"><input id="barcodeId<?php echo $count; ?>" type="text" tabindex="1"  name="linebarcodeId[]" value="<?php echo $billItems[items_item_id]; ?>" onchange="loadUnitRateNew(<?php echo $count; ?>);
                                                    finalTotal(<?php echo $count; ?>);
                                                    changeText(<?php echo $count; ?>);" >
                                        <label for="barcodeId" class="active">Item Code</label></td>
                    ...
                    <div class="card-panel">
                        ...
                        <div class="row">  
                            ...
                            <div class="input-field col s12 m12">
                                ...
                                <center> <button class="btn teal darken-2" type="submit" onclick="updateRetailSalesInvoicePrint('printpage', '<?php echo $companyId; ?>', '<?php echo $accountyear; ?>');">Print</button> </center>  
                            </div>
                            <div class="input-field col s12 m12" value="0.00">
                                <center>  <button id="makeInvoice" class="btn teal darken-2" type="submit" onclick="updateRetailSalesInvoice(<?php echo generalhelper::getGetElement('billGSTType') ?>);">CLOSE</button> </center>  
