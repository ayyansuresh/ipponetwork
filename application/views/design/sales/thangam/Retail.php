            ...
            <div class="row">
                    ...
                    <div class="input-group">
                        ...
                        <div class="sel-wrap">
                            <select id="billType" class="floating-label active" data-validation="select" data-content="Please Select Bill Type">
                                ...
                                <option value="2" selected>Membership Customer</option>
              ...
              <!--      <i class="mdi-av-my-library-books prefix"></i>  -->
                    ...
                    <div class="input-group">
                        ...
                        <div class="sel-wrap">
                            <select id="customerName" class="floating-label active" >
                                ...
                                <?php echo customerBlock::getCustomerNameWithMobile(2, 1, ""); ?>
                            </select>
                            <div class='bar'></div>
                        </div>  
                    </div>
                ...
                <div id="villageCustomer" style="display: none;">
                    <div class="input-field col s12 m2" >
                        <label for="villagecustomerName">Customer </label>
                        <input id="villagecustomerName" type="text"  value="" autocomplete="Off" >
                    </div>
                    <div class="input-field col s12 m2">
            ...
            <div class="col s12 m12 l9">
                <div class="card-panel divHeight">
                    <table id="myTable" style="margin-top:15px;">
                        <tr>
                            <td class="input-field"><input id="barcodeId0" type="text" tabindex="1" name="linebarcodeId[]"   onchange="loadUnitRateNew(0);
                                    finalTotal(0);
                ...
                <!--        <td class="input-field"><input id="Qty0" tabindex="2" onchange="finalTotal(0);" type="text" value="1"  name="linequantity[]"><label  for="Qty0" class="active">Quantity</label></td> -->
                        <td class="input-field"><input id="Qty0"  tabindex="2" onchange="finalTotal(0);addField();" type="text" value="1"  name="linequantity[]"><label  for="Qty0" class="active">Quantity</label></td>
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m12">
                                ...
                                <center> <button class="btn teal darken-2" type="submit" onclick="makeRetailSalesInvoicePrint('printpage', '<?php echo $companyId; ?>', '<?php echo $accountyear; ?>');">Print</button> </center>  
                            </div>
                            <div class="input-field col s12 m12" value="0.00">
                                <center>  <button id="makeInvoice" class="btn teal darken-2" type="submit" onclick="makeRetailSalesInvoice(<?php echo generalhelper::getGetElement('billGSTType') ?>);">CLOSE</button> </center>  
