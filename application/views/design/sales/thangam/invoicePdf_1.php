                ...
                <div class="row">
                    ...
                    <div style="font-size:15px !important;width:44.5%;float:left;border:1px solid #000;border-left:none;height:153px;">
                        <div class="panel panel-default">
                            ...
                            <div style="padding:1.4%;font-size:15px !important;">
            ...
            <div class="table-responsive">
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:15px !important;">
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle($sales[salesbill_round_off]) ?></strong></div>
                    </div>
                    <div style="width:100%;">
        ...
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:30%;float:right;padding:4% 0%;">
                    <div style="font-size:14px !important;"><label>GSTIN: <strong><?php echo $companyDetails[companyaddress_gst] ?></strong></label></div><br>
                    <div style="font-size:14px !important;"><label>Place Of Supply: <strong>Virudhunagar </strong></label></div><br>
                    <div style="font-size:14px !important;"><label><strong>COPY</strong></label></div>
                </div>
            </div>
        </div>
        <div class="row" style="font-size: 11px !important;">
