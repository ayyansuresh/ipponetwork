<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/bantage/newSales.js"></script>
                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="input-field col s12">
                                     ...
                                     <div class="input-field col s12">
                                        <input id="discount" type="number" readonly value="<?php echo $billDetails[salesbill_total_discount] ?>" >
                                        <label for="discount" class="active">Discount</label>
                                    </div>
                                     <div class="input-field col s12">
                                        <input id="totalFreight" type="number" readonly value="<?php echo $billDetails[salesbill_fright] ?>" >
                                        <label for="totalFreight" class="active">Freight</label>
                                    </div>
...
?>
<?php self::loadDesign('popup/bantage/salesAddProductPopup'); ?>
