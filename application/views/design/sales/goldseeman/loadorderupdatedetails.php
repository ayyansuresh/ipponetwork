...
$billDetailsRecord = salesInvoiceBlock::getUpdateOrderNumber();
...
//$billType = "2"; //Credit Bill
    ...
    $billItemDetailsPurchase = salesInvoiceBlock::getBillItemOrderPurchase($billId);
            ...
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                            ...
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="billType" class="floating-label active" data-validation="select" data-content="Please Select Bill Type">
                                        ...
                                        <option value="3" <?php if ($billDetails[salesbillgoldestimate_sales_bill_type] == 3) echo 'selected'; ?>>Retail Bill</option>
                        ...
                        <div class="input-field col s12 m2">
                            <input id="daywiseGoldRate" type="hidden" class="validate" value="<?php echo $billDetails[salesbillgoldestimate_dayWiseGoldRate]; ?>" readonly>
                        <input id="daywiseSilverRate" type="hidden" class="validate" value="<?php echo $billDetails[salesbillgoldestimate_dayWiseSilverRate]; ?>" readonly>
                            ...
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="customerName" class="floating-label active" >
                                        ...
                                        <?php echo customerBlock::getCustomerNameByType($partyType, $gstBillType, $billDetails[salesbillgoldestimate_customer_id]); ?>
                                    </select>
                                    <div class='bar'></div>
                                </div>  
                            </div>
                    ...
                    <div class="row" style="display:none;">
                        ...
                        <div class="input-field col s12 m2">
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="bankaccount" class="floating-label active" >
                                        ...
                                        <?php echo accountBlock::getAccountNameByCompany($billDetails[salesbillgoldestimate_account_ref_id]) ?>
                                    </select>
                                    <div class='bar'></div>
                                </div>  
                            </div>
                            <script>
                                ...
                                $("#bankaccount").val(<?php echo $billDetails[salesbillgoldestimate_account_ref_id] ?>).trigger("change");
                            </script>
                        </div>
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1" <?php echo $cgstdisplay ?>>
                                                <input readonly  name="linecgstRate[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_cgst_rate] ?>">
                                            </div><div class="input-field col s1" <?php echo $sgstdisplay ?>>
                                                <input readonly  name="linesgstRate[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_sgst_rate] ?>">
                                            </div>
                                            <div class="input-field col s1" <?php echo $igstdisplay ?>>
                                                <input readonly  name="lineigstRate[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_igst_rate] ?>">
                                            </div>



                                            <div class="input-field col s1">
                                                <input  id="lineunitrate<?php echo $count ?>" name="lineunitrate[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_unit_rate] ?>">

                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="linequantity[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_quantity] ?>">
                                                <input readonly  name="lineUOM[]" type="hidden" value="<?php echo $billItems[salesbillitemgoldestimate_UOM_ref_id] ?>">
                                                <input readonly  name="linecommodityRefId[]" type="hidden" value="<?php echo $billItems[salesbillitemgoldestimate_commodity_ref_id] ?>">
                                                <input readonly  name="linepackingfactor[]" type="hidden" value="1">
                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="vad[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_vad] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="makingCharge[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_makingCharge] ?>">
                                            </div>
                                            <div class="input-field col s2">
                                                <input readonly  name="linetotal[]" type="text" value="<?php echo $billItems[salesbillitemgoldestimate_total] ?>">
                                ...
                                <div  id="billForm1">
                                    ...
                                    foreach ($billItemDetailsPurchase as $billItemsPurchase) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1" <?php echo $cgstdisplay ?>>
                                                <input readonly  name="linecgstRatepurchase[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_cgst_rate] ?>">
                                            </div><div class="input-field col s1" <?php echo $sgstdisplay ?>>
                                                <input readonly  name="linesgstRatepurchase[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_sgst_rate] ?>">
                                            </div>
                                            <div class="input-field col s1" <?php echo $igstdisplay ?>>
                                                <input readonly  name="lineigstRatepurchase[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_igst_rate] ?>">
                                            </div>



                                            <div class="input-field col s1">
                                                <input  id="lineunitratepurchase<?php echo $count ?>" name="lineunitratepurchase[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_unit_rate] ?>">

                                            </div>
                                            <div class="input-field col s1" style="display:none;">
                                                <input  id="linegrossWeight<?php echo $count ?>" name="linegrossWeight[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_gross_weight] ?>">

                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="linenetWeight[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_net_weight] ?>">
                                                <input readonly  name="lineUOMpurchase[]" type="hidden" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_UOM_ref_id] ?>">
                                                <input readonly  name="linecommodityRefIdpurchase[]" type="hidden" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_commodity_ref_id] ?>">
                                                <input readonly  name="linepackingFactorPurchase[]" type="hidden" value="1">
                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="lineVadPurchase[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_vad] ?>">

                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="lineamountpurchase[]" type="text" value="<?php echo $billItemsPurchase[salesbillitemgoldpurchaseestimate_total] ?>">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="igstvalue" type="text" value="<?php echo $billDetails[salesbillgoldestimate_igst_total]; ?>" readonly>
                                        <label for="igstvalue" class="active">IGST</label>
                                    </div>

                                    <div class="input-field col s12" <?php echo $igstdisplay; ?>>
                                        <input id="cgstvaluePurchase" type="hidden" value="<?php echo $billDetails[salesbillgoldestimate_purchase_cgst]; ?>" readonly>
                                        <label for="cgstvaluePurchase" class="active">CGST</label>
                                    </div>

                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="sgstvaluePurchase" type="hidden" value="<?php echo $billDetails[salesbillgoldestimate_purchase_sgst]; ?>" readonly>
                                        <label for="sgstvaluePurchase" class="active">SGST</label>
                                    </div>
                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="igstvaluePurchase" type="hidden" value="<?php echo $billDetails[salesbillgoldestimate_purchase_igst]; ?>" readonly>
                                    ...
                                    <div class="input-field col s12"  >
                                        <input id="advancePayment" type="text" required value="<?php echo $billDetails[salesbillgoldestimate_advance_payment]; ?>" class="active">
