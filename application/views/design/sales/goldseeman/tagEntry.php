<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/goldseeman/newSalesTag.js"></script>
...
<form id="salesInvoice">
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Tag Entry</h4>
        </div>
            ...
            <div class="card-panel">
                <div class="row">
                    ...
                    <div class="input-field col s12 m2">
                        ...
                        <label for="billDate" class="active">Entry Date</label>
                    </div>
                    <div class="input-field col s12 m2" style="display:none">
                        <i class="mdi-action-event prefix"></i>
                ...
                <div class="row">
                    <div class="col s12 m12">
                        ...
                        <div class="input-field col s12" value="0.00">
                            <center>  <button id="makeInvoice" class="btn teal darken-2" type="submit" form="salesInvoice">CREATE TAG</button> </center>
                        </div>
                    </div>
                    <!-- Form with validation -->
                    <div class="col s12 m12 l2" style="display:none">
                        <div class="card-panel">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12" style="display:none;" >
                                        <input id="advancePayment" type="text"  class="active">
...
<?php self::loadDesign('popup/goldseeman/tagaddproductpopup'); ?>
