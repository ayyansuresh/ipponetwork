                    ...
                    <div >
                        <div style="padding:1.4%;">
                            <table style="width:100%;font-family:sans-serif !important;font-size:12px !important;">
                                    ...
                                    <!--<td>GSTIN</td>
                                    <td><strong><?php //echo $sales[customer_gst_number] ?></strong> !-->
                                    <!--</tr>-->
                                    <tr>
                                    <td>Estimate No:</td>
                                    <td><strong><?php echo $sales[salesbillgoldestimate_sales_bill_display_number] ?></strong></td>
                                    <td>Date:</td>
            ...
            <table  style="width:100%;height:128px;font-size:12px !important;border-top:1px dashed #000;border-bottom:1px dashed #000;border-collapse: collapse;">
                <thead>
                    <tr>
                        ...
                        <td style="border-bottom:1px dashed #000;text-align: center;"><strong>Weight</strong></td>
                ...
                <tr>
                       <td colspan="2" style="border-top:1px dashed #000;text-align:left;"><strong>Total Weight:<?php echo $finalquantity ?></strong></td>
                         
                    
                        <td colspan="2" style="border-top:1px dashed #000;text-align:right;"><strong>CGST (Rs):</strong></td>
                        <td style="border-top:1px dashed #000;text-align:center;padding-right: 1%;"><strong><?php echo $sales[salesbill_cgst_total]; ?></strong></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:left;"><strong>Total Item(s):<?php echo $count-1; ?></strong></td>
                  
                        <td colspan="2" style="text-align:right;"><strong>SGST (Rs):</strong></td>
                        <td style="text-align:center;padding-right: 1%;"><strong><?php echo $sales[salesbill_sgst_total]; ?></strong></td>
                    </tr>
