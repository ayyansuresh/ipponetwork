                ...
                <div class="col s12 m12 l10">
                    <div class="card-panel divHeight">
                        <table id="myTable" style="margin-top:15px;">
                            ...
                            <td class="input-field"><input id="netWeight0" onchange="finalTotal(0);" type="text" name="lineNetWeight[]" readonly=""><label  for="netWeight0" class="active">Net.Wt</label></td>
                            ...
                            <td class="input-field"><input id="mcPercentage0" onchange="finalTotal(0);" type="text" name="linemcPercentage[]" >  
                                <input id="mc0" onchange="finalTotal(0);" type="hidden" readonly="" name="linemc[]"><label  for="mc0" class="active">HC</label></td>
...
<?php self::loadDesign('popup/goldseeman/purchaseaddproductpopup'); ?>
