<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/goldseeman/updateRetailSales.js"></script>
<?php
...
<div class="container teal lighten-2">
    ...
    <div class="card-panel">
        <h4 class="header2">Search Invoice Retail</h4>
        <div class="row">
            <div class="row">
