                    ...
                    <div class="row">
                        ...
                        <div id="villageCustomer">
                            ...
                            <div class="row" >
                                ...
                                <div class="input-field col s12 m2">
                                    <label class="active" for="villagecustomerCity">Town Name</label>
                                ...
                                <div class="input-field col s12 m2">
                                    ...
                                    <label class="active" for="transportName">Pan Number</label>
                                </div>
                                <div class="input-field col s12 m2">
                                    <i class="mdi-av-my-library-books prefix"></i>
                        ...
                        <div class="card-panel divHeight">
                            <table id="myTable" style="margin-top:15px;">
                                ...
                                foreach ($billItemDetails as $billItems) {
                                    ...
                                    ?>
                                <input id="updateTagItemsId<?php echo $count; ?>" type="hidden" value="<?php echo $billItems[salesbilltagitemes_id]; ?>" readonly="" name="updateTagItemsId[]">
                                    <tr>
                                    ...
                                    <input id="productId<?php echo $count; ?>" type="hidden"   name="lineproductId[]" readonly="" value="<?php echo $billItems[items_item_id]; ?>"> 
                                    <td class="input-field"><input id="productName<?php echo $count; ?>" type="text" value="<?php echo $billItems[items_name]; ?>" name="lineproductName[]" readonly="">
                                        <!--<label for="productName" class="active">Item Name</label>-->
                                    </td>
                                    <td class="input-field"><input id="Qty<?php echo $count; ?>"  tabindex="2" onchange="finalTotal(<?php echo $count; ?>);" readonly="" type="text" name="linequantity[]" value="<?php echo $billItems[salesbillitem_quantity]; ?>">
                                        <!--<label  for="Qty" class="active">Gross.Wt</label>-->
                                    </td>
                                    <td class="input-field"><input id="lessWeight0" onchange="finalTotal(0);" value="<?php echo $billItems[salesbillitemgold_lessWeight]; ?>" type="text" name="lineLessWeight[]" >
                                        <!--<label  for="lessWeight0" class="active">Less.Wt</label>-->
                                    </td>
                                    <td class="input-field"><input id="netWeight0" onchange="finalTotal(0);" value="<?php echo $billItems[salesbillitem_netWeight]; ?>" type="text" name="lineNetWeight[]" readonly="">
                                        <!--<label  for="lessWeight0" class="active">Net.Wt</label>-->
                                    </td>
                                    <td class="input-field">
                                        <input id="unitRate<?php echo $count; ?>" type="number" value="<?php echo $billItems[salesbillitem_unit_rate]; ?>" name="lineunitrate[]" onchange="finalTotal(<?php echo $count; ?>);" readonly="">
                                        <input id="unitRateWithTax<?php echo $count; ?>" type="hidden" value="<?php echo $billItems[salesbillitem_unitrate_wittax]; ?>" name="lineunitratewithtax[]" onchange="finalTotal(<?php echo $count; ?>);" readonly="">

                                        <!-- <label for="unitRate" class="active">Rate </label> -->
                                    </td>
                                    <td class="input-field"><input id="vad<?php echo $count; ?>"  onchange="finalTotal(<?php echo $count; ?>);" type="text" value="<?php echo $billItems[salesbillitem_vad]; ?>" readonly="" name="linevad[]">
                                        <!--<label  for="vad0" class="active">VAD(%)</label>-->
                                    </td>
                                    <td class="input-field"><input id="mc<?php echo $count; ?>" onchange="finalTotal(<?php echo $count; ?>);" type="text" value="<?php echo $billItems[salesbillitem_makingCharge]; ?>"readonly="" name="linemc[]">
                                        <!--<label  for="mc0" class="active">MC</label>-->
                                    </td>
                                    <td class="input-field"><input id="linetotal<?php echo $count; ?>" type="text" name="linetotal[]" value="<?php echo $billItems[salesbillitemgold_total]; ?>" readonly="">
                                        <!--<label  for="linetotal0" class="active">Amount</label>-->
                                    </td>
                                    <td class="input-field">

                                        <input id="tagItemsId<?php echo $count; ?>" type="hidden" value="<?php echo $billItems[salesbilltagitemes_id]; ?>" readonly="" name="tagItemsId[]">
                                        <input id="hsnCode<?php echo $count; ?>" type="hidden" name="hsnCode[]" value="<?php echo $billItems[salesbillitem_hsn_code_ref_id]; ?>"readonly=""> <!--<label  for="hsnCode">hsncode</label> -->
                                        ...
                                        <input id="vadPercentage<?php echo $count; ?>" type="hidden" name="linevadPercentage[]" value="<?php echo $billItems[salesbillitem_vad]; ?>" readonly="">  
                                        <input id="mcPercentage<?php echo $count; ?>" type="hidden" name="linemcPercentage[]" value="<?php echo $billItems[salesbillitem_makingCharge]; ?>" readonly="">  
                                        ...
                                        <input id="linetotalwithtax<?php echo $count; ?>" type="hidden" name="linetotalwithtax[]" value="<?php echo $billItems[salesbillitem_total_withtax]; ?>" readonly="">
                                ...
                                <div  id="billForm1">
                                    ...
                                    foreach ($billItemDetailsPurchase as $billItemsPurchase) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1">
                                                <?php
                                                $netWeight = $billItemsPurchase[salesbillitemgoldpurchase_net_weight] - $billItemsPurchase[salesbillitemgold_vad];
                                                ?>
                                                <input  id="linegrossWeight<?php echo $count ?>" name="linegrossWeight[]" type="text" value="<?php echo $netWeight ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div id="loadGoldAccount">
                                        ...
                                        if ($accountDetail[account_transaction_type] == 2) {
                                            ...
                                            <div class="input-field col s12"  >
                                                <strong><input id="advancePaymentBank" type="text"  autocomplete="off"  style="font-size: 20px" class="active" required value="<?php echo $billDetails[salesbillgold_bankReceiveAmount]; ?>" onchange="loadDueDate()"></strong>
                                                <label for="advancePayment" class="active">Advance Amount Bank</label>
                                            </div>
                                            <div class="input-field col s12"  >
                                                <strong><input id="advancePaymentCash" type="text"   autocomplete="off" style="font-size: 20px" class="active" value="<?php echo $billDetails[salesbillgold_cashReceiveAmount]; ?>" required onchange="loadDueDate()"></strong>
