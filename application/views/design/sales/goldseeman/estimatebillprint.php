...
<script type="text/javascript">
    $(document).ready(function() {
        $("#estimateDetails").materialvalidation({
            theme: "materialize"
        });
        $("#estimateDetails").submit(function(evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#estimateDetails").data().materialvalidation.methods.validate()) {
                loadEstimateGridDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Estimate Invoice Details</h4>
    </div>
    <form class="formValidate" id="estimateDetails" novalidate>
    <div class="card-panel">
        <h4 class="header2">Estimate Invoice</h4>
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4">
                   <button class="waves-effect waves-light btn teal darken-2" form="estimateDetails" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
                </div>
            </div>
        </div>
    </div>
