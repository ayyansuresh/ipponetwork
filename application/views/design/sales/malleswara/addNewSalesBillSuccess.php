        ...
        <div class="col s12 m12 l12">
            <div class="card-panel">
                <h4 class="header2">SUCCESS (BILL NUMBER -
                    ...
                    $link=URL."sales-salesmalleswara/generateInvoicePdf?company=".generalhelper::getSessionElement('beebooklogincompanyid')
        ."&accountYear=".generalhelper::getSessionElement('beebookloginaccountyearid')
        ."&frombillnumber=".$salesBillNumber.
        "&tobillnumber=".$salesBillNumber."&gstType=1&billType=1";
