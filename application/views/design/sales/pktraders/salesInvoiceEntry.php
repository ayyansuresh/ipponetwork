                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m4" id="normalCustomer" >
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="customerName" required class="floating-label active">
                    ...
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="input-field col s12" value="0.00">
                                    <center>  <button id="makeInvoice" class="btn teal darken-2" type="button" onclick="makeSalesInvoice();">MAKE INVOICE</button> </center>
                                </div>
                            </div>
                        </div>
                    </div>
