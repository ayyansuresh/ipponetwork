<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/vishnu/newSales.js"></script>
<script>
                ...
                <div class="card-panel">
                    <div class="row">
                        ...
                        <div class="input-field col s2">
                            <input id="billDate" type="text" value="<?php echo $billDetails[salesbill_sales_bill_date] ?>" readonly>
                    ...
                    <div class="row">
                        ...
                        <input id="bundle" type="hidden" readonly class="validate" value="<?php echo $billDetails[salesbill_bundle] ?>">

                        <div class="input-field col s12 m2">
                            <i class="mdi-av-my-library-books prefix"></i>
                            <input id="bundle" type="hidden" class="validate" readonly="">
                            <input id="totalSquareFeet" type="text" class="validate" readonly="" value="<?php echo $billDetails[salesbill_total_square_feet] ?>">
                            <label for="totalSquareFeet" class="active">Total Square Feet</label>
                        </div>
                        <div class="input-field col s12 m2">
                            <i class="mdi-av-my-library-books prefix"></i>
                            <input id="totalLineWeight" type="text" class="validate" readonly="" value="<?php echo $billDetails[salesbill_total_weight] ?>">
                            <label for="totalLineWeight" class="active">Total Weight</label>
                        </div>
                                ...
                                <div class="row" id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1">
                                                <input  id="lineWeight<?php echo $count ?>" name="lineWeight[]" type="text" value="<?php echo $billItems[salesbillitem_total_UOM_quantity] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                            ...
                                            <div class="input-field col s1">
                                                <input readonly  name="linenumberofbags[]" type="hidden" value="<?php echo $billItems[salesbillitem_bags] ?>">
                    ...
                    <div class="col s12 m12 l2">
                        <div class="card-panel">
                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="subtotal" type="number" value="<?php echo $billDetails[salesbill_running_total] ?>" readonly>
                                        <label for="subtotal" class="active">Total</label>
                                    </div>
                                    <div class="input-field col s12" <?php echo $cgstdisplay; ?>>
                                        <input id="cgstvalue" type="number" value="<?php echo $billDetails[salesbill_cgst_total] ?>" readonly>
                                        <label for="cgstvalue" class="active">CGST</label>
                                    </div>

                                    <div class="input-field col s12" <?php echo $sgstdisplay; ?>>
                                        <input id="sgstvalue" type="number" value="<?php echo $billDetails[salesbill_sgst_total] ?>" readonly>
                                        <label for="sgstvalue" class="active">SGST</label>
                                    </div>
                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="igstvalue" type="number" value="<?php echo $billDetails[salesbill_igst_total] ?>" readonly>
...
?>
<?php self::loadDesign('popup/vishnu/salesAddProductPopup'); ?>
