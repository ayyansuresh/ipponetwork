...
<form id="salesInvoice" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Sales Invoice</h4>
        </div>
            ...
            <div class="card-panel">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m2">
                        ...
                        <input id="totalSquareFeet" type="text" class="validate" readonly="" value="0.00">

                        <label for="totalSquareFeet" class="active">Total Square Feet</label>
                    </div>
                    <div class="input-field col s12 m2">
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="totalLineWeight" type="text" class="validate" readonly="" value="0.00">
