...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                <div style="width:15%;float:left;padding:0% 2%;">
                    <img src="<?php echo URL; ?>assets/img/logo/iron2.jpg" style="height:135px;width:100px" />
                </div>
                <div style="width:50%;float:left;">
                    <div style="text-align: center;" class="panel-body">
                        <div style="font-size:36px !important;"><strong><?php echo $companyDetails[company_name_english] ?></strong></div>
                        <div style="font-size:16px !important;">
                            <?php echo $companyDetails[companyaddress_address1] ?>,
                            <?php echo $companyDetails[companyaddress_address2] ?><br/>
                            VirudhuNagar - 626001<br>TamilNadu.<br>
                ...
                <div style="width:30%;float:right;padding:2% 0%;">
                    <div style="font-size:12px !important;"><label>Mobile : <strong><?php echo $companyDetails[companyaddress_mobile] ?></strong></label></div><br>
        ...
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:13px !important;width:55%;float:left;border:1px solid #000;height:150px;">
                    ...
                    <div style="font-size:15px !important;width:44.5%;float:left;border:1px solid #000;border-left:none;height:150px;">
                        <div class="panel panel-default">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:13px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    <thead>
                        <tr>
                            ...
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Weight (Kg)</strong></td>
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Sq.Ft</strong></td>
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="width:10%;border-right:1px solid #000;text-align: center;padding-right:1%;"><strong><?php echo $saleItem[commodity_HSNcode_ref]; ?></strong></td>
                                ...
                                <td style="width:10.5%;text-align: right;padding-right:1%;font-size:15px !important;">
                                    <strong><?php
                        ...
                        <tr>
                            ...
                            <td style="border-right:1px solid #fff;border-top:1px solid #000;">&nbsp;</td>
                            <td colspan="2" style="border-right:1px solid #fff;border-top:1px solid #000;text-align:center;border-top:1px solid #000;"><strong>Total Kgs:</strong></td>
                            ...
                            <td style="border-right:1px solid #fff;border-top:1px solid #000;"><strong>Sq.Ft:</strong></td>
                            <td style="border-top:1px solid #000;"><strong>15</strong></td>
                            <td style="border-top:1px solid #000;">&nbsp;</td>
                        </tr>
                    </tbody>
                </table>
                <div style="width:49.5%;height:105px;float:left;border:1px solid #000;border-top:none;border-right:none;">
                    <div style="padding-left:1%;font-size:12px !important;">
                        <STRONG> OUR BANK DETAILS : </STRONG> <BR/>
                        Account Name   : Vishnu Iron<br/>
                        Current Account Number :<?php echo $companyDetails[companyaddress_accno] ?><br/>
                        Bank Name : <?php echo $companyDetails[companyaddress_bank] ?><br/>
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:15px !important;">
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sales_bill_total])); ?></strong><br/>
                        </div>
                    </div>
                </div>
                <div style="width:100%;">
                    <div style="width:100%;font-size:14px !important;float:left;border:1px solid #000;text-align: left;padding-left: 3%;border-top:none;">
                        <strong>Rupees <?php echo ucfirst(generalhelper::convert_number($sales[salesbill_sales_bill_total])); ?> Only.</strong>
                    </div>
                </div>
                <div style="width:100%;text-align:right;padding-top:0.5%;font-size:15px !important;">
        ...
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:30%;float:right;padding:2% 0%;">
                    ...
                    <div style="font-size:12px !important;"><label>GSTIN: <strong><?php echo $companyDetails[companyaddress_gst] ?></strong></label></div><br>
                    <div style="font-size:12px !important;"><label>Place Of Supply: <strong>VirudhuNagar </strong></label></div><br>
                    <div style="font-size:12px !important;"><label><strong>TRANSPORT</strong></label></div>
                </div>
            </div>
        </div>
        <div class="row" style="font-size: 11px !important;">
