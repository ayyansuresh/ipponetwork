...
<?php
$pendingBills = paymentBlock::getPendingSalesBills();
?>
                        ...
                        <tbody>
                            ...
                            foreach ($pendingBills as $pendingBillsResult) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $pendingBillsResult[salesbillgold_advance_payment] ?></td>
                                    <td style="color:green;"><?php echo $pendingAmount ?></td>
                                    <td style="color:red;"><?php echo $paidAmount -$pendingBillsResult[salesbillgold_advance_payment]?></td>
