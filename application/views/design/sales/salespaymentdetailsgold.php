            ...
            <div class="card-panel">
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="input-field col s12" >
                            <input id="advanceAmount" type="number" value="<?php echo $salesBill[salesbillgold_advance_payment] ?>" readonly>
                            <label for="advanceAmount" class="active">Advance Amount</label>
                        </div>
                        <div class="input-field col s12" >
                        ...
                        <div class="input-field col s12" >
                            <input id="pendingAmount" type="number" value="<?php echo $salesBill[salesbill_sales_bill_total]-$paidAmount-$salesBill[salesbillgold_advance_payment] ?>" readonly>
                            <label for="pendingAmount" class="active">Pending Amount</label>
                        </div>
                        <div class="input-field col s12"  >
...
<?php self::loadDesign('popup/salesPaymentDelete'); ?>