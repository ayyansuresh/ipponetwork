<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/malleswara/newSalesvatcst.js"></script>
<script>
                                ...
                                <div class="row" id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1" <?php echo $cgstdisplay ?>>
                                                <input readonly  name="linecgstRate[]" type="text" value="<?php echo $billItems[salesbillitem_vat_rate] ?>">
                                            </div>
                                            <div class="input-field col s1" <?php echo $igstdisplay ?>>
                                                <input readonly  name="lineigstRate[]" type="text" value="<?php echo $billItems[salesbillitem_cst_rate] ?>">
                                            </div>
                                            <div class="input-field col s1">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12" <?php echo $cgstdisplay; ?>>
                                        <input id="cgstvalue" type="number" value="<?php echo $billDetails[salesbill_vat_total] ?>" >
                                        <label for="cgstvalue" class="active">CGST</label>
                                    </div>

                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="igstvalue" type="number" value="<?php echo $billDetails[salesbill_cst_total] ?>" >
...
?>
<?php self::loadDesign('popup/malleswara/salesAddProductPopupcstvat'); ?>
