...
<div class="container teal lighten-2">
    ...
    <div class="card-panel">
        <h4 class="header2">Search Order Number <?php echo $salesDisplay;?></h4>
        <div class="row">
            <div class="row">
                <div class="input-field col s12 m4">
                    <i class="mdi-action-find-in-page prefix"></i>
                    <input id="orderNumber" type="text" data-validation="number" data-content="Please Enter Bill Number">
