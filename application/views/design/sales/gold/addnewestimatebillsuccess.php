    ...
    <div class="row">
        <div class="col s12 m12 l12">
            <div class="card-panel">
                <h4 class="header2">SUCCESS (ORDER NUMBER -
...
<div class="modal-footer green lighten-4">
    ...
    <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeEstimateModal(<?php echo generalhelper::getGetElement('billGSTType') ?>);">Close</button>
</div>
<script>
    ...
    function print(printpage,gstType, billType ,company,accountYear)
    {
        ...
        var completeurl = url + 'sales-salesmalleswara/generateOrderGoldInvoicePdf?frombillnumber=' + billnumber +
