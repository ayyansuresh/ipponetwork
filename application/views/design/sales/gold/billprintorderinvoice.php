...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Print Order Invoice</h4>
    </div>
    <div class="card-panel">
        <h4 class="header2">Order Invoice Print</h4>
        <div class="row">
            <div class="row">
...
<script>
    ...
    function print(gstType, billType ,company,accountYear)
    {
        ...
        var completeurl = url + 'sales-salesmalleswara/generateOrderInvoicePdf?frombillnumber=' + frombillnumber +
