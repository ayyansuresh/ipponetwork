...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Order Entry Print</h4>
    </div>
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4">
                    <p><a class="waves-effect waves-light btn teal darken-2" href="#!" onclick="print('printpage','1','<?php echo $billType; ?>','<?php echo $companyId; ?>','<?php echo $accountyear; ?>');"><i class="mdi-action-print left"></i> Print</a></p>
                </div>
            </div>
        </div>
    </div>
