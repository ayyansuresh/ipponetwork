<?php
$salesBillVillageCustomerResult = salesInvoiceBlock::getGoldBillVillageDetailsById();
$salesBillVillage = (array) $salesBillVillageCustomerResult[0];
                ...
                <div class="row" id="receiptForm">
                    ...
                    foreach ($salesReceiptResult as $salesReceipt) {
                        ...
                        <div class="col s12">
                            ...
                            <?php 
                            if($salesReceipt[salespayment_mode] != 5){
                            ?>
                            <div class="col s1">
                                ...
                                <button style="text-align:center;" id="display" class="waves-effect waves-light btn teal darken-2"  type="submit" name="action" onclick="printPositionModal('<?php echo $salesReceipt[salespayment_id] ?>','<?php echo $salesReceipt[salespayment_receipt_number]  ?>','<?php echo $salesBill[salesbillgold_sales_bill_id]  ?>','<?php echo $salesBill[salesbillgold_sales_bill_number]  ?>','<?php echo $companyId; ?>','<?php echo $accountyear; ?>');">Print<i class="material-icons right">receipt</i></button><br/><br/>
                            </div>
                            <?php }else { ?>
                            <div class="col s1">                                
                            </div>
            ...
            <div class="card-panel">
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="input-field col s12"  >
                            <input id="customerName" type="text" value="<?php echo $salesBillVillage[village_customerName] ?>" readonly>
                            <input id="customerId" type="hidden" value="<?php echo $salesBillVillage[village_party_id] ?>" readonly>
...
<?php //self::loadDesign('popup/gold/salesPaymentWithinStatePopup'); ?>
