...
<div class="modal-footer green lighten-4">
    ...
    <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeUpdateOrderInvoiceModal(<?php echo generalhelper::getGetElement('billGSTType') ?>);">Close</button>
</div>
<script>
    ...
    function print(printpage,gstType, billType)
    {
        ...
        var completeurl = url + 'sales-salesmalleswara/generateOrderInvoicePdf?frombillnumber=' + billnumber +
