...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
        ...
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:11px !important;width:55%;float:left;border:1px solid #000;height:80px;">
                    ...
                    <div style="font-size:11px !important;width:44.5%;float:left;border:1px solid #000;border-left:none;height:80px;">
                        <div class="panel panel-default">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:11px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    <thead>
                        <tr>
                            ...
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>G/Mg</strong></td>
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>RATE</strong></td>
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>VAD (%)</strong></td>
                            <td style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>MC (Rs)</strong></td>
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="width:43%;border-right:1px solid #000;padding-left:1%;padding-top:0.5%;"><strong><?php echo $saleItem[items_name]; ?></strong></td>
                                ...
                                <td style="width:5%;border-right:1px solid #000;text-align: right;padding-right:1%;padding-top:0.5%;"><strong><?php echo $saleItem[salesbillitem_quantity] ?> <?php echo $saleItem[uom_name] ?></strong></td>
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:12px !important;">
                    ...
                    ?>
                <div style="width:49.5%;height:123px;float:left;border:1px solid #000;border-top:none;border-right:none;font-size:12px !important;">
                    <div style="padding-left:1%;">
                        <label>E. & O.E</label>
                        <br/>OUR BANK DETAILS : <STRONG><?php echo $sales[account_name] ?></STRONG><BR/>
                        <STRONG>A/C NO :</STRONG> <?php echo $sales[account_number] ?>
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:12px !important;">
                    ...
                    <div style="width:100%;">
                        <div style="width:64.25%;border-top:1px solid #000;border-right:1px solid #000;float:left;text-align: right;padding-right: 4%;"><strong>Purchase Old Items Total</strong></div>
                        <div style="width:30.25%;border-top:1px solid #000;float:left;text-align: right;">
                ...
                <div style="width:100%;text-align:right;padding-top:0.5%;font-size:12px !important;">
                    ...
                    <div style="width:50%;float:left;text-align: left;">
                        <?php 
                        if($sales[salesbillgold_advance_payment]!=0){
                        ?>
                        <label><strong>Amount Paid : Rs.</strong> <?php echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbillgold_advance_payment])); ?></label>
                        <?php
                        }else{
                        ?>
                        &nbsp;
        ...
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:25px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:30%;float:right;padding:0% 0%; ">
                    <div style="font-size:12px !important;"><label>GSTIN: <strong><?php echo $companyDetails[companyaddress_gst] ?></strong></label></div><br>
                    <div style="font-size:12px !important;"><label>Place Of Supply: <strong>Kovilpatti </strong></label></div><br>
                    <div style="font-size:12px !important;"><label><strong>DUPLICATE</strong></label></div>
                </div>
            </div>
        </div>
        <div class="row" style="font-size: 11px !important;">
