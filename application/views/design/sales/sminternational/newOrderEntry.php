<script type="text/javascript" src="<?php echo URL; ?>assets/js/order/newOrder.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>assets/js/materialize/materialize-validation.min.js"></script>
<script type="text/javascript">
    $(document).ready(function () {
        $("#newOrderentry").materialvalidation({
            theme: "materialize"
        });
        $("#newOrderentry").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#newOrderentry").data().materialvalidation.methods.validate()) {
                makeNewOrder();
            }
            return false;
        });
...
<style>
    .picker__month-display{font-size: 1rem !important;}.picker__day-display{font-size: 2.5rem !important;}.picker__year-display{font-size: 1.5rem !important;}select.browser-default{margin-left: 1rem;}#makeNewOrder:focus{background-color:#ff4081 !important;}#addNewProduct:focus{background-color:#ff4081 !important;}
</style>
<form id="newOrderentry" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">New Order</h4>
        </div>
        <div class="col s12 m12 l12">
            <div class="row">
                <div class="col s12 m12 l6">
                    <div class="card-panel">
                        <h4 class="header2">ORDER DETAILS</h4>
                        <div class="row">
                            <div class="row">
                                <div class="input-field col s12" style="margin-bottom: 25px !important;">
                ...
                <div class="col s12 m12 l6">
                    <div class="card-panel">
                        <h4 class="header2">ADVANCE PAYMENT</h4>
                        <div class="row">
                            <div class="row">
                                <div class="input-field col s12">
                            <div class="input-group">
                                <label for="advancePayment">Advance</label>
                                <div class="sel-wrap">
                                    <select id="advancePayment" class="floating-label active" onchange="loadPaymentMode(this.value)">
                            ...
                            <script>
                                floatingSelect2('advancePayment');
                            </script>
                        </div>
                        <div id="advancePaymentMode" class="input-field col s12">
...
<?php self::loadDesign('popup/sminternational/orderAddProductPopup'); ?>
