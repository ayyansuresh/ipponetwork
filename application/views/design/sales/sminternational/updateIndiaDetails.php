                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        foreach ($billItemDetails as $billItems) {
                                            ...
                                            <div class="input-field col s1" style="display:none">
                                                <input readonly="" name="linecgstRate[]" type="text" value="9">
                                            </div><div class="input-field col s1" style="display:none">
                                                <input readonly="" name="linesgstRate[]" type="text" value="9">
                                            </div>
                                            <div class="input-field col s1" style="display:none">
                                                <input readonly="" name="lineigstRate[]" type="text" value="0.00">
                                            </div>
