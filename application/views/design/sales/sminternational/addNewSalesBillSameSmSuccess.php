...
<div class="modal-footer green lighten-4">
    <button  class="waves-effect waves-red btn-flat modal-action" onclick="closeSmWithStateSalesModal(<?php echo generalhelper::getGetElement('billGSTType') ?>);">Close</button>
</div>