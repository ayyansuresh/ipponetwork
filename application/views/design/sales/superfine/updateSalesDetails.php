                                ...
                                <div class="row" id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            </div><div class="input-field col s1" <?php echo $igstdisplay ?>>
                                            ...
                                            <div class="input-field col s1">
                                                <input readonly  name="lineUOMDisplay[]" type="text" value="<?php echo $billItems[uom_name] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                            ...
                                            <div class="input-field col s1">
                                                <input  id="incentivePercentage<?php echo $count ?>" name="incentivePercentage[]" type="text" value="<?php echo $billItems[salesbillitem_incentivePercentage] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                                <input  id="incentiveTaxAmount<?php echo $count ?>" name="incentiveTaxAmount[]" type="text" value="<?php echo $billItems[salesbillitem_incentiveTaxamount] ?>">
                                            </div>
                                            <div class="input-field col s1" <?php echo $igstdisplay ?>>
                                                <input readonly  name="linenumberofbags[]" type="text" value="<?php echo $billItems[salesbillitem_bags] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="linetotalwithtax[]" type="text" value="<?php echo $billItems[salesbillitem_total] ?>">
                                            </div>
                                            <div class="input-field col s1">
                        ...
                        <div class="card-panel">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                    <input id="incentiveAmount" type="text" readonly value="<?php echo $billDetails[salesbill_incentiveAmount] ?>" >
                                    <label for="incentiveAmount" class="active">Total Incentive Amount</label>
                                    </div>
                                    <div class="input-field col s12">
...
?>
<?php self::loadDesign('popup/superfine/salesAddProductPopup'); ?>
