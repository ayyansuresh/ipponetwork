...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
        ...
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:14px !important;width:49.8%;float:left;border:1px solid #000;height:110px;">
                    ...
                    <div style="font-size:14px !important;width:49.7%;float:left;border:1px solid #000;border-left:none;height:110px;">
                        <div class="panel panel-default">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <div style="font-family:arial;font-size:13px !important;width:49.5%;height:51px;float:left;border:1px solid #000;border-top:none;border-right:none;">
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:12px !important;">
                    <div style="width:100%;">
                        <div style="width:64.25%;border-right:1px solid #000;border-bottom:1px solid #000;float:left;text-align: right;padding-right: 4%;"><strong>IGST (<?php echo $saleItem[salesbillitem_Igst_rate] ?> %)</strong></div>
                        <div style="width:31.25%;float:left;text-align: right;border-bottom:1px solid #000;">
