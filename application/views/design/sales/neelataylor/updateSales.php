<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/neelataylor/updateSales.js"></script>
<?php
$gstType = generalhelper::getGetElement('gstType');
if ($gstType == 1) {
    $salesDisplay = "Order Update";
} else {
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Order Update</h4>
    </div>
        ...
        <div class="row">
            <div class="row">
                <div class="input-field col s12 m4">
                    ...
                    <label for="billNumber">Order Number</label>
                </div>
                <div class="input-field col s12 m4">
