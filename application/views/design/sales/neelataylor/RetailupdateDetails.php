                        ...
                        <table id="myTable" style="margin-top:15px;">
                                ...
                                foreach ($billItemDetails as $billItems) {
                                   ...
                                   <tr>
                                        ...
                                        <td class="input-field"><input id="unitRate0" type="text" value="<?php echo $billItems[salesbillitem_unit_rate]; ?>" name="lineunitrate[]" onchange="finalTotal(0)"> <label for="unitRate">Retail Unit Rate </label> </td>
                                        <td class="input-field"><input id="Qty0" onchange="finalTotal(0)" type="text" value="<?php echo $billItems[salesbillitem_quantity]; ?>" name="linequantity[]"><label  for="Qty">Quantity</label></td>
                                          <td class="input-field"><input id="discount0" onchange="finalTotal(0)" type="text" value="<?php echo $billDetails[salesbill_total_discount] ?>" name="linediscount[]"><label for="discount" class="active">Discount</label></td>
                                        <td class="input-field">
                                        <input id="hsnCode0" type="hidden" value="<?php echo $billItems[commodity_HSNcode_ref]; ?>" name="hsnCode[]" readonly=""> <!--<label  for="hsnCode">hsncode</label> -->
                                          <input id="cgstRate0" type="hidden" name="linecgstRate[]"  value="<?php echo $billItems[salesbillitem_cgst_rate] ?>" readonly=""> <!--<label  for="cgstRate">cgstRate</label> -->
                                         <input id="sgstRate0" type="hidden" name="linesgstRate[]" value="<?php echo $billItems[salesbillitem_sgst_rate] ?>" readonly=""> <!--<label  for="sgstRate">sgstRate</label> -->
                                         <input id="igstRate0" type="hidden" name="lineigstRate[]" value="<?php echo $billItems[salesbillitem_igst_rate] ?>" readonly=""> <!--<label  for="igstRate">igstRate</label>  -->
                                        <input id="UOM0" type="hidden" name="lineUOM[]" value="<?php echo $billItems[salesbillitem_UOM_ref_id] ?>" readonly="">  <!--<label  for="UOM">UOM</label>  -->
                                         <input id="commodityRefId0" type="hidden" name="linecommodityRefId[]"  value="<?php echo $billItems[salesbillitem_commodity_ref_id] ?>" readonly=""> <!--<label  for="commodityRefI">commodityRefId</label> -->
                                         <input id="packingFactor0" type="hidden" name="linepackingfactor[]" value="<?php echo $billItems[salesbillitem_packing_factor] ?>" readonly="">  <!--<label  for="packing">packing</label> -->
                                         <input id="billFactor0" type="hidden" name="linebillFactor[]"value="<?php echo $billItems[items_billFactor] ?>"  readonly="">  <!--<label  for="bill">bill</label>  -->

                                         <input id="numberofbags0"  type="hidden"   name="linenumberofbags[]"value="<?php echo $billItems[salesbillitem_bags] ?>">  <!--<label  for="noBag">nobag</label> -->
                                         <input id="linetotal0" type="hidden" name="linetotal[]" readonly="" value="<?php echo $billItems[salesbillitem_total] ?>"> <!--<label  for="lineTotal">line Total</label>  -->
