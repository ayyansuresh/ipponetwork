...
foreach ($invoice as $sales) {
    ...
    <div class="container" style="font-family:arial;">
            ...
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:50%;float:left;">
                    <div style="text-align: center;" class="panel-body">
                        <div style="font-size:20px !important;"><strong><?php echo $companyDetails[company_name_english] ?></strong></div>
                ...
                <div style="width:30%;float:right;padding:4% 0%;">
                    <div style="font-size:14px !important;"><label>GSTIN: <strong><?php echo $companyDetails[companyaddress_gst] ?></strong></label></div><br>
                    <div style="font-size:14px !important;"><label>Place Of Supply: <strong>Virudhunagar </strong></label></div><br>
                    <div style="font-size:14px !important;"><label><strong>SUPPLIER COPY</strong></label></div>
                </div>
            </div>
        </div>
        <div class="row" style="font-size: 11px !important;">
            <div class="col-xs-12">
                <div class="row">
                    <div style="font-size:15px !important;width:55%;float:left;border:1px solid #000;height:150px;">
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            <tr>
                                ...
                                <td style="width:10.5%;text-align: right;padding-right:1%;font-size:15px !important;"><strong>
                                        <?php
                                        echo generalhelper::formatInIndianStyle($saleItem[salesbillitem_total]);
                                        ?>
                            </tr>
                            <?php
                            $count++;
                ...
                <div style="width:49.5%;height:170px;float:left;border:1px solid #000;border-top:none;border-right:none;font-size:12px !important;">
                    <div style="padding-left:1%;">
                        <label>E. & O.E</label>
                        <br/> <span style="text-decoration: underline;"><STRONG>Our Bank Details</STRONG></span> :<br/>
                        <?php echo $companyDetails[companyaddress_bank] ?><br/> A/C NO :<?php echo $companyDetails[companyaddress_accno] ?>
                        <br>
                        IFS CODE : <?php echo $companyDetails[companyaddress_ifsc] ?>
<br/><br/><span style="text-decoration: underline;"><strong>Terms & Conditions</strong></span> :<br/><label>1.  We are not responsible for any loss in transit.</label><br/><label>2.  Goods once sold cannot be taken back.</label><br/><label>3.  Subject to Virudhunagar Juridiction only.</label>                    </div>
                </div>
                <div style="width:50%;height:170px;float:left;border:1px solid #000;border-top:none;font-size:15px !important;">
                    <div style="width:100%;">
                        ...
                        <div style="width:26.5%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle($sales[salesbill_running_total]) ?></strong>
                        </div>
                    </div>
                    <div style="width:100%;">
                        ...
                        <div style="width:25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle($sales[salesbill_cgst_total]) ?></strong></div>
                      ...
                      <div style="width:100%;">
                        ...
                        <div style="width:25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle($sales[salesbill_sgst_total]) ?></strong></div>
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php
                        echo generalhelper::formatInIndianStyle(sprintf('%.2f',$sales[salesbill_round_off])); ?></strong></div>
                    </div>
                    <div style="width:100%;">
                        <div style="width:69%;float:left;border-right:1px solid #000;border-top:1px solid #000;text-align: right;padding-right: 4%;border-bottom:1px solid #000;">
                            <strong>GRAND TOTAL Rs.</strong>
                        </div>
                        <div style="width:25%;float:left;border-top:1px solid #000;text-align: right;border-bottom:1px solid #000;">
        ...
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:30%;float:right;padding:4% 0%;">
                    <div style="font-size:14px !important;"><label>GSTIN: <strong><?php echo $companyDetails[companyaddress_gst] ?></strong></label></div><br>
                    <div style="font-size:14px !important;"><label>Place Of Supply: <strong>Virudhunagar </strong></label></div><br>
                    <div style="font-size:14px !important;"><label><strong>TRANSPORTER COPY</strong></label></div>
                </div>
            </div>
        </div>
        <div class="row" style="font-size: 11px !important;">
        ...
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                ...
                <div style="width:30%;float:right;padding:4% 0%;">
                    <div style="font-size:14px !important;"><label>GSTIN: <strong><?php echo $companyDetails[companyaddress_gst] ?></strong></label></div><br>
                    <div style="font-size:14px !important;"><label>Place Of Supply: <strong>Virudhunagar </strong></label></div><br>
                    <div style="font-size:14px !important;"><label><strong>ORIGINAL FOR RECIPIENT </strong></label></div>
                </div>
            </div>
        </div>
        <div class="row" style="font-size: 11px !important;">
