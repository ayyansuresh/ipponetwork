                ...
                <div class="card-panel">
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="input-field col s12" value="0.00">
                                <center>  <button id="makeInvoice" class="btn teal darken-2" onclick="loadPaymentMode();" type="submit">PAY</button> </center>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php self::loadDesign('popup/shivamobiles/salesPaymentWithinStatePopup'); ?>