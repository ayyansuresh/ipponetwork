                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12" <?php echo $cgstdisplay; ?>>
                                        <input id="cgstvalue" type="text" readonly value="<?php echo $billDetails[salesbill_cgst_total] ?>" >
                                        <label for="cgstvalue" class="active">CGST</label>
                                    </div>

                                    <div class="input-field col s12" <?php echo $sgstdisplay; ?>>
                                        <input id="sgstvalue" type="text" readonly value="<?php echo $billDetails[salesbill_sgst_total] ?>" >
                                        <label for="sgstvalue" class="active">SGST</label>
                                    </div>
                                    <div class="input-field col s12" <?php echo $igstdisplay; ?> >
                                        <input id="igstvalue" type="text" readonly value="<?php echo $billDetails[salesbill_igst_total] ?>" >
                                        <label for="igstvalue" class="active">IGST</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="roundOff" type="text" readonly value="<?php echo $billDetails[salesbill_round_off] ?>">
...
?>
<?php self::loadDesign('popup/shivamobiles/salesAddProductPopup'); ?>
