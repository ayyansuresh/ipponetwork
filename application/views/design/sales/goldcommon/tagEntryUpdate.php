...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Tag Entry Update</h4>
    </div>
    <form class="formValidate" id="salesGstReportsform" novalidate>
        <div class="card-panel">
            <h4 class="header2">Tag Entry Update</h4>
            <div class="row">
                <div class="row">
                    <div class="input-field col s12 m2">
                        <input id="tagNumber" type="text" value="" >
                        <label for="tagNumber" class="active">Tag Number</label>
                    </div>
                    <!-- <div class="input-field col s12 m2">
