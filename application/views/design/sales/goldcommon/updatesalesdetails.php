                                ...
                                <div  id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1">
                                                <input id="vad<?php echo $count; ?>"  onchange="finalTotal(<?php echo $count; ?>);" type="text" value="<?php echo $billItems[salesbillitem_vad]; ?>" readonly="" name="vad[]">
                                            </div>
                                            <div class="input-field col s1">
                                                <input id="makingCharge<?php echo $count; ?>" onchange="finalTotal(<?php echo $count; ?>);" type="text" value="<?php echo $billItems[salesbillitem_makingCharge]; ?>"readonly="" name="makingCharge[]">
                                            </div>
