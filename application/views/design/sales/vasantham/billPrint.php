...
?>
<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/vasantham/updateSales.js"></script>
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4" style="display:none">
                        ...
                        <div class="sel-wrap">
                            <select id="billType" class="floating-label">
                                ...
                                <option value="2" selected>Transport Copy (Dot Matrix)</option>
                ...
                <div class="input-field col s12 m4">
                    <p><a class="waves-effect waves-light btn teal darken-2" href="#!" onclick="printAction('<?php echo $gstType; ?>','<?php echo $companyId; ?>','<?php echo $accountyear; ?>')"><i class="mdi-action-print left"></i> Print</a></p>
                </div>
            </div>
        </div>
    </div>
