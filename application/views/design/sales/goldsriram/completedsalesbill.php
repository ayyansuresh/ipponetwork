...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Completed Sales Bill Detail</h4>
    </div>
                    ...
                    <table id="data-table-simple" class="paymentSales responsive-table display">
                        ...
                        <tbody>
                            ...
                            foreach ($pendingBills as $pendingBillsResult) {
                                ...
                                if ($pendingBillsResult['billAmount'] == $pendingBillsResult[salesbillgold_advance_payment]) {
                                    ?>
                                    <tr>
                                        ...
                                        <td style="color:green;"><?php echo $pendingBillsResult[salesbillgold_advance_payment] ?></td>
...
<link rel="stylesheet" href="<?php echo URL; ?>assets/css/select2/custom.css">||||||| .r0
