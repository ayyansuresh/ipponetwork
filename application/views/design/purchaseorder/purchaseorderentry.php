            ...
            <div class="card-panel">
                ...
                <div class="row">
                    <div class="input-field col s12 m4">
                        ...
                        <label for="despatch">PO Number</label>
                    </div>
                    <div class="input-field col s12 m4">
                        <i class="mdi-action-event prefix"></i>
                        <input id="transportName" type="text" class="validate focus">
                        <label for="transportName">Description</label>
                    </div>
                    <div class="input-field col s12 m2" style="display:none">
                        <i class="mdi-action-event prefix"></i>
                    ...
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="input-field col s12"  >
                                    <input id="roundOff" type="text"  value="0.00" readonly>
                                    <label for="roundOff" class="active">Round Off</label>
                                </div>

                                <div class="input-field col s12"  >
                                    <input id="grandTotal" type="text" readonly value="0.00">
                                    <label for="grandTotal" class="active">Grand Total</label>
                                </div>
                                <div class="input-field col s12" value="0.00">
                                    <center>  <button id="makeInvoice" class="btn teal darken-2" type="submit" form="salesInvoice">MAKE PO</button> </center>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php self::loadDesign('purchaseorder/purchaseorderproductpopup'); ?>
