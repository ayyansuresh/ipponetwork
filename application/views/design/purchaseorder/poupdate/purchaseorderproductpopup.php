...
<div id="newProductForSales" class="modal modal-fixed-footer teal" >
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <h4 class="header2">Purchase Order Product </h4>
                    <div class="row">
                        <form class="col s12" id="newsalesproductform">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m3" style="display:none">
                                    ...
                                    <label for="numberOfBags" >Commission</label>
                                </div>

                                <div class="input-field col s12 m3" style="display:none">
                                    <input id="packingFactor" type="text">
                                    <label for="packingFactor" class="active"> Freight</label>
                                </div>
    ...
    <div class="modal-footer green lighten-4">
        <button  class="waves-effect waves-green btn-flat" onclick="poItemUpdateSave();">Save</button>
