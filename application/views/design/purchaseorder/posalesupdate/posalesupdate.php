<script type="text/javascript" src="<?php echo URL; ?>assets/js/purchaseorder/posalesupdate.js"></script>
<?php
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">PURCHASE ORDER SALES UPDATE</h4>
    </div>
        ...
        <div class="row">
            <div class="row">
                <div class="input-field col s12 m4">
                    ...
                    <input id="billNumber" type="text" data-content="Please Enter Bill Number">
