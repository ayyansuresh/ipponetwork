            ...
            <div class="card-panel">
                <div class="row">
                    ...
                    <div class="input-field col s12 m2" >
                        <input id="billNumber" type="hidden" value="<?php //echo $billNumber   ?>" readonly>
                       ...
                       !-->
                        ...
                        <input id="billNumberDisplay" type="text"
                             data-validation="alphanumeric" data-content="Please enter the bill no" >
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="customerName" class="floating-label active" 
                                         data-validation="select" data-content="Please Select Customer Name">
                ...
                <div class="row">
                    <div class="input-field col s12 m2">
                        ...
                        <label for="recieveDate">Receive Date</label>
                    </div>
                    <div class="input-field col s12 m2">
                        <div class="input-group">
                    ...
                    <script>
                            floatingSelect2Change('reverseCharge');
                    </script>   
                    </div>
                    <div class="input-field col s12 m3">
                        <i class="mdi-action-event prefix"></i>
                    ...
                    <div class="input-field col s12 m4" id="normalCustomer" >
                        <div class="input-group">
                            <label for="customerSiteName">Customer Name</label>
                            <div class="sel-wrap">
