<script type="text/javascript" src="<?php echo URL; ?>assets/js/sales/malliga/newSales.js"></script>
...
if (count($billDetailsRecord) > 0) {
    ...
    <form id="updatePurchaseInvoice" novalidate>
        ...
        <div class="container teal lighten-2">
            <?php if($billDetails[purchasebill_debit_note]==="1") { ?>
                ...
                <div class="card-panel">
                    <div class="row">
                            ...
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="billType" class="floating-label active" data-validation="select" data-content="Please select Bill Type">
                                        ...
                                        <option value="3" <?php if ($billDetails[purchasebill_purchase_bill_type] == 3) echo 'selected'; ?>>Village Purchase</option>
                                                 </select>
                                    <div class='bar'></div>
                                </div>  
                            </div>
                        ...
                        <div class="input-field col s12 m6" id="normalCustomer" >
                            <div class="input-group">
                                <label for="customerName" class="active">Supplier Name</label>
                                <div class="sel-wrap">
                        ...
                        <div id="villageCustomer" style="display: none;">
                            <div class="input-field col s12 m3" >
                                ...
                                <input id="villagecustomerName" type="text" class="validate" value="<?php echo $billDetails[customer_name] ?>" >
                                <input id="villagecustomerId" type="hidden" class="validate" value="<?php echo $billDetails[customer_id] ?>" >
                            </div>
                            <div class="input-field col s12 m3">
                                <label for="villagecustomerCity" class="active">Town Name</label>
                                <input id="villagecustomerCity" type="text" class="validate" value="<?php echo $billDetails[customer_field2] ?>" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12 m2">
                            ...
                            <input id="recieveDate" type="date" class="datepicker" value="<?php echo $billDetails[purchasebill_recieve_date] ?>">
                        ...
                        <div class="input-group">
                            <label for="customerSiteName" class="active">Customer Name</label>
                            <div class="sel-wrap">
                                <select id="customerSiteName" class="floating-label active"   >
                                    <option value="" selected >Select Customer</option>
                                    <?php echo customerBlock::getCustomerNameByType(2, $gstBillType, ""); ?>
                                </select>
                                <div class='bar'></div>
                            </div>  
                        </div>
                        ...
                        <script>
                            floatingSelect2('customerSiteName');
                                $("#customerSiteName").val(<?php echo $billDetails[purchasebill_customer_site_ref_id] ?>).trigger("change");
                        </script>
                    </div>
                                ...
                                <div class="row" id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1">
                                                <input readonly  name="linediscount[]" type="text" value="<?php echo $billItems['purchasebillitemDiscount'] ?>">
                                            </div>
                                            <div class="input-field col s1">
...
<?php self::loadDesign('popup/malliga/salesAddProductPopup'); ?>
