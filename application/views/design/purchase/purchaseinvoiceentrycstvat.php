...
?>
<form id="newPurchaseForm" onsubmit="makePurchaseInvoice();" >
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Purchase Invoice</h4>
        </div>
            ...
            <div class="card-panel">
                <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="billType" class="floating-label active">
                                    ...
                                    <option value="3" >Village Purchase</option>
                                </select>
                                <div class='bar'></div>
                            </div>  
                        </div>
                    ...
                    <div class="input-field col s12 m2">
                       ...
                       !-->
                        <input id="billGSTType" type="hidden"  value="<?php echo $gstBillType ?>" readonly>
                        <i class="mdi-av-my-library-books prefix"></i>
                        <input id="billNumberDisplay" type="text">
                        <label for="billNumberDisplay" >Bill Number</label>
                    </div>
                ...
                <div class="row">
                    <div class="input-field col s12 m4">
                        <i class="mdi-action-event prefix"></i>
                        <input id="transportName" type="text"  focus">
                    ...
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="input-field col s12" value="0.00">
                                    <center>  <button id="makeInvoice" class="btn teal darken-2" form='newPurchaseForm' type="submit" name='action'>MAKE INVOICE</button> </center>
                                </div>
                            </div>
                        </div>
                    </div>
