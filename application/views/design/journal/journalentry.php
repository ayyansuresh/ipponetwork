...
<form class="formValidate" id="addJournalEntry" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Journal Entry</h4>
        </div>
                    ...
                    <div class="card-panel">
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m3">
                                    <button id="saveGdc" class="btn teal darken-2" type="button" onclick="loadJournalEntry();">RESET</button>
                                </div>
                            </div>
                    </div>
                </div>
