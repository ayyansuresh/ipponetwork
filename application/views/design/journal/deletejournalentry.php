...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Journal Entry Details</h4>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($journalDetailsResult[journalItems_transactionType] == 2) {
                                        echo '<font color="red">Input : ' . $journalDetailsResult[items_name] ." (".$journalDetailsResult[journalItems_quantity]. ")</font><br/>";
                                    } else {
...
<?php self::loadDesign('popup/journalEntryDelete'); ?>
