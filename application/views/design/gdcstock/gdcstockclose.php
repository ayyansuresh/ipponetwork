...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">GDC Stock Close</h4>
    </div>
                        ...
                        <tbody>
                            ...
                            foreach ($gdcStockDetails as $gdcStockDetailsResult) {
                                ...
                                <tr>
                                    ...
                                    <td><i class="material-icons" onclick="loadGDCStockCloseDetails(<?php echo $gdcStockDetailsResult[gdc_out_id] ?>);">clear</i></td>
                                </tr>
                                <?php
                                $count++;
                            }
...
<div id="closeGDCStockDetails"></div>
