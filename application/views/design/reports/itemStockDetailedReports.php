...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Detailed Item Stock Reports</h4>
    </div>
                    ...
                    <div class="input-field col s12 m4">
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                ...
                                <select id="itemName" class="floating-label">
                                    
                                    <option value="" disabled selected>Select Item Name</option>
                                    
                                 <?php echo stockBlock::getItemName(); ?> 
...
<div id="loadItemDetailedGrid"></div>
