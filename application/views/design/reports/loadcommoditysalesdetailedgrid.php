        ...
        <div class="row">
            ...
            <div class="input-field col s12 m3">
                <button class="waves-effect waves-light btn teal darken-2" 
                        onclick="printCommoditySalesReports('<?php echo generalhelper::getGetElement('fromDate') ?>',
                        ...
                        <tbody>
                            ...
                            foreach ($salesReport as $sales) {
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $sales[customer_gst_number]; ?>   </td>
                                    <td> <?php echo $sales['Quantity']; ?>  </td>
                                    <td> <?php echo $sales['total']; ?>  </td>
                                    <td> <?php echo $sales['cgstTotal']; ?>  </td>
                                    <td> <?php echo $sales['sgstTotal']; ?> </td>
                                    <td>  <?php echo $sales['igstTotal']; ?>  </td>
                                </tr>
                                <?php
