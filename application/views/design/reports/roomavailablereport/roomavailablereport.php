...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Available Room Reports</h4>
    </div>
    <form class="formValidate" id="stockDetailedReportsForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Available Room Reports</h4>
            <div class="row">
                <div class="row">
    ...
    <div class="container teal lighten-2">
        ...
        <div class="card-panel">
            <div class="row">
                ...
                <div class="input-field col s12 m3" >
                    <center> <button class="waves-effect waves-light btn teal darken-2" onclick="printAvailableRoomReport('<?php echo $courentDate ?>', 1, '');"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
                    </center>
                </div>
            </div>
            <div class="row">
