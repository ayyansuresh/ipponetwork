    ...
    <div class="card-panel">
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m3" >
                    <center> <button class="waves-effect waves-light btn teal darken-2" onclick="printCheckinOutReport('', 2, '<?php echo $fromDate ?>');"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
                    </center>
                </div>
            </div>
