    ...
    $(document).ready(function () {
        ...
        $("#customerReportsForm").submit(function (evt) {
            ...
            if ($("#customerReportsForm").data().materialvalidation.methods.validate()) {
                loadCustomerCreditPointReportsGrid();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Customer Credit Point Reports</h4>
    </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="customerName" class="floating-label">
                                    ...
                                    <?php echo stockBlock::getAllCustomerName(); ?> 
