...
$unRegisteredTaxableValueWithinStatePurchase = commodityPurchaseBlock::getUnRegisteredTaxableValue(1);
        ...
        <div class="row">
            <div id="admin" class="col s12">
                <div class="card material-table">
                    ...
                    <button class="waves-effect waves-light btn teal darken-2" onclick="printGstrReports();"><i class="mdi-av-my-library-books left"></i> Export to PDF</button> 
