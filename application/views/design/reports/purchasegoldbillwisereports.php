...
<script type="text/javascript">
    $(document).ready(function () {
        $("#purchaseGstReportsform").materialvalidation({
            theme: "materialize"
        });
        $("#purchaseGstReportsform").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#purchaseGstReportsform").data().materialvalidation.methods.validate()) {
                loadGoldPurchaseGstReportsBillWiseDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Purchase Bill Wise GST Reports</h4>
    </div>
    
    <form class="formValidate" id="purchaseGstReportsform" novalidate>
        <div class="card-panel">
            <h4 class="header2">Purchase Gst Reports</h4>
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                        <button class="waves-effect waves-light btn teal darken-2" form="purchaseGstReportsform" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
