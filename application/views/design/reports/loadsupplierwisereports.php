...
<script type="text/javascript">
    $(document).ready(function() {
        $("#supplierDetails").materialvalidation({
            theme: "materialize"
        });
        $("#supplierDetails").submit(function(evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#supplierDetails").data().materialvalidation.methods.validate()) {
                loadSupplierGridDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Supplierwise Sales Report</h4>
    </div>
    <form class="formValidate" id="supplierDetails" novalidate>
    <div class="card-panel">
        <h4 class="header2">Supplierwise Sales Report</h4>
        <div class="row">
            <div class="row">
                ...
                <div class="input-field col s12 m4">
                   <button class="waves-effect waves-light btn teal darken-2" form="supplierDetails" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
                </div>
            </div>
        </div>
    </div>
...
<div id="loadsupplierDetails"></div>
