...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Liability Transaction Reports</h4>
    </div>
...
<div id="loadLiabilityTxnReportGrid"></div>
