...
$staffName = "";
if($CustomerID != -1) {
    $customerName = salesInvoiceBlock::getCustomerNameByID($CustomerID);
} else {
    $customerName = "All";
}
if($StaffID != -1) {
    $staffName = salesInvoiceBlock::getStaffNameByID($StaffID);
} else {
    $staffName = "All";
}
                ...
                <div style="font-size:11px !important;width:100%;float:left;border:1px solid #000;">
                    <div class="panel panel-default">
                        <div style="width:100%;border-bottom:1px solid #ccc;text-align: center;background-color: #000;color:#fff;font-size:12px !important;">
                            <strong> PAYROLL DETAIL REPORT</strong>
                        </div>
                        <div>
                            <table style="width: 100%; max-width: 1200px; margin: 0 auto; padding: 15px; font-family: Arial, sans-serif; font-size: 14px; border-collapse: collapse; background-color: #f9f9f9; border: 1px solid #ddd;">
                                <tr>
                                    ...
                                    <td style="padding: 10px; text-align: left; border-bottom: 1px solid #eee; font-weight: bold; color: #333;">Customer Name :</td>
                                    <td style="padding: 10px; text-align: left; border-bottom: 1px solid #eee; color: #0066cc;"><?php echo htmlspecialchars($customerName); ?></td>
                                
                                    <td style="padding: 10px; text-align: left; border-bottom: 1px solid #eee; font-weight: bold; color: #333;">Staff Name :</td>
                                    <td style="padding: 10px; text-align: left; border-bottom: 1px solid #eee; color: #0066cc;"><?php echo htmlspecialchars($staffName); ?></td>
