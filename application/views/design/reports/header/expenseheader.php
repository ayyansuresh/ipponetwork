...
$generatedOn = date("d-m-Y h:i A"); // 01-01-2026 07:15 PM
...
<div class="row">
    <div style="width:100%;border:1px solid #000;font-size: 16px !important;">
        ...
        <div style="width:40%;float:right;text-align:right;padding:10px;font-size:12px;">
            <strong>Report Generated On: <?php echo date("d-m-Y h:i A"); ?></strong>
