    ...
    $(document).ready(function () {
        ...
        $("#dayWiseReportsForm").submit(function (evt) {
            ...
            if ($("#dayWiseReportsForm").data().materialvalidation.methods.validate()) {
                loadDayWiseStockReportsDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Daywise Stock Report</h4>
    </div>
    <form class="formValidate" id="dayWiseReportsForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Daywise Stock Report</h4>
            <div class="row">
                <div class="row">
...
<div id="loadStockDayWiseGrid"></div>