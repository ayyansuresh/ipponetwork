...
$BTCResult = purchaseBlock::getPurchaseBillWiseGstBTCReports(generalhelper::getSessionElement('beebooklogincompanyid'), generalhelper::getSessionElement('beebookloginaccountyearid'));
    ...
    <div class="card-panel">
        <div class="row">
            ...
            <div class="input-field col s12 m3">
                <button class="waves-effect waves-light btn teal darken-2" onclick="printPurchaseGSTBillWiseReports('<?php echo generalhelper::getGetElement('fromDate') ?>', '<?php echo generalhelper::getGetElement('toDate') ?>', '<?php echo generalhelper::getGetElement('customerId') ?>');"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
            </div>
            <div class="input-field col s12 m3">
    ...
    <div class="card-panel">
        <div class="row">
            <div class="input-field col s12 m6 right">
                <button class="waves-effect waves-light btn teal darken-2" onclick="printExcelPurchaseGSTBillWiseReportsB2C();"><i class="mdi-av-my-library-books left"></i> Export to Excel</button>
            </div>
            <div id="admin" class="col s12">
                <div class="card material-table">
