...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Available Stock Reports</h4>
    </div>
    <form class="formValidate" id="stockDetailedReportsForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Available Reports</h4>
            <div class="row">
                <div class="row">                    
                    <div class="input-field col s12 m4">
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                ...
                                <select id="commodityName" onchange="loadItemType(this.value)" class="floating-label">
