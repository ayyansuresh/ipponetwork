...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;"><?php echo $itemName ?></h4>
    </div>
    <div class="card-panel">
        <div class="row">
            ...
            <div class="input-field col s12 m2">
                ...
                <input id="availableStock" type="text" readonly value="<?php echo $trialStockFinal[openingstockitem_UOM_quantity]; ?>">
                <label class="active" for="availableStock">Opening Stock</label>
            </div>
            <div class="input-field col s12 m3">
                <button class="waves-effect waves-light btn teal darken-2" onclick="printItemStockDetailedReports();"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
            </div>
