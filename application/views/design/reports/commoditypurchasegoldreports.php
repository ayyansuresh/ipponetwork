...
<script type="text/javascript">
    $(document).ready(function () {
        $("#commodityPurchaseReportsForm").materialvalidation({
            theme: "materialize"
        });
        $("#commodityPurchaseReportsForm").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#commodityPurchaseReportsForm").data().materialvalidation.methods.validate()) {
                loadCommodityPurchaseGoldDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    ...
    <form class="formValidate" id="commodityPurchaseReportsForm" novalidate>
        <div class="card-panel">
            <h4 class="header2">Detailed Reports</h4>
            <div class="row">
                <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                ...
                                <select id="commodityName" class="floating-label">
                                 ...
                                 <?php echo stockBlock::getCommodityName(); ?> 
                    ...
                    <div class="input-field col s12 m2">
                            ...
                            <div class="sel-wrap">
                                <select id="gstType" class="floating-label">
                                    <option value="" disabled selected>Select GST Type</option>
                                    <option value="1">All</option>
                                    <option value="2">Intra State (CGST/SGST)</option>
                                    <option value="3">Inter State (IGST)</option>
                                </select>
                                <div class='bar'></div>
                            </div>
                    </div>
                    <div class="input-field col s12 m2">
                            <label for="customerType" class="active">Customer Type</label>
                            <div class="sel-wrap">
                                <select id="customerType" class="floating-label">
                    ...
                    <div class="input-field col s12 m12 center-align">
                        <button class="waves-effect waves-light btn teal darken-2" form="commodityPurchaseReportsForm" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
...
<div id="loadPurchaseDetailedGrid"></div>
