...
<script type="text/javascript">
    $(document).ready(function () {
        $("#gstr3BForm").materialvalidation({
            theme: "materialize"
        });
        $("#gstr3BForm").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#gstr3BForm").data().materialvalidation.methods.validate()) {
                loadGoldGstr3BDetails();
            }
            return false;
        });
    });
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">GSTR - 3B Reports</h4>
    </div>
    <form class="formValidate" id="gstr3BForm" novalidate>
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                        <button class="waves-effect waves-light btn teal darken-2" form="gstr3BForm" type="submit" name="action"><i class="mdi-av-my-library-books left"></i> Go</button>
...
<div id="loadGstr3BDetailedGrid"></div>
