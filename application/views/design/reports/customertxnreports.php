...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Customer Transaction Reports</h4>
    </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="sel-wrap">
                                <select id="customerName" class="floating-label">
                                    ...
                                    <?php echo customerBlock::getCustomerNameWithCity(); ?> 
                                </select>
                                <div class='bar'></div>
                            </div>  
                        </div>
...
<div id="loadCusTxnReportGrid"></div>
