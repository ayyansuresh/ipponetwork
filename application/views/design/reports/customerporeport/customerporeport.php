...
<script type="text/javascript" src="<?php echo URL; ?>assets/js/purchaseorder/poupdate.js"></script>
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Customer Wise Po Reports</h4>
    </div>
