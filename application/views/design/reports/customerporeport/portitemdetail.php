...
$billDetailsRecord = purchaseOrderBlock::getPoReportDetails();
                ...
                <div class="card-panel">
                    <div class="row">
                        <div class="input-field col s12 m3">
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select disabled="" id="billType" class="floating-label active" data-validation="select" data-content="Please Select Bill Type">
                        ...
                        <div class="input-field col s12 m3">
                            ...
                            <input id="billDate" type="date" class="datepicker"  disabled=""
                        ...
                        <div class="input-field col s12 m6" id="normalCustomer" >
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="customerName" disabled="" class="floating-label active" >
                    ...
                    <div class="row">
                        <div class="input-field col s12 m4">
                            ...
                            <input id="despatch" disabled="" type="text" value="<?php echo $billDetails[purchaseorder_purchaseorderNumber]; ?>" class="validate focus">
                            <label for="despatch" class="active">PO Number</label>
                        </div>
                        <div class="input-field col s12 m4">
                            <i class="mdi-action-event prefix"></i>
                            <input id="transportName" disabled="" type="text" value="<?php echo $billDetails[purchaseorder_transport]; ?>" class="validate focus">
                                ...
                                <div class="row" id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            ...
                                            <div class="input-field col s1">
                                                <input readonly id="lineunitrate<?php echo $count ?>" name="lineunitrate[]" type="hidden" value="<?php echo $billItems[purchaseorderitem_unit_rate] ?>">
                                                <input readonly id="lineunitratewithtax<?php echo $count ?>" name="lineunitratewithtax[]" type="text" value="<?php echo $billItems[purchaseorderitem_unitrate_wittax] ?>">

                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly id="linequantity<?php echo $count ?>"  name="linequantity[]" type="text" value="<?php echo $billItems[purchaseorderitem_quantity] ?>">
                        ...
                        <div class="card-panel">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12" value="0.00" style="display:none">
