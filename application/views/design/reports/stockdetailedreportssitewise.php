...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Site wise consumed qty reports</h4>
    </div>
            ...
            <div class="row">
                ...
                <div class="row">    
                    ...
                    <div class="input-field col s12 m3">
                        ...
                        <script>
                            floatingSelect2Change('commodityName', 'loadProductByCommodity');
                        </script>
                    </div>
                    
                    <div class="input-field col s12 m3" id="loadAllProducts">
                    </div>
