...
$trialBalance = stockBlock::getAccountTrialBalance($companyID, $accountYear);
$trialBalanceFinal = (array) $trialBalance[0];

$trialBalanceFinal[account_opening_balance];
$openingStart = $trialBalanceFinal[account_opening_balance] + $credit - $debit;
$balance = $openingStart;
?>
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Journal Report</h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m3">
                <button class="waves-effect waves-light btn teal darken-2"
                        onclick="printDaywiseReports('<?php echo generalhelper::getGetElement('fromDate') ?>',
