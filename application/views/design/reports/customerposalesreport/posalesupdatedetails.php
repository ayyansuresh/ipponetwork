...
$billDetailsRecord = purchaseOrderBlock::getPoBillUpdateDetails();
if (count($billDetailsRecord) > 0) {
    $billDetails = (array) $billDetailsRecord[0];
    $billDisplay = $billDetails[salesbill_sales_bill_number];
//$billType = "2"; //Credit Bill
    $billId = $billDetails[salesbill_sales_bill_id];


    $billItemDetails = purchaseOrderBlock::getPoBillItemUpdateDetails($billId);
    ?>
    <form id="updateSalesInvoice" novalidate>
        <input type="hidden" id="billId" value="<?php echo $billId ?>"/>
        <input type="hidden" id="poId" value="<?php echo $billDetails[salesbill_purchaseOrderRefId]; ?>"/>
        <div class="container teal lighten-2">
            <div class="collection">
                <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">PURCHASE ORDER SALES ENTRY REPORT</h4>
            </div>
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        <div class="input-field col s12 m2">
                            <div class="input-group">
                                ...
                                <div class="sel-wrap">
                                    <select id="billType" disabled class="floating-label active" data-validation="select" data-content="Please Select Bill Type">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m2" style="display: none;">
                            <i class="mdi-action-event prefix"></i>
                            <input id="transportName" type="text" class="validate" value="<?php echo $billDetails[purchaseorder_transport] ?>">
                            <label for="transportName" class="active">Payment Terms</label>
                        </div>
                        <div class="input-field col s12 m2" style="display: none;">
                            <i class="mdi-action-event prefix"></i>
                            <input id="lrr" type="text" value="<?php echo $billDetails[salesbill_lorry_number] ?>" class="validate focus">
                        ...
                        <div class="input-field col s12 m2" style="display: none;">
                            <i class="mdi-action-event prefix"></i>
                            <input id="document" type="text" value="<?php echo $billDetails[salesbill_document_through] ?>" class="validate focus">
                            ...
                            <div class="row">
                                <div class="row" id="billForm">
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        if ($billItems[salesbillitem_quantity] > 0) {
                                            if ($gstBillType == "1") {
                                                $cgstdisplay = 'style="display:block"';
                                                $sgstdisplay = 'style="display:block"';
                                                $igstdisplay = 'style="display:none"';
                                            ...
                                            <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                                ...
                                                <div class="input-field col s1" <?php echo $cgstdisplay ?>>
                                                    <input readonly id="linecgstRate<?php echo $count ?>"  name="linecgstRate[]" type="text" value="<?php echo $billItems[salesbillitem_cgst_rate] ?>">
                                                </div><div class="input-field col s1" <?php echo $sgstdisplay ?>>
                                                    <input readonly id="linesgstRate<?php echo $count ?>"  name="linesgstRate[]" type="text" value="<?php echo $billItems[salesbillitem_sgst_rate] ?>">
                                                </div>
                                                <div class="input-field col s1" <?php echo $igstdisplay ?>>
                                                    <input readonly id="lineigstRate<?php echo $count ?>"  name="lineigstRate[]" type="text" value="<?php echo $billItems[salesbillitem_igst_rate] ?>">
                                                </div>
                                                ...
                                                <div class="input-field col s1">
                                                    <input readonly id="linequantity<?php echo $count ?>"  name="linequantity[]" type="text" value="<?php echo $billItems[salesbillitem_quantity] ?>">
                                                    ...
                                                    <input readonly id="linepackingfactor<?php echo $count ?>"  name="linepackingfactor[]" type="hidden" value="<?php echo $billItems[salesbillitem_packing_factor] ?>">
                                                </div>
                                                <div class="input-field col s1">
                                                    <input id="linenumberofbags<?php echo $count ?>" name="linenumberofbags[]" type="text" onchange="poSalesItemCalculation(this.value, '<?php echo $count ?>')" value="<?php echo $billItems[salesbillitem_quantity] ?>">
                                                    <div id="fprebinmsg<?php echo $count ?>">
                                                    </div>
                                                </div>
                                                <div class="input-field col s1">
                                                    <input readonly id="purchaseOrderItemRefId<?php echo $count ?>"  name="purchaseOrderItemRefId[]" type="hidden" value="<?php echo $billItems[salesbillitem_purchaseOrderItemRefId] ?>">
                                                    <input readonly id="linetotal<?php echo $count ?>"  name="linetotal[]" type="hidden" value="<?php echo $billItems[salesbillitem_total_withtax] ?>">
                                                    <input readonly id="linetotalwithtax<?php echo $count ?>"  name="linetotalwithtax[]" type="text" value="<?php echo $billItems[salesbillitem_total_withtax] ?>">
                            ...
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="input-field col s12" style="display: none;" >
                                        <input id="packing" type="text" onchange="calculateTotalValue();" value="<?php echo $billDetails[purchaseorder_packing_charge] ?>">
                                        <label for="packing" class="active" >Packing Forwarding </label>
                                    </div>
                                    <div class="input-field col s12" style="display: none;">
                                        <input id="postage" type="text" value="<?php echo $billDetails[purchaseorder_postage_charge] ?>"  onchange="calculateTotalValue();">
