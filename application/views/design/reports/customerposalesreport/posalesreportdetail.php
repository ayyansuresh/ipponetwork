...
$customerResult = stockBlock::getposalesreportdetail();
?>
                        ...
                        <tbody>
                            ...
                            foreach ($customerResult as $customer) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $customer[purchaseorder_purchaseorderTotal] ?></td>
                                    <td><?php echo $customer[salesbill_sales_bill_number] ?></td>
                                    <td><?php echo $customer[salesbill_sales_bill_date] ?></td>
                                    <?php
                                    if ($customer[salesbill_sales_bill_number] == "") {
                                        ?>
                                        <td><i class="mdi-action-visibility" onclick=""></i></td>  <?php
                                    } else {
                                        ?>
                                        <td><i class="mdi-action-visibility" onclick="loadPoSalesReportDetails('<?php echo $customer[salesbill_sales_bill_number] ?>', '<?php echo $customer[purchaseorder_purchaseorderGSTType] ?>');"></i></td>  <?php
                                    }
                                    ?>
                                </tr>
                                <?php
