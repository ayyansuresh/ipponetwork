...
<div class="container teal lighten-2">
    ...
    <div class="card-panel">
        ...
        <button class="waves-effect waves-light btn teal darken-2"
                        onclick="printStockReports('<?php echo generalhelper::getGetElement('fromDate') ?>',
                                        '<?php echo generalhelper::getGetElement('toDate') ?>',
                        <?php echo generalhelper::getGetElement('customerId') ?>,
                                        '<?php echo $customerName ?>');"><i class="mdi-av-my-library-books left"></i> Export to PDF</button>
