            ...
            <div class="row">
                ...
                <div class="input-field col s12 m3">
                    <button class="waves-effect waves-light btn teal darken-2" 
                            onclick="printGoldPurchaseGstReports('<?php echo generalhelper::getGetElement('fromDate') ?>',
...
<div class="container teal lighten-2">
    <div class="container teal lighten-2">
        ...
        <div class="card-panel">
            ...
            $companyId = generalhelper::getSessionElement('beebooklogincompanyid');
            $accountYearId = generalhelper::getSessionElement('beebookloginaccountyearid');
            $stockResult = stockBlock::getPurchaseGoldGstReportsBTC($companyId, $accountYearId);
            ?>
            <div class="row">
                <div class="input-field col s12 m6">
                    <button class="waves-effect waves-light btn teal darken-2" 
                            onclick="printExcelGoldPurchaseGstReportsB2C();">
                        <i class="mdi-av-my-library-books left"></i> Export to Excel</button>
                </div>
                <div id="admin" class="col s12">
                    <div class="card material-table">
...
<div class="container teal lighten-2">
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Overall Customer GST Reports Retail</h4>
        </div>
        ...
        <div class="card-panel">
            ...
            $companyId = generalhelper::getSessionElement('beebooklogincompanyid');
            $accountYearId = generalhelper::getSessionElement('beebookloginaccountyearid');
            $stockResult = stockBlock::getPurchaseGstReportsRetail($companyId, $accountYearId);
            ?>
            <div class="row">
                <div class="input-field col s12 m6">
                    <button class="waves-effect waves-light btn teal darken-2" 
                            onclick="printExcelPurchaseGstReportsRetail();">
                        <i class="mdi-av-my-library-books left"></i> Export to Excel</button>
                </div>
                <div id="admin" class="col s12">
                    <div class="card material-table">
                        <table id="data-table-simple1" class="responsive-table display">
                            ...
                            <tbody>
                                ...
                                foreach ($stockResult as $stock) {
                                    ...
                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td><?php echo $stock[village_customerName]; ?></td>
                                        <!--<td><?php //echo $stock[customer_gst_number]; ?></td>-->
                                        <td><?php echo $stock[purchasebill_purchase_bill_display_number]; ?></td>
                                        <td><?php echo $stock[purchasebillitem_hsn_code_ref_id]; ?></td>
                                        <td><?php echo $stock[items_name]; ?></td>
