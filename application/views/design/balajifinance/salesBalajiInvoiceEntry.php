...
<script type="text/javascript">
    $(document).ready(function () {
        $("#salesBajajInvoice").materialvalidation({
            theme: "materialize"
        });
        $("#salesBajajInvoice").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#salesBajajInvoice").data().materialvalidation.methods.validate()) {
                makeBalajiSalesInvoice();
            }
            return false;
        });
    });
...
if ($gstBillType == 1) {
  ...
  $billNumber = salesFinanceBlock::getQuotationBillNumber($gstBillType);
  $billNumberDisplay = salesFinanceBlock::getQuotationBillPrefix($gstBillType);
  $displayNumber = str_pad($billNumber, $billNumberDisplay[salesprefix_digit], '0', STR_PAD_LEFT);
  $billDisplay = $billNumberDisplay[salesprefix_value] . $displayNumber;
 
 
//$billType = "2"; //Credit Bill
?>
<form id="salesBajajInvoice" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Quotation<?php //echo $salesDisplay; ?></h4>
        </div>
            ...
            <div class="card-panel">
                <div class="row">
                    <div class="input-field col s12 m0">
                        <div class="input-group" style="display:none">
                            ...
                            <div class="sel-wrap">
                                <select id="billType" class="floating-label active" data-validation="select" disabled data-content="Please Select Bill Type">
                                    <option value=""  disabled >Bill Type</option>
                                    <option value="2" >Cash Bill</option>
                                    <option value="1" selected >Credit Bill</option>
                                    <option value="3" >Retail Sales</option>
                                </select>
                                <div class='bar'></div>
                            </div>  
                        </div>
                    ...
                    <div class="input-field col s12 m4" style="display:block">
                    ...
                    <div id="villageCustomer" style="display: none;">
                        ...
                        <div class="input-field col s12 m3">
                            <label for="villagecustomerCity">Mobile Number</label>
                ...
                <div class="row">
                    <div class="input-field col s12 m3">
                        ...
                        <label for="transportName">Advance Payment</label>
                    </div>
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="input-field col s12" <?php echo $sgstdisplay; ?>>
                                    <input id="sgstvalue" type="number" value="0.00" >
                                ...
                                <div class="input-field col s12" value="0.00">
                                    <center>  <button id="makeInvoice" class="btn teal darken-2" type="submit" form="salesBajajInvoice">MAKE INVOICE</button> </center>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php self::loadDesign('popup/balajifinance/salesaddproductpopup'); ?>
