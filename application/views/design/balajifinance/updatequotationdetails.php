...
$billDetailsRecord = salesFinanceBlock::getQuotationDetailsByBillNumber();
...
//$billType = "2"; //Credit Bill
    ...
    $billItemDetails = salesFinanceBlock::getQuotationBillItem($billId);
    ?>
                                    ...
                                    foreach ($billItemDetails as $billItems) {
                                        ...
                                        <div class="input-field col s12" id="billItemRow<?php echo $count ?>">
                                            <div class="input-field col s3">
                                                ...
                                                <input readonly  name="lineproductName[]" type="text" value="<?php echo $billItems[salesbillitem_item_refid]; ?>">

                                            </div>

                                            
                                            <div class="input-field col s1">
                                            <input readonly  name="lineproductdescription[]" type="text" value="<?php echo $billItems[salesbillitemdescription]; ?>">
                                            </div>
                                            <div class="input-field col s1" <?php echo $cgstdisplay ?>>
                                                <input readonly  name="linecgstRate[]" type="text" value="<?php echo $billItems[salesbillitem_cgstrate] ?>">
                                            </div><div class="input-field col s1" <?php echo $sgstdisplay ?>>
                                                <input readonly  name="linesgstRate[]" type="text" value="<?php echo $billItems[salesbillitem_sgstrate] ?>">
                                            </div>
                                            <div class="input-field col s1" <?php echo $igstdisplay ?>>
                                                <input readonly  name="lineigstRate[]" type="text" value="<?php echo $billItems[salesbillitem_igstrate] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                                <input  id="lineunitrate<?php echo $count ?>" name="lineunitrate[]" type="text" value="<?php echo $billItems[salesbillitem_unitrate] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                                <input readonly  name="linequantity[]" type="text" value="<?php echo $billItems[salesbillitem_quantity] ?>">
                                                <input readonly  name="lineUOM[]" type="hidden" value="<?php echo $billItems[salesbillitem_UOM_refid] ?>">
                                                <input readonly  name="linecommodityRefId[]" type="hidden" value="<?php echo $billItems[salesbillitem_commodity_ref_id] ?>">
                                                <input readonly  name="linepackingfactor[]" type="hidden" value="<?php echo $billItems[salesbillitem_packingfactor] ?>">
                                            </div>
                                            <div class="input-field col s1">
                                            ...
                                            <div class="input-field col s1">
                                                <input readonly  name="hsnCode[]" type="hidden" value="<?php echo $billItems[commodity_HSNcode_ref]; ?>">
                                            </div>
                                        </div> 
                                        <?php
                                        $count++;
