<script type="text/javascript" src="<?php echo URL; ?>assets/js/material/updatematerial.js"></script>
...
<div class="container teal lighten-2">
    <div class="collection">
        <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Material Update</h4>
    </div>
