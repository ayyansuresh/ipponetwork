<script type="text/javascript" src="<?php echo URL; ?>assets/js/bajajFinance/bajajFinance.js"></script>
...
<form id="salesBajajInvoice" novalidate>
    <div class="container teal lighten-2">
        <div class="collection">
            <h4 class="collection-item teal darken-2 center-align" style="color:#fff !important;">Finance Bill<?php //echo $salesDisplay; ?></h4>
        </div>
        <div class="col s12 m12 l12">
            <div class="card-panel">
                <div class="row">
                    ...
                    <div class="input-field col s12 m2" style="display:block">
...
<?php self::loadDesign('popup/malleswara/salesAddProductPopup'); ?>
