    ...
    <div class="container" style="font-family:arial;">
        <div class="row">
            <div style="width:100%;border:1px solid #000;height:60px;font-size: 11px !important;border-bottom:none;">
                <div style="width:15%;float:left;padding:0% 2%;">&nbsp;
                    <img src="<?php echo URL; ?>assets/img/malleswara.jpg" style="height:170px;width:150px" />
                </div>
                <div style="width:50%;float:left;">
                    <img src='<?php echo URL; ?>assets/img/top_logo.png' />
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="padding:1.4%;"> 
                                ...
                                if ($sales[customeraddress_mobile] != "") {
                                    ?>
                                    Mobile No:&nbsp;&nbsp;
                                    <strong><?php echo $sales[customeraddress_mobile] ?></strong><br>
                                    <?php
                                } ?>
                                <?php
                        ...
                        <div class="panel panel-default">
                            ...
                            <div style="padding:1.4%;">
                                <table style="font-family:arial;font-size:11px !important;">
                                    <tr>
                                        <td>Invoice No:</td>
                                        <td><strong><?php echo $sales[salesbill_salesbill_display_number] ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td>Date:</td>
                                        <td><strong><?php echo date("d-m-Y", strtotime($sales[salesbill_salesbill_date])) ?></strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <!--<tr>
                                    <?php
                                    $billType = $sales[salesbill_sales_billtype];
                                    if ($billType == 1) {
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <?php
                $sales[salesbill_salesbill_id];
                $invoiceItemDetails = salesFinanceBlock::getSalesInvoiceItemDetails($sales[salesbill_salesbill_id]);
                ?>
                ...
                <table class="table table-condensed" style="width:100%;height:450px;font-size:15px !important;border:1px solid #000;border-collapse: collapse;border-top:none;font-family:arial;">
                    <thead>
                        <tr>
                            ...
                            <td rowspan="2" style="border-bottom:1px solid #000;text-align: center;border-right:1px solid #000;"><strong>Description of Goods</strong></td>
                    ...
                    <tbody>
                        ...
                        foreach ($invoiceItemDetails as $saleItem) {
                            ...
                            $finalquantity = $finalquantity + $saleItem[salesbillitemquantity];
                            ?>
                            <tr>
                                ...
                                <td style="width:10%;border-right:1px solid #000;text-align: right;padding-right:1%;"><strong><?php echo $saleItem[salesbillitemquantity] ?></strong></td>
                                <td style="width:3%;border-right:1px solid #000;text-align: right;padding-right:1%;"><strong><?php echo $saleItem[uom_name] ?></strong></td>

                                <td style="width:10%;border-right:1px solid #000;text-align: right;padding-right:1%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_unitrate])) ?></strong></td>
                                <td style="width:10%;text-align: right;padding-right:1%;border-right:1px solid #000;"><strong>
                                        <?php
                                        echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitemtotal]));
                                        ?></strong></td>
                                <td style="width:3%;border-right:1px solid #000;text-align: right;padding-right:1%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_cgstrate])) ?></strong></td>
                                <td style="width:10%;border-right:1px solid #000;text-align: right;padding-right:1%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_cgsttotal])) ?></strong></td>
                                <td style="width:3%;border-right:1px solid #000;text-align: right;padding-right:1%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_sgstrate])) ?></strong></td>
                                <td style="width:10%;text-align: right;padding-right:1%;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $saleItem[salesbillitem_sgsttotal])) ?></strong></td>
                            </tr>
                            <?php
                            $count++;
                        }
                        ...
                        ?>
                        <tr>
                            <td colspan="2" style="border-right:1px solid #fff;border-top:1px solid #000;text-align:left;border-top:1px solid #000;"><img src='<?php echo URL; ?>assets/img/content.png' /></td>
                            <td colspan="1" style="border-right:1px solid #fff;border-top:1px solid #000;text-align:right;border-top:1px solid #000;"><strong>Total:</strong></td>
                            ...
                            <td colspan="3" style="border-right:1px solid #fff;border-top:1px solid #000;text-align:right;border-top:1px solid #000;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_runningtotal])) ?></strong></td>
                            <td colspan="2" style="border-right:1px solid #fff;border-top:1px solid #000;text-align:right;border-top:1px solid #000;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_cgsttotal])) ?></strong></td>
                            <td colspan="2" style="border-right:1px solid #000;border-top:1px solid #000;text-align:right;border-top:1px solid #000;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_sgsttotal])) ?></strong></td>
                        </tr>
                ...
                <div style="width:50%;float:left;border:1px solid #000;border-top:none;font-size:14px !important;">
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_runningtotal] + $sales[salesbill_cgsttotal] + $sales[salesbill_sgsttotal])) ?></strong>
                        </div>
                    </div>
                    ...
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;"><strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_roundoff])); ?></strong></div>
                    </div>
                    <div style="width:100%;">
                        ...
                        <div style="width:30.25%;float:left;border-top:1px solid #000;text-align: right;">
                            <strong><?php echo generalhelper::formatInIndianStyle(sprintf('%.2f', $sales[salesbill_salesbill_total])); ?></strong>
                        </div>
                    </div>
                </div>
                <div style="width:100%;">
                    <div style="width:100%;font-size:12px !important;float:left;border:1px solid #000;text-align: left;padding-left: 3%;border-top:none;">
                        <strong><?php echo ucfirst(generalhelper::convert_number(round($sales[salesbill_sales_bill_total]))); ?> ONLY/- </strong>
                    </div>
                </div>
                <div style="width:100%;text-align:right;padding-top:0.5%;font-size:12px !important;border:1px solid #000;">
