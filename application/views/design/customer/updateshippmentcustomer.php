...
<script type="text/javascript">
    $(document).ready(function () {
        $("#updateShippmentCustomer").materialvalidation({
            theme: "materialize"
        });
        $("#updateShippmentCustomer").submit(function (evt) {
            evt.preventDefault();
            evt.stopPropagation();
            if ($("#updateShippmentCustomer").data().materialvalidation.methods.validate()) {
                loadShippmentCustomerDetails();
            }
            return false;
        });
    });
</script>
<form id="updateShippmentCustomer" novalidate>
        ...
        <div class="card-panel">
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="input-field col s12 m4">
                        <button class="btn teal darken-2" type="submit" form="updateShippmentCustomer">SEARCH</button>
                    </div>
                </div>
            </div>
        </div>
