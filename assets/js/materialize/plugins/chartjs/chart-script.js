...
var completeurl = url + 'dashboard-dashboard/getChartdata';

var chartdata = ajaxloadwithresponsesnonjson('POST', completeurl, "");
var res = chartdata.split("####");
var sales = res[0].split("###");
var saleslabel = sales[0].split("##");
var salesdata = sales[1].split("##");
var tag = res[1].split("###");
var taglabel = tag[0].split("##");
var tagdata = tag[1].split("##");
var pending = res[2].split("###");
var pendinglabel = pending[0].split("##");
var pendingdata = pending[1].split("##");
var data = {
    labels: saleslabel,
    datasets: [
        {
 ...
 */
var radarChartData = {
    labels: ["Cus1", "Cus2", "Cus3", "Cus4", "Cus5"],
    datasets: [
        {
            label: "First dataset",
            ...
            data: [500.00, 6500.00, 150.00, 500.00, 1000.00]
        }
    ],
};
/*var nReloads2 = 0;
...
/*var nReloads2 = 0;
 ...
 lineChart.addData([x], lineChartData.labels[l2]);
 var y = lineChart.removeData();
 l2++;
 if( l2 == radarChartData.labels.length){ l2 = 0;}
...
window.onload = function () {
     ...
     */
    window.trendingBarChart = new Chart(document.getElementById("trending-radar-chart").getContext("2d")).Bar(customerBalanceChart, {
