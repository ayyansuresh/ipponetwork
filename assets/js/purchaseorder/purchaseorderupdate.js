...
function setPoupdate() {
    ...
    var completeurl = url + "sales-sales/setPoupdate";
    var place = "mainModal";
    $("#" + place).html("Loading");
    var posting = $.get(completeurl,
            {
                ...
                packing: $("#packing").val(),
                postage: $("#postage").val(),
                purchaseOrderRefId: $("#purchaseOrderRefId").val()
            });
...
function closePoUpdateModal(gstType) {
    $('#mainModal').closeModal();
