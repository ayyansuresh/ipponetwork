...
function loadPoSalesDetails(vatCstFlag)
{
    var requesturl;
    if (vatCstFlag == 0) {
        requesturl = url + 'sales-sales/loadPoSalesDetails';
    } else {
        requesturl = url + 'sales-sales/loadPoSalesDetails';
    }
    var data = "";
    var purchaseOrderId = $("#poNumber option:selected").val();
    var billNumber = $("#poNumber option:selected").text();
    var gstType = $("#gstType").val();
    data = "billNumber=" + billNumber + "&gstType=" + gstType + "&vatCstFlag=" + vatCstFlag + "&purchaseOrderId=" + purchaseOrderId;
...
function makePoSalesInvoice() {
    ...
    var completeurl = url + "sales-sales/makePoSalesInvoice";
    var place = "mainModal";
    $("#" + place).html("Loading");
...
function closePOSalesModal(gstType) {
    $('#mainModal').closeModal();
