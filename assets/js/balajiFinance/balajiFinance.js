...
function billItemSave() {
    rowcount = rowcount + 1;
    var productName = $("#salesproductName").val();
    ...
    var unitRate = parseFloat(unitRateOrginal) * parseFloat(billFactor) * 100/
            (parseFloat(sgstRate)+ parseFloat(cgstRate)+ parseFloat(igstRate)+100);
    ...
    var billitemrow = '<div class="input-field col s12" id="billItemRow' + rowcount + '">\n\
                        ...
                        <div class="input-field col s1">\n\
                        <input readonly  name="lineproductdescription[]" type="text" value="' + description + '">\n\
                        </div>\n\
                        ...
                        <div class="input-field col s1">\n\
                         <input readonly  name="lineunitrate[]" type="text" value="' + unitRateOrginal + '">\n\
                        </div>\n\
                        <div class="input-field col s1">\n\
...
function makeBalajiSalesInvoice() {
    //event.preventDefault();
    /*if (parseFloat($("#grandTotal").val()) > 10000 && ((($("#billType").val()) == 2) || ($("#billType").val()) == 3)) {
        ...
        var completeurl = url + "balajiFinance-balajiFinance/makeBalajiSalesInvoice";
        var place = "mainModal";
        $("#" + place).html("Loading");
...
function closeSalesFinanceModal(gstType) {
    $('#mainModal').closeModal();
...
function updatePurchaseInvoice() {
   ...
   /* if (parseFloat($("#grandTotal").val()) > 10000 && ((($("#billType").val()) == 2) || ($("#billType").val()) == 3)) {
    ...
    /* To print Bills */
function printAction2(gstType, company, accountYear)
{
    ...
    var billType = '1';
    var completeurl = url + 'balajiFinance-balajiFinance/generateFinanceInvoicePdf?company=' + company + '&accountYear=' + accountYear +
            '&frombillnumber=' + frombillnumber + '&tobillnumber=' + tobillnumber + '&gstType=' + gstType + '&billType=' + billType;
    window.open(completeurl);
//}
}
function loadQuotationDetails(vatCstFlag)
{
    var requesturl;
    if (vatCstFlag == 0) {
        requesturl = url + 'balajiFinance-balajiFinance/loadQuotationDetails';
    } else {
        requesturl = url + 'balajiFinance-balajiFinance/loadSalesDetailsCstVat';
    }
    var data = "";
    ...
    function updateQuotationInvoice() {
    event.preventDefault();
    if (parseFloat($("#grandTotal").val()) > 10000 && ((($("#billType").val()) == 2) || ($("#billType").val()) == 3)) {
        alert("Cash Bill should be Within Rs. 10000");
        return false;
        ...
        var billId = $("#billId").val();
        $('#mainModal').openModal({dismissible: false});
        var completeurl = url + "balajiFinance-balajiFinance/updateQuotationInvoice";
        var place = "mainModal";
        $("#" + place).html("Loading");
        var posting = $.get(completeurl,
                {
