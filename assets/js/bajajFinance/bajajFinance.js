...
function makeBajajSalesInvoice() {
    //event.preventDefault();
    /*if (parseFloat($("#grandTotal").val()) > 10000 && ((($("#billType").val()) == 2) || ($("#billType").val()) == 3)) {
        ...
        var completeurl = url + "bajajFinance-bajajFinance/makeBajajSalesInvoice";
        var place = "mainModal";
        $("#" + place).html("Loading");
...
function printAction2(gstType, company, accountYear)
{
    ...
    var billType = '1';
    var completeurl = url + 'bajajFinance-bajajFinance/generateFinanceInvoicePdf?company=' + company + '&accountYear=' + accountYear +
