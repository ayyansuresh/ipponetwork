...
function makeSalesInvoice() {
    //event.preventDefault();
        ...
        var completeurl = url + "sales-salesmalleswara/makeVendorInvoice";
        var place = "mainModal";
        $("#" + place).html("Loading");
...
function closeVendorInvoiceModal(gstType) {
    $('#mainModal').closeModal();
...
function updateSalesInvoice() {
    ...
    if (parseFloat($("#grandTotal").val()) > 10000 && ((($("#billType").val()) == 2) || ($("#billType").val()) == 3)) {
        ...
        $('#mainModal').openModal({dismissible: false});
        var completeurl = url + "sales-salesmalleswara/updateSalesInvoiceVendor";
        var place = "mainModal";
        $("#" + place).html("Loading");
        var posting = $.get(completeurl,
                {
...
function closeUpdateVendorInvoiceModal(gstType) {
    $('#mainModal').closeModal();
...
function printBill()
{
    var completeurl = url + 'invoice-invoice/loadVendorReportPdf';
