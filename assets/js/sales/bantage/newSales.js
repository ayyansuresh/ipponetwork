...
//alert(unitRateOrginal);
    ...
    var lineproductdescription = $("#description option:selected").text();
    ...
    var billitemrow = '<div class="input-field col s12" id="billItemRow' + rowcount + '">\n\
                        ...
                        <input readonly  name="lineproductName[]" type="text" value="' + productName + '-' + lineproductdescription + '">\n\
                  \n\<label></label>\n\
...
//alert(unitRateOrginal);
    ...
    var unitRateWithTax = parseFloat(unitRate) + ((parseFloat(cgstRate) +
            parseFloat(sgstRate) + parseFloat(igstRate)) * parseFloat(unitRate) / 100) - (parseFloat(itemdiscount) * parseFloat(unitRate) / 100);

    var total = (parseFloat(quantity * unitRate).toFixed(2));
    //var total = parseFloat(total1) - (parseFloat(itemdiscount) * parseFloat(total1) / 100);
    var totalwithTax = (parseFloat(quantity * unitRateWithTax).toFixed(2));
    var finalDiscount = (parseFloat(itemdiscount) * parseFloat(total) / 100);
    var finalDiscountTotal = (parseFloat(total) - parseFloat(finalDiscount));
    var commodityRefId = $("#commodityRefId").val();
    var cgstdisplay;
    var sgstdisplay;
    var igstdisplay;
    ...
    var billitemrow = '<div class="input-field col s12" id="billItemRow' + rowcount + '">\n\
                        ...
                        <input readonly  name="lineproductName[]" type="text" value="' + productName + '-' + lineproductdescription + '">\n\
                  \n\<label></label>\n\
<input readonly  name="lineproductdescription[]" type="hidden" value="' + lineproductdescription + '"><input readonly  name="finalDiscount[]" type="hidden" value="' + finalDiscount + '">\n\
                 </div>\n\
                        <div class="input-field col s1">\n\
                        <input readonly  name="hsnCode[]" type="text" value="' + hsnCode + '">\n\
                        </div>\n\
                      ...
                      <input readonly  name="linepackingfactor[]" type="hidden" value="' + packingFactor + '">\n\
                        ...
                        <div class="input-field col s1">\n\
                         <input readonly  name="linetotal[]" type="text" value="' + total + '">\n\
                         <input type="hidden" name="finalDiscountTotal[]" type="text" value="' + finalDiscountTotal + '">\n\
                         <input readonly  name="linetotalwithtax[]" type="hidden" value="' + totalwithTax + '">\n\
                        </div>\n\
                        <div class="input-field col s1">\n\
                         <i class="mdi-action-delete red darken-1" onclick="removeItem(' + rowcount + ')"></i>\n\
...
function calculateTotalValue() {
    ...
    var finalDiscountTotal = $('input[name="finalDiscountTotal[]"]').map(function() {
        return $(this).val();
    }).get();
    alert(finalDiscountTotal);
    ...
    var finalDiscount = $('input[name="finalDiscount[]"]').map(function() {
        return $(this).val();
    }).get();
    var subtotal = 0.00;
    var totalbags = 0.00;
    ...
    for (increment = 0; increment < linetotal.length; increment++) {
        ...
        cgstValue = cgstValue + (parseFloat(linecgstrate[increment]) *
                parseFloat(finalDiscountTotal[increment]) / 100);
        ...
        discountAmount = discountAmount + parseFloat(finalDiscount[increment]);
    }
    finalTotalFreight = finalTotalFreight + parseFloat(totalFreight);
    if ($("#billGSTType").val() == "1") {
        var grandTotal = parseFloat(cgstValue.toFixed(2)) + parseFloat(sgstValue.toFixed(2)) + parseFloat(subtotal.toFixed(2)) + parseFloat(finalTotalFreight.toFixed(2)) - parseFloat(discountAmount.toFixed(2));
    } else {
        var grandTotal = parseFloat(igstValue.toFixed(2)) + parseFloat(subtotal.toFixed(2)) + parseFloat(finalTotalFreight.toFixed(2)) - parseFloat(discountAmount.toFixed(2));
    }
