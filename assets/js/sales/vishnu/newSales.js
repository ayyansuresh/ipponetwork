...
function addNewProduct() {
    ...
    $("#weight").siblings("label,i").removeClass("active");
}
    ...
    if (productId == "") {
        ...
        for (var i = 0; i < loadedItemName.item.length; i++) {
            if (loadedItemName.item[i].ItemId === productId) {
                ...
                // $('#unitRate').focus();
                $("#weight").siblings("label,i").addClass("active");
...
function purchasebillItemSave() {
    ...
    var linenumberofbags = $("#productquantity").val();
    var billFactor = $("#billFactor").val();
    var lineUOMQuantity = $("#weight").val();
    ...
    var billitemrow = '<div class="input-field col s12" id="billItemRow' + rowcount + '">\n\
                      ...
                      <input readonly  name="linepackingfactor[]" type="hidden" value="' + packingFactor + '">\n\
                        ...
                        <div class="input-field col s1">\n\
                         <input   name="linetotal[]" type="text" value="' + total + '">\n\
                        </div>\n\
                        <div class="input-field col s1">\n\
    ...
    document.getElementById("makePurchase").tabIndex = "2";
...
function billItemSave() {
    ...
    var billitemrow = '<div class="input-field col s12" id="billItemRow' + rowcount + '">\n\
                        ...
                        <div class="input-field col s1">\n\
                         <input readonly  name="lineWeight[]" type="text" value="' + lineUOMQuantity + '">\n\
                        </div>\n\
                        <div class="input-field col s1">\n\
                         <input readonly  name="lineunitrate[]" type="text" value="' + unitRate + '">\n\
                         <input readonly  name="lineUOM[]" type="hidden" value="' + UOM + '">\n\
...
function calculateTotalValue() {
    ...
    var lineWeight = $('input[name="lineWeight[]"]').map(function () {
        return $(this).val();
    }).get();
    var subtotal = 0.00;
    var totalbags = 0.00;
    var totalSquareFeet = 0.00;
    var totalLineWeight = 0.00;
    var cgstValue = 0.00;
    var sgstValue = 0.00;
    var igstValue = 0.00;
    for (increment = 0; increment < linetotal.length; increment++) {
        ...
        totalSquareFeet = totalSquareFeet + parseFloat(linequantity[increment]);
        totalLineWeight = totalLineWeight + parseFloat(lineWeight[increment]);
    ...
    $("#totalSquareFeet").val(totalSquareFeet);
    $("#totalLineWeight").val(totalLineWeight);
        ...
        var posting = $.get(completeurl,
                {
                    ...
                    totalSquareFeet: $("#totalSquareFeet").val(),
                    totalLineWeight: $("#totalLineWeight").val()
                });
