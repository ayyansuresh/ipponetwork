...
function makeOrderInvoice() {
    ...
    $('#mainModal').openModal({dismissible: false});
    var completeurl = url + "sales-salesmalleswara/makeOrderInvoice";
    var place = "mainModal";
    $("#" + place).html("Loading");
    var posting = $.get(completeurl,
            {
...
function closeOrderModal(gstType) {
    $('#mainModal').closeModal();
...
function loadOrderUpdateDetails(vatCstFlag)
{
    alert('test');
    var requesturl;
    if (vatCstFlag == 0) {
    ...
    data = "orderNumber=" + orderNumber + "&gstType=" + gstType + "&vatCstFlag=" + vatCstFlag;
...
function updateOrderDetails() {
    ...
    var billId = $("#billId").val();
    $('#mainModal').openModal({dismissible: false});
    var completeurl = url + "sales-salesmalleswara/updateOrderDetails";
    var place = "mainModal";
    $("#" + place).html("Loading");
    var posting = $.get(completeurl,
            {
