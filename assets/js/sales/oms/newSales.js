...
function calculateTotalValue() {
    ...
    if ($("#billGSTType").val() == "1") {
     ...
     if ($("#frightAmount").length) {
        var frightAmount = parseFloat($("#frightAmount").val()).toFixed(2);
        var totalDiscount = parseFloat($("#totalDiscount").val()).toFixed(2);
        grandTotal = grandTotal - frightAmount - totalDiscount;
    }
