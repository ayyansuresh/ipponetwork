...
function loadUnitRateNew(rowindex) {
    ...
    if (productId == "") {
        ...
        for (var i = 0; i < loadedItemName.item.length; i++) {
            ...
            if (loadedItemName.item[i].purchasebillId === productId) {
                ...
                match = 1;
                itemFlag = 0;
                var lineunitrate = parseFloat(loadedItemName.item[i].purchaseBillBags) * 100 /
                        (parseFloat(loadedItemName.item[i].cgstRate) +
                                parseFloat(loadedItemName.item[i].sgstRate) + 100);

                var unitRateOriginal = (parseFloat(loadedItemName.item[i].purchaseBillBags))
                        * 100 /
