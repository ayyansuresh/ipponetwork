...
//alert(unitRateOrginal);
    ...
    var quantity = $("#productquantity").val();
    var UOM = $("#UOM").val();
    var UOMDisplay = $("#UOM option:selected").text();
    var incentivePercentage = $("#incentivePercentage").val();
    var linenumberofbags = $("#numberOfBags").val();
    var billFactor = $("#billFactor").val();
    if ($("#taxType").val() == "1") {
    ...
    var total = (parseFloat(quantity * unitRate).toFixed(2));
    var incentiveTaxAmount = parseFloat(total * incentivePercentage / 100).toFixed(2);
    //var totalwithTax = (parseFloat(quantity * unitRateWithTax).toFixed(2));
    var totalwithTax = total - incentiveTaxAmount;
    var commodityRefId = $("#commodityRefId").val();
    var cgstdisplay;
    var sgstdisplay;
    var igstdisplay;
...
<input readonly  name="lineproductdescription[]" type="hidden" value="' + lineproductdescription + '">\n\
                        ...
                        <div class="input-field col s1">\n\
                        <input readonly  name="lineUOMDisplay[]" type="text" value="' + UOMDisplay + '">\n\
                        </div>\n\
                      ...
                      <input readonly  name="linepackingfactor[]" type="hidden" value="' + packingFactor + '">\n\
                        ...
                        <div class="input-field col s1">\n\
                          <input readonly  name="incentivePercentage[]" type="text" value="' + incentivePercentage + '">\n\
                        </div>\n\
                        <div class="input-field col s1">\n\
                        <input readonly  name="incentiveTaxAmount[]" type="text" value="' + incentiveTaxAmount + '">\n\
                        </div>\n\
                        <div class="input-field col s1" ' + igstdisplay + '>\n\
...
function calculateTotalValue() {
    ...
    var incentiveTaxAmount = $('input[name="incentiveTaxAmount[]"]').map(function () {
        return $(this).val();
    }).get();
    var subtotal = 0.00;
    var totalbags = 0.00;
    ...
    var sgstValue = 0.00;
    var igstValue = 0.00;
    var totalIncentiveTaxValue = 0.00;
    for (increment = 0; increment < linetotal.length; increment++) {
        ...
        totalIncentiveTaxValue = totalIncentiveTaxValue + parseFloat(incentiveTaxAmount[increment]);
    }
    if ($("#billGSTType").val() == "1") {
    ...
    $("#incentiveAmount").val(totalIncentiveTaxValue.toFixed(2));
...
function makeSalesInvoice() {
        ...
        var incentivePercentage = $('input[name="incentivePercentage[]"]').map(function () {
            return $(this).val();
        }).get();
         var incentiveTaxAmount = $('input[name="incentiveTaxAmount[]"]').map(function () {
            return $(this).val();
        ...
        var posting = $.get(completeurl,
                {
                    ...
                    incentiveTaxAmount:incentiveTaxAmount,
                });
...
function addNewdeliveryProduct() {
    //event.preventDefault();
...
//alert(unitRateOrginal);
    ...
    var quantity = $("#productquantity").val();
    var UOM = $("#UOM").val();
    var uomQty = parseFloat(quantity) * parseFloat(packingFactor);
    var UOMDisplay = $("#UOM option:selected").text();
    var incentivePercentage = $("#incentivePercentage").val();
    var linenumberofbags = $("#numberOfBags").val();
    var billFactor = $("#billFactor").val();
...
<input readonly  name="lineproductdescription[]" type="hidden" value="' + lineproductdescription + '">\n\
    ...
    calculateDeliveryTotalValue();

}
function loadDeliveryUnitRate() {
    var productId = $("#salesproductName").val();
    if (productId == "") {
        $("#cgstRate").val("");
        $("#sgstRate").val("");
