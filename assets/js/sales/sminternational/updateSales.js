...
//International Bill Update

function loadInternationalBillDetails(vatCstFlag)
{
    var requesturl;
    if (vatCstFlag == 0) {
        requesturl = url + 'sales-salesmalleswara/loadSalesDetailsCstVat';
    } else {
        requesturl = url + 'sales-salesmalleswara/loadInternationalSalesDetails';
    }
    var data = "";
    var billNumber = $("#billNumber").val();
    var gstType = 3;
...
function loadIndiaBillDetails(gstType, vatCstFlag)
{
    requesturl = url + 'sales-salesmalleswara/loadIndiaSalesDetails';
    var data = "";
    var billNumber = $("#billNumber").val();
    data = "billNumber=" + billNumber + "&gstType=" + gstType + "&vatCstFlag=" + vatCstFlag;
    $("#loadBillDetails").html('<div style="text-align:center;padding:0% 0%;"><img style="width:100px;" src="' + url + 'assets/img/loading.gif"/><br/><label>Please Wait...</label></div>');
...
function loadOtherStateBillDetails(gstType, vatCstFlag)
{
    requesturl = url + 'sales-salesmalleswara/loadSmSalesBillOtherStateUpdate';
    var data = "";
    var billNumber = $("#billNumber").val();
    data = "billNumber=" + billNumber + "&gstType=" + gstType + "&vatCstFlag=" + vatCstFlag;
    $("#loadBillDetails").html('<div style="text-align:center;padding:0% 0%;"><img style="width:100px;" src="' + url + 'assets/img/loading.gif"/><br/><label>Please Wait...</label></div>');
