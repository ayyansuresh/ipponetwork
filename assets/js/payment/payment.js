...
{
    var requesturl = url + 'payment-payment/salesPaymentDetails';
...
function deletePaymentConfirmation(salesPaymentId) {
    $('#salesPaymentDeletePopupWS').openModal({dismissible: false});
...
function deleteSalesPayment() {
    var completeurl = url + "payment-payment/deleteSalesPayment";
    var place = "salesPaymentDeletePopupWS";
...
function saveSiteWiseExpensePayment() {
    var completeurl = url + "accounts-accounts/makeSitewiseExpensePayment";
    var place = "mainModal";
    var toggleState = $('#expenseToggle').is(':checked') ? true : false;
...
function printReceiptDetails(salespaymentId,receiptNo,salesBillId,salesBillNo,company, accountYear)
